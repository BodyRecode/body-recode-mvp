...
${emailStatusCard({
  ...
  body: `${FULL_NAME} now has portal access and will start the onboarding flow: agreement → health declaration → 208-question intake → baseline. You will be notified as each step lands.`,
})}
