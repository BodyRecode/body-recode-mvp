...
export default function SendEmailButton({
  ...
  const variantClass =
    variant === 'outline'
      ? 'border border-[#E8EAEE] text-[#43474F] hover:border-[#1B6DFC] hover:text-[#1B6DFC] hover:bg-[rgba(27,109,252,0.06)]'
      : 'bg-[#1B6DFC] text-white font-semibold hover:bg-[#1560E0]'
