    ...
    <html lang="en" style={{ background: PAPER }}>
      ...
      <body>
        <div className="doc">
          ...
          <p className="sub">A personalised reading against your pattern, your last four weeks of check-ins, and the Body Recode framework.</p>
          ...
          <div className="signoff">
            Designed by <strong>Kade Dunstone</strong>. Generated by the Body Recode engine — the same framework Kade uses with coaching clients, formalised into a personalised reading. The interpretation is the framework. The response is your situation read through it. Re-read it once or twice. Bring observations into your next weekly check-in.
          </div>
        </div>
      </body>
    </html>
