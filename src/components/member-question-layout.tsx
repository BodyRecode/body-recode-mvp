    ...
    <html lang="en" style={{ background: PAPER }}>
      <head>
        ...
        <style>{`
          ...
          .meta { font-size: 11px; color: ${SUBTLE}; letter-spacing: 0.12em; text-transform: uppercase; padding: 14px 0; border-top: 1px solid ${HAIRLINE}; border-bottom: 1px solid ${HAIRLINE}; margin-bottom: 36px; }
      ...
      <body>
        <div className="doc">
          ...
          <div className="signoff">
            This response was generated by the Body Recode engine, trained on the same framework Kade uses with coaching clients. Re-read it once or twice. Bring observations into your next weekly check-in.
          </div>
        </div>
      </body>
    </html>
