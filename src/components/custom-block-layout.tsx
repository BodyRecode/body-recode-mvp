      ...
      <body>
        <div className="doc">
          ...
          <div className="signoff">
            Designed by <strong>Kade Dunstone</strong>. Generated by the Body Recode engine, the same framework Kade uses with coaching clients, formalised into a personalised block. Print this if you are travelling or off-grid. Bring observations from these two weeks into your next weekly check-in.
          </div>
        </div>
      </body>
    </html>
