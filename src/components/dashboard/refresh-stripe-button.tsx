...
export default function RefreshStripeButton({ clientId }: { clientId: string }) {
  ...
  return (
    <button
      ...
      onClick={refresh}
      disabled={pending}
      className="flex items-center gap-1.5 px-3 py-1.5 text-[12.5px] font-medium text-[#8A9099] hover:text-[#FAFAF8] border border-[#2A2F39] hover:border-[#FAFAF8] hover:bg-[rgba(27,109,252,0.06)] rounded-lg transition-colors disabled:opacity-50"
    >
