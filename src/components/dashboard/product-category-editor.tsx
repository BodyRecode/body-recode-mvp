...
export default function ProductCategoryEditor({
  ...
  return (
    <select
      ...
      className="bg-[#1A1E26] border border-[#2A2F39] hover:border-[#2A2F39] text-[12.5px] text-[#FAFAF8] rounded-lg px-2.5 py-1.5 focus:outline-none focus:border-[#FAFAF8]/50 disabled:opacity-50"
    >
