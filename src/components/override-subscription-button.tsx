...
export default function OverrideSubscriptionButton({ clientId }: { clientId: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="text-xs text-[#999999] hover:text-blue-500 border border-[#E5E5E5] hover:border-blue-200/50 px-3 py-1.5 rounded-lg transition-colors disabled:opacity-50 whitespace-nowrap"
    >
