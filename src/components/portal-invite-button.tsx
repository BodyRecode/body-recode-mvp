...
export default function PortalInviteButton({ clientId, onboardingToken }: { clientId: string; onboardingToken?: string }) {
  ...
  return (
    <button
      ...
      className="text-sm font-medium px-4 py-2.5 rounded-lg border border-[#E8EAEE] text-[#43474F] hover:border-[#1B6DFC] hover:bg-[rgba(27,109,252,0.06)] transition-colors disabled:opacity-50"
    >
