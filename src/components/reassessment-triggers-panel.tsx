...
export default function ReassessmentTriggersPanel({
  ...
  return (
    <div className="br-card p-6 mb-6">
      ...
      <p className="text-sm text-[#8A9099] mb-5">
        ...
        {triggers.map((t) => {
          ...
          return (
            <li
              ...
              style={{ borderColor: overdue ? '#F5C6C6' : '#2A2F39', background: overdue ? '#FEF7F7' : '#14171D' }}
            >
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className="text-sm font-bold text-[#FAFAF8]">
                  ...
                  <p className="text-sm text-[#C2C6CC] leading-relaxed">{t.message}</p>
                  <p className="text-[12.5px] text-[#676D76] mt-1.5 inline-flex items-center gap-1">
                    <Clock size={11} />
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    disabled={busy}
                    className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg text-[12.5px] font-medium text-[#0B0D10] bg-[#FAFAF8] hover:bg-[#E4E4E0] disabled:opacity-60 transition-colors"
                  >
                  ...
                  <button
                    ...
                    disabled={busy}
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-[12.5px] font-medium border border-[#2A2F39] text-[#C2C6CC] hover:border-[#CFD4DC] disabled:opacity-60 transition-colors"
                  >
                    <X size={13} /> Dismiss
                  </button>
                </div>
                ...
                <div className="mt-3 pt-3 border-t border-[#2A2F39]">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="px-3.5 py-2 rounded-lg text-[12.5px] font-medium text-[#0B0D10] bg-[#FAFAF8] hover:bg-[#3A3A3A] disabled:opacity-40 transition-colors"
                    >
