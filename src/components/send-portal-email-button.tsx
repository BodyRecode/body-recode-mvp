...
export default function SendPortalEmailButton({ clientId }: { clientId: string }) {
  ...
  const cls = 'text-sm font-medium px-4 py-2.5 rounded-lg border border-[#E5E5E5] text-[#3A3A3A] hover:border-[#1B6DFC] hover:bg-blue-50 transition-colors disabled:opacity-50'
