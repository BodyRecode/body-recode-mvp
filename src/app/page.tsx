  ...
  return (
    <div style={{ background: CANVAS, minHeight: '100vh', color: TXT_BODY, overflowX: 'hidden' }}>
      ...
      <Section>
        ...
        <Grid min={220}>
          <StatCard value={String(QUESTIONS)} label="Questions asked" detail="Eleven sections, covering sleep, stress, training, food, injury, medications and where they store fat. Most people take 25 to 35 minutes over it, and it saves as you go." />
