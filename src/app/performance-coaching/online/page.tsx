    ...
    <>
      ...
      <section className="bg-white py-32 px-5 border-t border-stone-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-stone-600 text-lg leading-relaxed mb-6">
            This means building a complete picture across nine domains: training history, stress load, sleep and recovery, body pattern signals, nutrition behaviours, schedule, stimulant use, and hormonal context. Not a fitness questionnaire. A full read of your system.
          </p>
