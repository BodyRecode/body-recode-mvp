    ...
    <>
      ...
      <section className="bg-white pt-44 pb-32 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-stone-600 leading-relaxed max-w-2xl mb-12">
            {brand().name}™ is a biology-first coaching system built for high-functioning adults in Brisbane whose bodies have stopped responding to effort. If you want to understand why before you do anything else, this is where to start.
                                </p>
          <Link
      ...
      <section className="bg-white py-32 px-5 border-t border-stone-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-stone-600 text-lg leading-relaxed mb-6">
            Most coaching in Brisbane escalates when progress stalls: more sessions, more intensity, more restriction. {brand().name}™ does the opposite. Before any training is prescribed, we establish what your biology is actually doing and why.
                                </p>
          <p className="text-stone-600 text-lg leading-relaxed mb-6">
      ...
      <section className="bg-[#FFFFFF] py-32 px-5 border-t border-stone-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-stone-400 text-base text-center leading-relaxed max-w-xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500 uppercase tracking-wider font-semibold mb-10">
                Performance Coach · Founder, {brand().name}™ · Anytime Fitness Newstead
                                            </p>
