  ...
  return (
    <>
      ...
      <section className="bg-white pt-44 pb-28 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-stone-600 leading-relaxed max-w-2xl mb-12">
            {brand().name}™ is not standard personal training. It is a structured, biology-first coaching system that builds around how your body actually works, not a program written for the average person.
                                </p>
          <Link
      ...
      <section className="bg-white py-32 px-5 border-t border-stone-200">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#1A1A1A] tracking-tight mb-12">Standard PT vs {brand().name}™</h2>
      ...
      <section className="bg-white py-32 px-5 border-t border-stone-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-stone-600 text-lg leading-relaxed mb-4">
            {brand().name}™ operates exclusively at <a href="https://www.anytimefitness.com/en-au/locations/newstead-queensland-au-1937" target="_blank" rel="noopener noreferrer" className="text-[#1B6DFC] hover:underline">Anytime Fitness Newstead</a>, Brisbane. All coaching is face-to-face and one-on-one. This is not a group fitness model or a high-volume gym environment. Availability is limited by design, because the system requires a level of attention that cannot be delivered at scale.
          </p>
          <p className="text-stone-600 text-lg leading-relaxed mb-12">
            To find out if there is current availability and whether {brand().name}™ is the right fit for you, start with the free Performance Check-In.
                                </p>
