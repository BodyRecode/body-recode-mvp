  ...
  return (
    <>
      ...
      <section className="bg-black py-32 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight mb-12">Standard online PT vs Body Recode™</h2>
          <div className="grid md:grid-cols-2 gap-10">
            <div className="border border-white/10 rounded-xl p-6">
              <p className="text-sm font-bold text-white/40 uppercase tracking-wider mb-4">Standard Online Personal Training</p>
