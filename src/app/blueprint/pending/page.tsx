      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '56px 24px 24px', position: 'relative' }}>
          ...
          <p style={{ fontSize: '17px', color: '#4A4A4A', lineHeight: 1.75, margin: 0 }}>
            Watch your inbox. Your private portal link lands at {email ? <strong style={{ color: '#1A1A1A' }}>{email}</strong> : 'the email you paid with'} - usually within a minute. Bookmark it. Your full six weeks live there.
          </p>
        </div>
      </div>
