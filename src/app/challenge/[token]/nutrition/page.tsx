      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
              <span style={{
                fontSize: '11px', fontWeight: 800, color: '#0c0a09',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            {[
              ...
              <div key={p.text} style={{ ...card, display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                ...
                <p style={{ fontSize: '13px', color: '#d4cfc9', margin: 0, lineHeight: 1.55 }}>{p.text}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {[
              ...
              <div key={f.cat} style={{ ...card }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '6px' }}>
                  ...
                  <span style={{ fontSize: '11px', color: '#57534e', background: '#1c1917', padding: '2px 8px', borderRadius: '99px', whiteSpace: 'nowrap' as const, marginLeft: '10px' }}>{f.note}</span>
                </div>
                <p style={{ fontSize: '13px', color: '#a8a29e', margin: 0, lineHeight: 1.55 }}>{f.items}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <div style={{ marginBottom: '12px' }}>
            <p style={{ fontSize: '13px', fontWeight: 700, color: '#57534e', textTransform: 'uppercase' as const, letterSpacing: '0.08em', marginBottom: '10px' }}>Post-training carb options</p>
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' as const }}>
              {['White rice', 'Potatoes', 'Sweet potato', 'Banana', 'Honey', 'Berries', 'Pineapple'].map(c => (
                <span key={c} style={{ fontSize: '13px', color: '#a8a29e', background: '#1c1917', borderRadius: '6px', padding: '5px 12px' }}>{c}</span>
              ))}
            </div>
          </div>
            ...
            {[
              ...
              <div key={m.time} style={{ display: 'flex', gap: '0' }}>
                ...
                <div style={{ ...card, marginBottom: '6px', flex: 1 }}>
                  ...
                  {m.note && <p style={{ fontSize: '12px', color: '#57534e', margin: 0, lineHeight: 1.5 }}>{m.note}</p>}
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '16px' }}>
            {[
              ...
              <div key={m.num} style={{ ...card }}>
                ...
                <p style={{ fontSize: '11px', color: '#57534e', textTransform: 'uppercase' as const, letterSpacing: '0.06em', margin: '0 0 8px' }}>{m.sub}</p>
                <p style={{ fontSize: '12px', color: '#57534e', margin: 0, lineHeight: 1.55 }}>{m.items}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {[
              ...
              <div key={e.meal} style={card}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                  ...
                  <span style={{ fontSize: '11px', color: '#57534e', background: '#1c1917', padding: '2px 8px', borderRadius: '99px' }}>{e.tag}</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  {e.items.map(item => (
                    <div key={item} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                      <div style={{ width: '5px', height: '5px', borderRadius: '50%', background: '#14b8a6', flexShrink: 0, marginTop: '7px' }} />
                      <p style={{ fontSize: '13px', color: '#d4cfc9', margin: 0, lineHeight: 1.55 }}>{item}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                    ...
                    <p style={{ fontSize: '13px', color: '#a8a29e', margin: 0, lineHeight: 1.45 }}>{i}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
              {[
                ...
                <div key={s.name} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: '14px', fontWeight: 600, color: '#d4cfc9', margin: '0 0 3px' }}>{s.name}</p>
                    <p style={{ fontSize: '12px', color: '#57534e', margin: 0, lineHeight: 1.4 }}>{s.note}</p>
                  </div>
