...
const FOUR_PATTERNS = [
  {
    ...
    where: 'Midsection storage, around the stomach and waist',
    signal: 'Wired but tired. Holds fat at the midsection. Wakes puffy. Late-night alertness despite fatigue.',
    colour: '#DC2626',
  },
  {
    name: 'Insulin-Drift',
    ...
    where: 'Full-body softening, especially across chest and stomach',
    signal: 'Energy crashes mid-morning or afternoon. Cravings under stress. Training feels heavier than it should.',
    colour: '#B7791F',
  },
  {
    name: 'Estrogen-Shift',
    ...
    where: 'Hips, thighs, lower body. Bloating without obvious reason.',
    signal: 'Body shifting underneath you. Cycle unpredictability. Restriction makes it worse, not better.',
    colour: '#8B5CF6',
  },
  {
    ...
    where: 'Reduced muscle tone. Softer chest and midsection. Tired face in morning.',
    signal: 'Capability slipping, not just appearance. Strength sessions feel heavier than they used to. Recovery slower.',
    colour: '#1B6DFC',
  },
]
