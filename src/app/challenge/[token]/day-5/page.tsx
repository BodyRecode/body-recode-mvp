      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '56px 24px 32px', position: 'relative' }}>
          ...
          <p style={{ fontSize: '17px', color: '#4A4A4A', lineHeight: 1.75, margin: 0 }}>
            An 8 to 9 minute session walking you through what has actually happened in your biology across the first 5 days, why the signals you have been feeling matter, and what Week 2 is building toward.
          </p>
        </div>
      </div>

      {/* Video placeholder — always renders the dark player block.
          The day-gated CTAs / educational content below are still gated by
          `locked`; only the hero video slot is unconditional, matching the
          pattern across /day-7, /day-14, /challenge etc. */}
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px 24px' }}>
        <div style={{
          ...
          <p style={{
            ...
            Week One Progress Session · 8-9 min
          </p>
          <p style={{
