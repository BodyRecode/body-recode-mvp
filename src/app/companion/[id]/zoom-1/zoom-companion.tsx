        ...
        <div className="flex-1 flex overflow-hidden">
                ...
                {(['prompts', 'scorecard', 'language'] as const).map(tab => (
                  <button
                    ...
                    className={`text-xs font-semibold px-3 py-2 capitalize border-b-2 -mb-px transition-colors ${
                      activeTab === tab ? 'border-[#1B6DFC] text-[#1B6DFC]' : 'border-transparent text-stone-500 hover:text-stone-300'
                    }`}
                  >
          ...
          <div className="w-72 border-l border-stone-200 flex flex-col">
            <div className="p-4 border-b border-stone-200 flex items-center justify-between">
              ...
              <button
                onClick={saveNotes}
                className="text-xs text-[#1B6DFC] hover:text-white transition-colors font-semibold"
              >
                {saving ? 'Saving...' : 'Save'}
              </button>
            </div>
            ...
            <div className="p-4 border-t border-stone-200 space-y-3">
              ...
              <div className="bg-stone-900 border border-stone-800 rounded-lg p-3">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-[10px] font-bold text-emerald-700">A</span>
              ...
              <button
                ...
                className={`w-full text-xs font-bold px-3 py-2 rounded-lg transition-colors ${statusUpdated ? 'bg-emerald-500/10 border border-emerald-500/20 text-emerald-700' : 'bg-stone-800 border border-stone-700 text-stone-300 hover:border-stone-500 hover:text-white'}`}
              >
