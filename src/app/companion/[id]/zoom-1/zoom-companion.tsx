        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center bg-stone-900 border border-stone-800 rounded-lg p-0.5">
            <button
              ...
              className={`text-xs font-semibold px-3 py-1.5 rounded-md transition-colors ${view === 'live' ? 'bg-[#1B6DFC] text-black' : 'text-stone-400 hover:text-white'}`}
            >
              Live
            </button>
            <button
              onClick={() => setView('postcall')}
              className={`text-xs font-semibold px-3 py-1.5 rounded-md transition-colors ${view === 'postcall' ? 'bg-[#1B6DFC] text-black' : 'text-stone-400 hover:text-white'}`}
            >
              Post-Call
            </button>
          </div>
