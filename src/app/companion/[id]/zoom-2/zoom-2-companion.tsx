...
const OBJECTIONS = [
  {
    ...
    followup: 'If they remain hesitant on price — consider Objection Handling tab to explore the online option.',
    dropDown: true,
  },
  {
...
export default function Zoom2Companion({
  ...
  const [activeTab, setActiveTab] = useState<'prompts' | 'objection_triggered' | 'online' | 'signals'>('prompts')
            ...
            <div className="max-w-xl">
              ...
              <div className="flex gap-1 mb-5 border-b border-white/10 flex-wrap">
                {([
                  ...
                  { key: 'objection_triggered', label: 'Objection Handling', colour: 'amber' },
