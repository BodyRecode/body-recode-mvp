  ...
  if (done) {
    return (
      <div className="rounded-2xl border border-[#DCDCD7] bg-[#F2F2EF] p-6 text-center">
        <p className="text-[13.5px] font-semibold text-[#0F1115] mb-1">Results received</p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-[12.5px] font-medium text-[#9CA2AB] mb-1.5">Lab (optional)</label>
          <input
            type="text"
            value={labName}
            onChange={e => setLabName(e.target.value)}
            placeholder="e.g. QML, Sullivan Nicolaides"
            className="w-full rounded-xl border border-[#E4E4E0] bg-[#FFFFFF] px-3 py-2.5 text-[13.5px] text-[#0F1115] placeholder:text-[#9CA2AB] focus:border-[#0F1115] focus:outline-none"
          />
        </div>
        <div>
          <label className="block text-[12.5px] font-medium text-[#9CA2AB] mb-1.5">Date taken (optional)</label>
          <input
            type="date"
            value={collectedOn}
            onChange={e => setCollectedOn(e.target.value)}
            className="w-full rounded-xl border border-[#E4E4E0] bg-[#FFFFFF] px-3 py-2.5 text-[13.5px] text-[#0F1115] focus:border-[#0F1115] focus:outline-none"
          />
        </div>
      </div>
      ...
      <div>
        <label className="block text-[12.5px] font-medium text-[#9CA2AB] mb-1.5">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[#E4E4E0] bg-[#FFFFFF] px-3 py-2.5 text-[13.5px] text-[#0F1115] focus:border-[#0F1115] focus:outline-none"
        />
        <p className="mt-1.5 text-[12.5px] text-[#9CA2AB] leading-relaxed">
      ...
      <div>
        <label className="block text-[12.5px] font-medium text-[#9CA2AB] mb-1.5">Anything to add (optional)</label>
        <textarea
          value={clientNote}
          onChange={e => setClientNote(e.target.value)}
          rows={2}
          placeholder="e.g. my GP ordered these for fatigue"
          className="w-full rounded-xl border border-[#E4E4E0] bg-[#FFFFFF] px-3 py-2.5 text-[13.5px] text-[#0F1115] placeholder:text-[#9CA2AB] focus:border-[#0F1115] focus:outline-none resize-none"
        />
      </div>
      ...
      <div className="space-y-3 pt-1">
        ...
        />
        {consentMissing && (
          <p className="text-[13.5px] font-medium text-[#8F2D2D]">Please tick this before uploading.</p>
        )}
      </div>
