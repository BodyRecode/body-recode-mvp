  ...
  if (submitted) {
    return (
      <div className="rounded-2xl border border-[#14b8a6]/20 bg-[#14b8a6]/5 p-8 text-center">
        ...
        <p className="text-[#a8a29e] text-sm mb-6">Your coach will see this when they review your plan.</p>
        <button
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#111110] border border-[#1c1917] rounded-2xl px-4 py-3">
        <p className="text-xs text-[#57534e]">Current plan</p>
        <p className="text-sm font-semibold text-white mt-0.5">{planName}</p>
      </div>

      {/* Adherence */}
      <div>
        <p className="text-xs font-bold text-[#57534e] uppercase tracking-widest mb-3">Did you follow your plan?</p>
        <button
      ...
      {/* What did you notice */}
      <div>
        <p className="text-xs font-bold text-[#57534e] uppercase tracking-widest mb-3">What did you notice?</p>
      ...
      <div id="f-direction" className="scroll-mt-24">
        <p className={`text-xs font-bold uppercase tracking-widest mb-3 ${missing.has('direction') ? 'text-red-400' : 'text-[#57534e]'}`}>Overall - how are things going?</p>
