  ...
  if (submitted) {
    return (
      <div className="rounded-2xl border border-[#B5CFFC] bg-[#EFF5FE] p-8 text-center">
        ...
        <p className="text-[#666D7A] text-sm mb-6">Your coach will see this when they review your plan.</p>
        <button
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#FFFFFF] border border-[#E8EAEE] rounded-2xl px-4 py-3">
        <p className="text-xs text-[#98A0AD]">Current plan</p>
        <p className="text-sm font-semibold text-[#141821] mt-0.5">{planName}</p>
      </div>

      {/* Adherence */}
      <div>
        <p className="text-[12.5px] font-medium text-[#98A0AD] mb-3">Did you follow your plan?</p>
        <button
      ...
      {/* What did you notice */}
      <div>
        <p className="text-[12.5px] font-medium text-[#98A0AD] mb-3">What did you notice?</p>
      ...
      <div id="f-direction" className="scroll-mt-24">
        <p className={`text-xs font-bold uppercase tracking-widest mb-3 ${missing.has('direction') ? 'text-[#C82626]' : 'text-[#98A0AD]'}`}>Overall - how are things going?</p>
