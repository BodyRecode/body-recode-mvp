  ...
  if (submitted) {
    return (
      <div className="rounded-2xl border border-[#DCDCD7] bg-[#F2F2EF] p-8 text-center">
        ...
        <p className="text-[#6E747D] text-sm mb-6">Your coach will see this when they review your plan.</p>
        <button
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#FFFFFF] border border-[#E4E4E0] rounded-2xl px-4 py-3">
        <p className="text-xs text-[#9CA2AB]">Current plan</p>
        <p className="text-sm font-semibold text-[#0F1115] mt-0.5">{planName}</p>
      </div>
      ...
      <div id="f-direction" className="scroll-mt-24">
        <p className={`text-xs font-bold uppercase tracking-widest mb-3 ${missing.has('direction') ? 'text-[#8F2D2D]' : 'text-[#9CA2AB]'}`}>Overall - how are things going?</p>
