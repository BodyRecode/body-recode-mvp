...
const RestTimer = forwardRef<RestTimerHandle>(function RestTimer(_props, ref) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-[#E4E4E0] bg-white/95 backdrop-blur-sm shadow-[0_-4px_16px_rgba(0,0,0,0.06)]">
      <div className="max-w-md mx-auto px-4 py-3">
        {!active ? (
          <div className="flex items-center gap-2">
            <span className="text-[12.5px] font-medium text-[#6E747D] whitespace-nowrap">Rest timer</span>
          ...
          <div>
            {/* Progress bar */}
            <div className="h-1.5 rounded-full bg-[#E4E4E0] overflow-hidden mb-2.5">
              <div
                className={`h-full transition-[width] duration-300 ease-linear ${done ? 'bg-[#0F1115]' : 'bg-[#0F1115]'}`}
