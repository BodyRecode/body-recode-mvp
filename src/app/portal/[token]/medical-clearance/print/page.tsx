  ...
  return (
    <div className="min-h-screen bg-white text-black p-12 max-w-3xl mx-auto print:p-8">
      ...
      <div className="flex items-start justify-between mb-10">
        <div>
          <p className="text-xs font-bold tracking-widest uppercase text-[#4A4F57] mb-1">{brand().name}™</p>
        ...
        <button
          ...
          className="text-sm bg-[#0F1115] text-white font-semibold px-4 py-2 rounded-lg hover:bg-[#6E747D] transition-colors print:hidden"
        >
          Print / Save as PDF
        </button>
      </div>
      ...
      <div className="space-y-8 text-sm">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Full Legal Name</p>
              <p className="font-semibold text-base border-b border-[#4A4F57] pb-1">{client.name}</p>
            </div>
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Date of Birth</p>
              <div className="border-b border-[#4A4F57] pb-1 h-6" />
            </div>
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Primary Contact Details</p>
        ...
        <section>
          ...
          <p className="text-[#6E747D] text-xs mt-2">This request is precautionary and relates only to exercise participation eligibility.</p>
        </section>
        ...
        <section className="border border-[#4A4F57] rounded-lg p-5">
          ...
          <div className="space-y-4">
            {['Medical Practitioner Name', 'Provider Number', 'Practice Name', 'Contact Details'].map(label => (
              <div key={label}>
                <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">{label}</p>
                <div className="border-b border-[#4A4F57] pb-1 h-6" />
              </div>
            ))}
          </div>
          <div className="mt-5">
            <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-3">Participation Status (Select One)</p>
            <div className="space-y-2">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Effective Date</p>
              <div className="border-b border-[#4A4F57] pb-1 h-6" />
            </div>
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Review / Expiry Date</p>
              <div className="border-b border-[#4A4F57] pb-1 h-6" />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Signature</p>
              <div className="border-b border-[#4A4F57] pb-1 h-10" />
            </div>
            <div>
              <p className="text-xs font-semibold text-[#6E747D] uppercase tracking-wide mb-1">Date</p>
              <div className="border-b border-[#4A4F57] pb-1 h-10" />
            </div>
          </div>
        </section>

        <div className="border-t border-[#E4E4E0] pt-6 text-xs text-[#4A4F57]">
