    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-lg mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <h1 className="text-[30px] font-extrabold text-white tracking-tight leading-[1.1] mt-4 mb-2">Your readings</h1>
          <p className="text-[#a8a29e] text-[15px]">A read of how your body is currently organising itself. Updated when significant signals shift.</p>
        </div>

        {published.length === 0 ? (
          <div className="rounded-2xl border border-[#1c1917] bg-[#111110] p-6 text-center">
            <p className="text-[#a8a29e] text-[14px] mb-2">No readings yet</p>
            <p className="text-[#57534e] text-[12px] leading-relaxed">Your Foundational Reading will appear here once it has been finalised. Future weekly readings will join it.</p>
          </div>
        ) : (
          <div className="space-y-3">
            ...
            <Link
              ...
              className="group block rounded-2xl border border-[#14b8a6]/30 bg-[#14b8a6]/5 p-5 hover:border-[#14b8a6]/50 transition-colors"
            >
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#0c0a09] border border-[#14b8a6]/30 flex items-center justify-center shrink-0 mt-0.5">
                  <FileText size={16} className="text-[#14b8a6]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <p className="text-[15px] font-semibold text-white group-hover:text-[#14b8a6] transition-colors">Foundational Reading</p>
                    <span className="text-[10px] font-bold text-[#14b8a6] uppercase tracking-wider">Current</span>
                  </div>
                ...
                <ArrowUpRight size={14} className="text-[#14b8a6] shrink-0 mt-2" />
              </div>
            </Link>

            {published.length > 1 && (
              <>
                <p className="text-[10px] font-bold text-[#57534e] uppercase tracking-widest mt-6 mb-2 px-1">Earlier readings</p>
                {published.slice(1).map(r => (
                  <div
                    key={r.id}
                    className="block rounded-2xl border border-[#1c1917] bg-[#111110]/50 p-5 opacity-70"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[14px] font-semibold text-[#a8a29e] mb-1">Foundational Reading</p>
                        ...
                        <p className="text-[11px] text-[#3c3835] mt-1">Archived</p>
                      </div>
                    </div>
                  </div>
                ))}
