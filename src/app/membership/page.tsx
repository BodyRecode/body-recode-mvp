...
const PATTERNS: ColorCard[] = [
  ...
  { name: 'Insulin-Drift', colour: '#B7791F', tag: 'Insulin driver', signal: 'Mid-back, lower back and love handles rather than the front. Afternoon crash, evening cravings, foggy after meals.', bodyLabel: 'Block A prescription', body: 'Formal carb cycling introduced. Training days get more carbs, rest days fruit only. Protein target increases to 2.5 to 3 palms per day. Post-meal walk is non-negotiable.' },
