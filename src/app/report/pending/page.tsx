...
export default function ReportPendingPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF', color: 'white', fontFamily: 'system-ui, -apple-system, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <PurchaseTracker value={37} contentName="scorecard_report" />
      <div style={{ maxWidth: '480px', textAlign: 'center', padding: '40px 24px' }}>
        <img src="/logo-black.png" alt="Body Recode" style={{ height: '44px', marginBottom: '48px' }} />
        ...
        <p style={{ fontSize: '15px', color: '#999999', lineHeight: 1.7, marginBottom: '8px' }}>
