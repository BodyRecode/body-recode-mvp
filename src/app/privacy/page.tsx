    ...
    <div style={{
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '52px 24px 100px' }}>
        ...
        {section('1. Information We Collect', <>
          <p style={{ fontSize: '14px', fontWeight: 600, color: '#E5E5E5', margin: '0 0 8px' }}>A. Personal information you provide</p>
          ...
          <p style={{ fontSize: '14px', fontWeight: 600, color: '#E5E5E5', margin: '16px 0 8px' }}>B. Automatically collected information</p>
          {bullets(['IP address', 'Device and browser details', 'Pages viewed and time spent on site', 'Cookies and tracking technologies'])}
          <p style={{ fontSize: '14px', fontWeight: 600, color: '#E5E5E5', margin: '16px 0 8px' }}>C. Health and lifestyle information (voluntary)</p>
