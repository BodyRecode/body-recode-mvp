...
/**
 * B-roll canvas: Blueprint Six-Week Journey (9:16 VERTICAL)
 *
 * Vertical (1080×1920) sibling of /broll/blueprint-six-weeks. Same content
 * and copy, re-laid-out for portrait screen recording so it can be used as
 ...
 *
 * The horizontal /broll/blueprint-six-weeks page is unchanged and still
 * serves the 16:9 master of the Blueprint explainer.
 *
 ...
 *   - Portal mockup's three tiles stack into a single column
 *   - Headlines scaled down, side padding reduced for the narrow frame
 *
 * URL: /broll/blueprint-six-weeks-vertical (noindex - see /broll/layout.tsx)
 */
...
export default function BlueprintSixWeeksVerticalPage() {
  return (
    <div style={{
      width: '100%',
      maxWidth: '1080px',
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto', width: '100%', position: 'relative' }}>
          ...
          <p style={{ fontSize: '22px', color: '#4A4A4A', lineHeight: 1.5, marginBottom: '40px' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <p style={{ fontSize: '12px', fontWeight: 700, color: '#999999', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 4px' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '12px' }}>
                <div style={{
                  ...
                  <FileText size={19} strokeWidth={2.5} color="#FFFFFF" />
                </div>
                <div>
                  <p style={{ fontSize: '11px', fontWeight: 800, color: '#1056D6', letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}>
            ...
            {/* Three tiles - stacked for portrait */}
                ...
                return (
                  <div key={i} style={{
                    ...
                    <div style={{
                      ...
                      <Icon size={20} strokeWidth={2.5} color="#1B6DFC" />
                    </div>
                    <div>
                      <p style={{ fontSize: '15px', fontWeight: 800, color: '#1A1A1A', margin: '0 0 3px' }}>
                        {t.label}
                      </p>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto', width: '100%' }}>
          ...
          <h1 style={{ fontSize: '52px', fontWeight: 900, color: '#1A1A1A', letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: '20px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '22px' }}>
              <div style={{
                ...
                <Compass size={22} strokeWidth={2.5} color="#FFFFFF" />
              </div>
              <div>
                <p style={{ fontSize: '12px', fontWeight: 800, color: '#dc2626', letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}>
                  Stress-Stored · Midpoint Reflection
                </p>
                <p style={{ fontSize: '20px', fontWeight: 800, color: '#1A1A1A', margin: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {MIDPOINT_QUESTIONS.map((q, i) => (
                <div key={i} style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                  ...
                  <p style={{ fontSize: '18px', color: '#3A3A3A', margin: 0, lineHeight: 1.5 }}>{q}</p>
                </div>
              ))}
            </div>

            <p style={{ fontSize: '14px', color: '#6B6B6B', fontStyle: 'italic', margin: '26px 0 0', paddingTop: '22px', borderTop: '1px solid #E5E5E5', lineHeight: 1.6 }}>
        ...
        <div style={{ maxWidth: '960px', margin: '0 auto', width: '100%', position: 'relative' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                <div style={{
                  ...
                  <CheckCircle2 size={24} strokeWidth={2.5} color="#FFFFFF" />
                </div>
                <div>
                  <p style={{ fontSize: '12px', fontWeight: 700, color: '#999999', letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}>
            ...
            <div style={{ padding: '34px 32px' }}>
              <p style={{ fontSize: '12px', fontWeight: 800, color: '#1B6DFC', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 10px' }}>
                What comes next
              </p>
              <p style={{ fontSize: '26px', fontWeight: 800, color: '#1A1A1A', letterSpacing: '-0.015em', margin: '0 0 14px', lineHeight: 1.2 }}>
                Block A loads automatically when you join the Membership.
              </p>
              <p style={{ fontSize: '16px', color: '#4A4A4A', lineHeight: 1.65, margin: '0 0 26px' }}>
              ...
              <p style={{ fontSize: '13px', color: '#6B6B6B', margin: '16px 0 0', fontStyle: 'italic' }}>
