...
export const alt = 'B-Roll Canvas: The Long Arc. Production utility page for the Body Recode Membership explainer video.'
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            fontSize: '84px', fontWeight: 900, color: '#1A1A1A',
            lineHeight: 1.0, letterSpacing: '-0.035em', marginBottom: '24px',
            display: 'flex', flexDirection: 'column',
          }}>
            <div>The Long Arc</div>
          </div>
          <div style={{
          ...
          <div style={{
            ...
            Three production zones: the cycle of programmes ending, the months-long state-shift arc, the 24-week block structure.
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            bodyrecode.au/broll/the-long-arc
          </div>
        </div>
      </div>
    ),
