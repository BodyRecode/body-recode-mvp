...
export default function HermonyCoaching() {
  ...
  const statusToPill: Record<string, { label: string; accent: 'teal' | 'amber' | 'red' | 'neutral' }> = {
    active_settling:   { label: 'Settling',   accent: 'amber' },
    active_building:   { label: 'Building',   accent: 'teal' },
    active_expression: { label: 'Expression', accent: 'teal' },
  ...
  return (
    <div className="max-w-[1100px]">
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-8">
        ...
        <Card>
          <SectionLabel accent="teal">Readings ready to notify</SectionLabel>
          <p className="text-[13px] text-[#4B4B4B] leading-relaxed mb-3">
