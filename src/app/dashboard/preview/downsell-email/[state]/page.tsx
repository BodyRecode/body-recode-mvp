  ...
  return (
    <div className="max-w-3xl space-y-10">
      <div>
        ...
        <h1 className="text-xl font-semibold text-white">{stateLabel} State - Downsell Emails</h1>
      ...
      <div className="flex gap-3">
        {['depleted', 'transitioning', 'ready'].map(s => (
          <a
            ...
            className={`text-sm font-medium px-4 py-2 rounded-lg border transition-colors ${s === state ? 'bg-teal-500/10 border-teal-500/30 text-teal-400' : 'border-stone-700 text-stone-400 hover:text-white hover:border-stone-500'}`}
          >
            {STATE_LABELS[s]}
          </a>
        ))}
