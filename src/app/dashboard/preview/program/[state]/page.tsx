...
export default async function PreviewProgramPage({
  ...
  const stateColour = STATE_COLOURS[state]

  return (
    <div style={{ background: '#0a0a0a', minHeight: '100vh', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      {/* Preview banner */}
      <div style={{ background: '#1a1a00', borderBottom: '1px solid #333300', padding: '10px 24px', textAlign: 'center' }}>
        <span style={{ fontSize: '12px', color: '#aaaa00', fontWeight: 600 }}>
          PREVIEW MODE - This is what the client sees after purchase
        </span>
