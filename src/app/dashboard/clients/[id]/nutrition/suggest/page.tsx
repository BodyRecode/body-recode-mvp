    ...
    <div className="max-w-[980px]">
      <div className="mb-8">
        <div className="flex items-center gap-2 text-[#8A9099] text-sm br-page-header sticky top-0 z-20 mb-7 pt-4 pb-3.5 border-b border-[#2A2F39] bg-[#14171D]/[0.88] backdrop-blur-md print:static print:bg-transparent">
          ...
          <span>/</span>
          <span className="text-[#FAFAF8]">Prescription</span>
        </div>
        <h1 className="text-[20px] font-semibold text-[#FAFAF8] tracking-[-0.025em]">Nutrition Prescription</h1>
        <p className="text-[#8A9099] text-sm mt-1">Review the suggested prescription before generating the plan.</p>
      </div>
