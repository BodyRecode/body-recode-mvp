    ...
    <div className="bg-[#14171D] br-card overflow-hidden">
      ...
      {reviews && reviews.length > 0 ? (
            ...
            <div key={review.id} className="px-5 py-4 space-y-2.5">
              ...
              <div className="space-y-1.5">
                <div className="flex gap-2">
                  <span className="text-[12.5px] text-[#676D76] w-36 shrink-0">Followed plan</span>
                ...
                {review.signal_category && (
                  <div className="flex gap-2">
                    <span className="text-[12.5px] text-[#676D76] w-36 shrink-0">What they noticed</span>
        ...
        <div className="px-5 py-6 text-center">
          ...
          <p className="text-[12.5px] text-[#FAFAF8] mt-1">
