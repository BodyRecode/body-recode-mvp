    ...
    <div className="mb-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {emailSent && (
            <span
              className={`inline-flex items-center gap-1.5 text-[10px] px-2 py-0.5 rounded-full border ${
                opened
                  ? 'border-[#1A1E26] bg-[#14171D] text-[#6FA98B]'
                  : 'border-[#4A3A22] bg-[#1A1E26] text-[#E0A254]'
              }`}
              title={
                opened
      ...
      {!generated ? (
        <div className="br-card p-8 text-center">
          <p className="text-[#8A9099] text-[13.5px] mb-2">No client-facing read yet</p>
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-[#2A2F39] flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-[11px] font-medium px-2.5 py-1 rounded-md border border-[#2A2F39] bg-[#14171D] text-[#C2C6CC] hover:border-[#FAFAF8] hover:bg-[rgba(27,109,252,0.06)] hover:text-[#FAFAF8] transition-colors"
              >
                Preview
              </Link>
              <Link
