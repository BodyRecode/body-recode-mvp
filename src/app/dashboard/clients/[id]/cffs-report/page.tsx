        ...
        <div style={{ background: PAGE_BG, padding: '48px 52px 64px' }}>
          ...
          <div style={{ background: INK, padding: '36px 40px', marginBottom: 40, borderRadius: 6 }}>
            ...
            <p style={{ fontSize: 13, fontWeight: 400, color: '#a3a3a3', lineHeight: 1.85, marginBottom: 12 }}>
              The Coach-Facing Foundational Synthesis (CFFS) is generated by the Body Recode interpretation engine following completion of the Foundational Intake. It translates 221 data points across eight signal domains into a single, coherent picture of the client&apos;s current body state: their regulatory load, recovery capacity, training exposure, stress architecture, and behavioural patterns.
            </p>
            <p style={{ fontSize: 13, fontWeight: 400, color: '#a3a3a3', lineHeight: 1.85, marginBottom: 12 }}>
