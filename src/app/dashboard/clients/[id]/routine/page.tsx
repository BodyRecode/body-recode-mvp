  ...
  return (
    <div className="w-full">
      ...
      {!hasCustomisations && !hasDraft && (
        <p className="text-[12.5px] text-[#676D76] -mt-2 mb-6">
      ...
      <div className="mt-10 mb-4 flex items-center gap-3">
        <h2 className="text-lg font-semibold text-[#FAFAF8]">Live routine</h2>
        <span className="text-[10px] text-[#8A9099]">What the client sees on their portal</span>
      </div>
