    ...
    <div className="bg-[#F2F2EF] br-card overflow-hidden">
      ...
      <div className="p-5 flex gap-6">
        ...
        <div className="shrink-0 w-40">
          <p className="text-[10px] font-medium text-[#9CA2AB] mb-3">Cross-Pillar Order</p>
            ...
            {PILLARS.map((p, i) => (
              <div key={p.label} className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#9CA2AB] leading-tight">{p.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="flex-1 min-w-0 space-y-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[10px] font-medium text-[#6E747D]">Macro Arc</p>
              {plan && <p className="text-[10px] text-[#9CA2AB] ml-auto">{totalWeeks}w total</p>}
            </div>
                    ...
                    {plan.plan_blocks.map((block, i) => (
                      <div key={block.id} className="flex items-center gap-1">
                        ...
                        {i < plan.plan_blocks.length - 1 && (
                          <span className="text-[#0F1115] text-[10px]">›</span>
                        )}
                      </div>
                    ))}
                  </div>
          ...
          <div className="flex items-center gap-2 pl-1">
            ...
            <span className="text-[10px] text-[#0F1115]">current block</span>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[10px] font-medium text-[#6E747D]">Meso Block</p>
            </div>
          ...
          <div className="flex items-center gap-2 pl-1">
            <div className="w-px h-3 bg-[#E4E4E0] ml-0.5" />
            <span className="text-[10px] text-[#0F1115]">generates program</span>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[10px] font-medium text-[#6E747D]">Micro Program</p>
            </div>
            ...
            {activeProgram ? (
              <div className="px-3 py-2 rounded-lg bg-[#EDEDEA]/50 border border-[#E4E4E0]">
                ...
                <p className="text-[10px] text-[#6E747D] mt-0.5 capitalize">
          ...
          <div className="flex items-center gap-2 pl-1">
            <div className="w-px h-3 bg-[#E4E4E0] ml-0.5" />
            <span className="text-[10px] text-[#0F1115]">supported by</span>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[10px] font-medium text-[#6E747D]">Nutrition Support</p>
            </div>

            {nutritionPlan ? (
              <div className="flex gap-2 flex-wrap">
                {nutritionPlan.entry_state && (
                  <span className="text-[10px] px-2 py-1 bg-[rgba(27,109,252,0.08)] border border-[#0F1115]/20 rounded text-[#0F1115] capitalize">
                    {nutritionPlan.entry_state}
                  </span>
                )}
                {nutritionPlan.carb_demand_level && (
                  <span className="text-[10px] px-2 py-1 bg-[#EDEDEA] border border-[#E4E4E0] rounded text-[#6E747D] capitalize">
      ...
      <div className="px-5 py-3 border-t border-[#E4E4E0] flex items-center gap-4 flex-wrap">
        {[
          ...
          <div key={item.label} className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-[#9CA2AB]">{item.label}</span>
          </div>
        ))}
      </div>
    </div>
