...
export default async function CoachSupplementsPage({
  ...
  return (
    <div className="max-w-[980px]">
      ...
      <p className="text-[12.5px] text-[#676D76] -mt-2 mb-6 leading-relaxed">
        The substance library lives in code. Research reports and doctrine rationale sit at <code className="bg-[#14171D] px-1 rounded">~/Dropbox/01_BODY_RECODE/00_PLAYBOOK/supplement_research/</code>; add substances in <code className="bg-[#14171D] px-1 rounded">src/lib/supplement-substances-seed.ts</code>.
      </p>
