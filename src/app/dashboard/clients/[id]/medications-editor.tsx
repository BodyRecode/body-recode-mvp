...
export default function MedicationsEditor({
  ...
  return (
    <div className="br-card p-6 mb-4">
      ...
      <p className="text-[#9CA2AB] text-[12.5px] mb-3">
      ...
      {showStaleBanner && (
        <div className="mb-3 px-3 py-2.5 rounded-lg border border-[#B06E1F]/50 bg-[#B06E1F]/5">
      ...
      {editing ? (
        <div className="space-y-3">
          <textarea
            ...
            className="w-full bg-[#FFFFFF] border border-[#E4E4E0] rounded-lg p-3 text-[#0F1115] text-sm leading-relaxed focus:outline-none focus:border-[#DCDCD7] placeholder-[#4A4F57] min-h-[120px]"
          />
        ...
        <p className="text-sm text-[#4A4F57] leading-relaxed whitespace-pre-line">{value}</p>
      ) : (
        <p className="text-sm text-[#4A4F57] italic">None reported.</p>
      )}
    </div>
  )
}
