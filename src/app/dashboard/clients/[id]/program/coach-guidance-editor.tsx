    ...
    <div className="bg-[#111110] border border-[#1c1917] rounded-2xl overflow-hidden mb-3">
      ...
      {open && (
        <div className="px-5 pb-4 border-t border-[#1c1917]">
          ...
          {/* AI assist panel */}
          <div className="mb-3 border border-[#1c1917] rounded-lg bg-[#0c0a09]">
            <button
              onClick={() => setAssistOpen(o => !o)}
              className="w-full flex items-center justify-between gap-2 px-3 py-2 hover:bg-[#1c1917]/40 transition-colors text-left"
            >
              <div className="flex items-center gap-2">
                <Sparkles size={12} className="text-[#14b8a6]" />
                <span
                  className="text-[10px] font-bold text-[#d4cfc9] uppercase"
                  style={{ fontFamily: MONO_FONT, letterSpacing: '0.12em' }}
                >
                  Suggest with AI
                </span>
              </div>
              <span className="text-[10px] text-[#57534e]">{assistOpen ? 'Close' : 'Open'}</span>
            </button>
            {assistOpen && (
              <div className="px-3 pb-3 border-t border-[#1c1917]">
                <div className="pt-3 mb-3">
                  <p
                    className="text-[10px] font-bold text-[#a8a29e] uppercase mb-1.5"
                    style={{ fontFamily: MONO_FONT, letterSpacing: '0.12em' }}
                  >
                    Intent
                  </p>
                      ...
                      return (
                        <button
                          ...
                          className={`text-[11px] px-2.5 py-1 rounded-full border transition-colors ${
                            active
                              ? 'bg-[rgba(20,184,166,0.12)] border-[#0d2d29] text-[#14b8a6]'
                              : 'bg-[#0c0a09] border-[#1c1917] text-[#a8a29e] hover:border-[#292524]'
                          }`}
                        >
                          {opt.label}
                        </button>
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-[#111110] border border-[#1c1917] rounded-lg px-2.5 py-2 text-[12px] text-[#e7e5e4] placeholder:text-[#3c3835] focus:outline-none focus:border-[#292524] leading-relaxed resize-y"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={suggest}
                    disabled={suggesting}
                    className="inline-flex items-center gap-1.5 text-[12px] font-semibold px-3 py-1.5 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed border border-[#14b8a6] bg-[rgba(20,184,166,0.10)] text-[#14b8a6] hover:bg-[rgba(20,184,166,0.18)]"
                  >
