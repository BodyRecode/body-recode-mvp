...
const directionColour: Record<string, string> = {
  ...
  deload: 'text-[#000000] bg-[rgba(27,109,252,0.08)] border-[#DCDCD7]',
}
    ...
    <div className="bg-[#F2F2EF] br-card overflow-hidden">
      ...
      {reviews && reviews.length > 0 ? (
            ...
            <div key={review.id} className="px-5 py-4 space-y-2.5">
              ...
              <div className="space-y-1.5">
                <div className="flex gap-2">
                  <span className="text-[12.5px] text-[#9CA2AB] w-36 shrink-0">Sessions completed</span>
                ...
                {review.signal_category && (
                  <div className="flex gap-2">
                    <span className="text-[12.5px] text-[#9CA2AB] w-36 shrink-0">How training felt</span>
        ...
        <div className="px-5 py-6 text-center">
          ...
          <p className="text-[12.5px] text-[#0F1115] mt-1">Client submits their weekly training check-in via the portal.</p>
        </div>
      )}
    </div>
  )
