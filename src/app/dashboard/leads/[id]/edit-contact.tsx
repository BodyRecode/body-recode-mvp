...
export default function EditContact({ leadId, name, email, phone }: Props) {
    ...
    return (
      <div className="bg-stone-900 border border-stone-800 rounded-xl p-6 mb-4">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-stone-300 uppercase tracking-wider">Contact</h2>
          <button
  ...
  return (
    <div className="bg-stone-900 border border-stone-800 rounded-xl p-6 mb-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-sm font-semibold text-stone-300 uppercase tracking-wider">Contact</h2>
        <button onClick={cancel} className="text-xs text-stone-500 hover:text-stone-300 transition-colors">
          Cancel
        </button>
      </div>
      <div className="space-y-3">
        ...
        <button
          ...
          className="bg-white text-stone-950 text-sm font-medium px-5 py-2 rounded-lg hover:bg-stone-100 transition-colors disabled:opacity-50"
        >
          {saving ? 'Saving...' : 'Save'}
        </button>
      </div>
