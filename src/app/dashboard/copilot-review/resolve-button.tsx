...
export default function ResolveButton({ clientId, messageId }: { clientId: string; messageId: string }) {
  ...
  return (
    <button
      ...
      onClick={resolve}
      disabled={busy}
      className="inline-flex items-center gap-1.5 text-[12.5px] font-medium px-3 py-1.5 rounded-md border border-[#2A2F39] text-[#4B4B4B] hover:text-[#FAFAF8] hover:bg-[#F6F6F6] transition-colors disabled:opacity-50"
    >
