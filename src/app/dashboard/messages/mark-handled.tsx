  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold px-3 py-1.5 rounded-lg border border-[#2A2F39] text-[#C2C6CC] hover:border-[#FAFAF8] hover:text-[#FAFAF8] transition-colors disabled:opacity-50"
      >
        {busy
      ...
      {error && <span className="text-[12.5px] font-semibold text-[#D4817E]">{error}</span>}
    </div>
  )
}
