    ...
    <div className="pt-2">
      {!open ? (
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl border border-dashed border-[#CFD4DC] px-4 py-3 text-[12.5px] font-semibold text-[#666D7A] hover:border-[#1B6DFC]/50 hover:text-[#1B6DFC] transition-colors"
        >
          <Plus size={13} />
        ...
        <div className="rounded-xl border border-[#E8EAEE] bg-[#FFFFFF] p-2">
          <p className="text-[11px] font-medium text-[#98A0AD] px-2 py-1.5">
            Not messaged yet
          </p>
          <div className="max-h-64 overflow-y-auto">
            {clients.map(c => (
              <button
                ...
                className="block w-full text-left px-2 py-2 rounded-lg text-[12.5px] text-[#43474F] hover:bg-[#F3F7FF] hover:text-[#1B6DFC] transition-colors"
              >
                {c.name}
              </button>
            ))}
