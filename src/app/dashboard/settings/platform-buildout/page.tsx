    ...
    <div className="max-w-[1100px]">
      ...
      <details className="mb-6 p-4 rounded-2xl border border-blue-200 bg-blue-50/40">
        ...
        <div className="mt-3 space-y-3 text-[13px] text-stone-700 leading-relaxed">
          <p><strong>What this is.</strong> The platform buildout is Kade&apos;s already-scoped plan to turn Body Recode from a solo coach business into a licensable multi-tenant platform (The Body Recode Collective). It has five phases (0-4) that must be tackled in order — earlier phases lock decisions and unblock later ones.</p>
