...
import { PHASES } from '@/lib/performance-coaching-buildout-manifest'
      ...
      explainer={
        <details className="mb-6 p-4 rounded-xl border border-[#B5CFFC] bg-[rgba(27,109,252,0.08)]/40">
          ...
          <div className="mt-3 space-y-3 text-[13px] text-[#141821] leading-relaxed">
            ...
            <p><strong>Where this sits in the plan.</strong> The coaching application is deliberately <em>not</em> being waited for. The read goes to market first. This becomes the second tier sold to coaches already paying for the read — which is also how it finally gets finished on real coaches&apos; feedback rather than guesses.</p>
            ...
            <p><strong>⚠ This board is incomplete on purpose.</strong> The two real phases below carry verified history. The rest of Layer 2 has not been audited into steps yet, and it is left empty rather than filled with guesses — an invented status makes the percentage at the top start lying and nobody notices.</p>
          </div>
        </details>
      }
      footer={
