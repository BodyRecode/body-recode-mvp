...
const STAGES: StageGroup[] = [
  ...
  {
    stage: 'Funnel B · Stage 1 · 14-Day Body Decode Challenge (FREE)',
    blurb: 'Marketing landing + token-gated participant portal across 14 days. Token-linked pages render using the current Test Participant.',
    accent: '#DC2626',
    funnel: 'B',
    pages: [
      ...
      { name: 'Day 14 framing page', url: '/challenge/{token}/day-14', description: 'Day 14 Read host + framing for the Body Decode Report.', tokenKind: 'challenge' },
      { name: 'Day 5 preview (no Supabase)', url: '/challenge/preview/day-5', description: 'Day 5 preview with mocked enrollment. For design review.' },
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'Intake (221 questions)', url: '/intake/{token}', description: 'Foundational intake form. Triggers CFFS generation.', tokenKind: 'intakeFoundational' },
