...
export default async function CmoPage() {
  ...
  return (
    <div className="max-w-[1100px]">
      ...
      <h3 className="text-[11px] font-medium text-[#8A9099] mb-3">Funnel volumes (trailing 30d)</h3>
      ...
      <h3 className="text-[11px] font-medium text-[#8A9099] mb-3">Conversion rates</h3>
      ...
      <h3 className="text-[11px] font-medium text-[#8A9099] mb-3">Wave 1 status</h3>
      <div className="mb-8 br-card p-5">
        <div className="flex items-baseline justify-between mb-3 gap-4 flex-wrap">
          <div>
            ...
            <div className="text-[20px] font-bold text-[#FAFAF8] mt-1">
              Wave {snap.waveNumber ?? '?'} · {snap.waveLabel ?? 'unknown'}
            </div>
          </div>
          <div className="text-right">
            <div className="text-[11px] font-medium text-[#8A9099]">Fill</div>
            <div className="text-[20px] font-bold text-[#FAFAF8] mt-1 font-mono">
      ...
      <h3 className="text-[11px] font-medium text-[#8A9099] mb-3">Ad performance (last 30d)</h3>
      ...
      <h3 className="text-[11px] font-medium text-[#8A9099] mb-3">Content pulse</h3>
...
function FunnelStep({ label, value }: { label: string; value: number | null }) {
  return (
    <div className="br-card p-3 text-center">
      ...
      <div className="text-[20px] font-bold text-[#FAFAF8] font-mono">
