        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-stone-900 border border-stone-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-stone-400 mb-1.5">Product Name</label>
                <input
                  type="text"
                  value={form.name}
              ...
              <div>
                <label className="block text-xs font-medium text-stone-400 mb-1.5">Price (AUD)</label>
              ...
              {form.type === 'subscription' && (
                <div>
                  <label className="block text-xs font-medium text-stone-400 mb-1.5">Billing Interval</label>
                  <div className="flex gap-2">
                    {[
