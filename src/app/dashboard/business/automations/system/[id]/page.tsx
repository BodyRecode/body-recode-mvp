    ...
    steps: [
      {
        ...
        paragraphs: [
          'Hi {firstName},',
          'Your portal is open. Four steps to complete before we start coaching: Coaching Agreement, Health Declaration, Foundational Intake (221 questions across 8 areas), and Baseline Documentation.',
