...
export default async function SystemAutomationDetailPage({
  ...
  return (
    <div style={{ maxWidth: '680px', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      {/* Breadcrumb */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#676D76', marginBottom: '32px' }}>
        <Link href="/dashboard/business/automations" style={{ color: '#676D76', textDecoration: 'none' }} className="hover:text-[#FAFAF8] transition-colors">
          Automations
        </Link>
        <span>/</span>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ width: '28px', height: '3px', background: '#FAFAF8', borderRadius: '2px', marginBottom: '20px' }} />
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
          <div>
            <h1 style={{ fontSize: '22px', fontWeight: 800, color: '#FAFAF8', letterSpacing: '-0.02em', marginBottom: '6px' }}>
              {automation.name}
            </h1>
            <p style={{ fontSize: '14px', color: '#8A9099', lineHeight: 1.6 }}>{automation.description}</p>
          </div>
          <span style={{
            flexShrink: 0, display: 'flex', alignItems: 'center', gap: '6px',
            fontSize: '11px', fontWeight: 700, letterSpacing: '0.06em',
            color: '#FAFAF8', background: 'rgba(27,109,252,0.08)',
      ...
      {/* Trigger */}
      <div style={{ background: '#14171D', border: '1px solid #2A2F39', borderRadius: '12px', padding: '20px 24px', marginBottom: '32px' }}>
        <p style={{ fontSize: '10px', fontWeight: 700, color: '#676D76', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '8px' }}>Trigger</p>
        <p style={{ fontSize: '15px', fontWeight: 600, color: '#FAFAF8', marginBottom: '4px' }}>{automation.trigger}</p>
        <p style={{ fontSize: '13px', color: '#8A9099', lineHeight: 1.6 }}>{automation.triggerDetail}</p>
      </div>

      {/* Steps */}
      <p style={{ fontSize: '10px', fontWeight: 700, color: '#676D76', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px' }}>
        Email Sequence - {automation.steps.length} emails
      </p>

      <div style={{ position: 'relative' }}>
        <div style={{ position: 'absolute', left: '19px', top: '40px', bottom: '40px', width: '1px', background: '#2A2F39' }} />
          ...
          {automation.steps.map((step, i) => (
            <div key={i} style={{ display: 'flex', gap: '16px' }}>
              ...
              <div style={{
                ...
                background: '#14171D', border: '1px solid #2A2F39',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                position: 'relative', zIndex: 1,
              }}>
                <span style={{ fontSize: '12px', fontWeight: 700, color: '#676D76' }}>{i + 1}</span>
              </div>

              {/* Card */}
              <div style={{ flex: 1, background: '#14171D', border: '1px solid #2A2F39', borderRadius: '12px', overflow: 'hidden', marginBottom: '4px' }}>

                {/* Step header */}
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 18px', borderBottom: '1px solid #2A2F39', background: '#F8F8F8' }}>
                  <span style={{ fontSize: '12px', fontWeight: 700, color: '#FAFAF8' }}>{step.day}</span>
                  <span style={{ fontSize: '11px', color: '#676D76', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Email</span>
                </div>

                {/* Subject */}
                <div style={{ padding: '16px 18px 14px', borderBottom: '1px solid #2A2F39' }}>
                  <p style={{ fontSize: '10px', fontWeight: 700, color: '#676D76', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '6px' }}>Subject</p>
                  <p style={{ fontSize: '14px', fontWeight: 600, color: '#FAFAF8' }}>{step.subject}</p>
                </div>

                {/* Body */}
                <div style={{ padding: '16px 18px 14px', borderBottom: '1px solid #2A2F39' }}>
                  <p style={{ fontSize: '10px', fontWeight: 700, color: '#676D76', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '12px' }}>Body</p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    {step.paragraphs.map((para, j) => (
                      <p key={j} style={{ fontSize: '13px', color: '#8A9099', lineHeight: 1.75 }}>{para}</p>
                    ))}
                  </div>
                </div>
                ...
                <div style={{ padding: '14px 18px' }}>
                  <p style={{ fontSize: '10px', fontWeight: 700, color: '#676D76', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '10px' }}>CTA</p>
                  <span style={{
                    display: 'inline-block', padding: '8px 16px',
                    background: '#FAFAF8', color: '#FAFAF8',
