          ...
          <Card className="border-blue-500/30 bg-blue-500/5">
            ...
            <div className="mt-3 space-y-2 text-xs">
              ...
              <div className="bg-white/70 border border-violet-500/20 rounded-lg p-3">
                ...
                <p className="text-stone-700 leading-relaxed mt-2"><strong className="text-amber-700">The trap:</strong> the scorecard fires <code className="bg-stone-100 px-1 rounded text-[#1B6DFC] text-[11px]">CompleteRegistration</code>, and men CAN complete the scorecard. If the campaign optimises on that instead, Meta counts men as conversions and keeps buying traffic that cannot convert downstream. <strong>Fix the event, not the audience.</strong></p>
                <p className="text-stone-700 leading-relaxed mt-2"><strong className="text-amber-700">Open decision · /book fires nothing.</strong> A male who books a strategy call is invisible to Meta, so the algorithm is being trained AWAY from the one outcome male traffic produces - and a 30-minute call converting to 1:1 is worth many multiples of a $97 Blueprint. If a booking counts as a conversion it needs its own CAPI event. Roughly 20 minutes of work, and it changes what Meta optimises toward, so it is Kade&apos;s call.</p>
