          ...
          <Card className="border-blue-500/30 bg-blue-500/5">
            ...
            <div className="mt-3 space-y-2 text-xs">
              ...
              <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
                ...
                <p className="text-stone-700 leading-relaxed mt-2"><strong className="text-amber-700">Broad is all genders, and The Body Decode is not.</strong> The page opens &quot;for women whose bodies have stopped responding&quot;, the signup form turns men away, and the scorecard routes them to a strategy call instead (25 Aug). Men were <strong>3 of the 29 typed leads, about 10%</strong>, so roughly that share of spend reaches someone who cannot take the free offer. Kept broad deliberately - narrowing is what caused the July exhaustion, and a male click still produces a call booking rather than nothing. <strong>Watch it rather than fix it:</strong> if the male share climbs well past 10% once volume arrives, that is a creative signal, not a targeting one.</p>
              </div>
