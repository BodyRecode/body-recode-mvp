        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="clients-dashboard" title="13. Clients Dashboard" colour="teal">
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>CFWS readiness marks</strong> - Four marks (Capacity, Schedule, Regulation, Behaviour) from the latest weekly synthesis. <strong>They no longer carry a colour (23 Sep 2026)</strong>, because they were borrowing the readiness and Attention colours and teaching the same amber two meanings. Hollow means <strong>Not limiting</strong>, soft means <strong>Limiting</strong> (holding them back enough to shape how much is asked), solid means <strong>Main limit</strong> (the one holding everything else back). The stored values are still Green, Amber and Red.</li>
