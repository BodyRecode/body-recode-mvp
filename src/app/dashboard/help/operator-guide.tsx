...
const SECTIONS = [
  ...
  { id: 'foundational-reading',  title: '10b. Foundational Read', colour: 'teal' as const, category: 'coaching' as Category },
  ...
  { id: 'program-reading',  title: '20b. Program Read',   colour: 'teal' as const, category: 'coaching' as Category },
  { id: 'trajectory-reading', title: '20c. Progress Read', colour: 'teal' as const, category: 'coaching' as Category },
  ...
  { id: 'nutrition-reading', title: '22b. Nutrition Read', colour: 'teal' as const, category: 'coaching' as Category },
...
export default function OperatorGuide() {
          ...
          {CATEGORIES.map(cat => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-colors border ${
                activeTab === cat.id
                  ? 'bg-[#F2F2EF] text-[#0F1115] border-[#DCDCD7]'
                  : 'bg-[#EDEDEA] text-[#6E747D] border-[#E4E4E0] hover:text-[#0F1115]'
              }`}
            >
              {cat.label}
            </button>
        ...
        <nav className="w-48 shrink-0 sticky top-[104px] self-start overflow-y-auto max-h-[calc(100vh-8rem)]">
          <ul className="space-y-0.5">
            {SECTIONS.filter(s => s.category === activeTab).map(({ id, title, colour }) => {
              ...
              const activeColour = colour === 'violet' ? 'text-violet-700' : colour === 'amber' ? 'text-[#B06E1F]' : 'text-[#0F1115]'
              return (
                <li key={id}>
                  <button
                    onClick={() => scrollTo(id)}
                    className={`w-full text-left text-xs px-3 py-1.5 rounded-lg transition-colors leading-snug ${
                      isActive
                        ? `${activeColour} bg-[#EDEDEA] font-semibold`
                        : 'text-[#9CA2AB] hover:text-[#4A4F57] hover:bg-[#EDEDEA]/50'
                    }`}
                  >
                    {title}
                  </button>
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="operator-flow" title="Operator Flow - Lead to Active Client" colour="violet">
            ...
            <div className="space-y-6 mt-2">
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 1 - Lead Arrives</p>
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 2 - Zoom</p>
                <div className="space-y-2">
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 3 - Coaching Entry</p>
                <div className="space-y-2">
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 5 - Client Setup</p>
                <div className="space-y-2">
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 6 - Training Program</p>
                <div className="space-y-2">
              ...
              <div>
                <p className="text-[12.5px] font-medium text-[#6E747D] mb-3">Phase 7 - Nutrition Plan</p>
                <div className="space-y-2">
          ...
          <Section id="funnel-dashboard" title="Funnel Dashboard" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Summary cards</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Attention flags</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Tabs</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Search</p>
          ...
          <Section id="brand-voice" title="Brand Voice - Layered Buyer Language" colour="violet">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">The principle</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">By layer</p>
            <StatusList items={[
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Hard rules</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Reference docs</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/2026-04-30_Buyer_Language_Rewrite.md</code> - full diagnostic, every before/after, IG bio variants</li>
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/2026-05-01_Pre_Call_Brief_Template.md</code> - locked 13-section template for pre-call briefs</li>
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/2026-05-01_May_Post_Revisions.json</code> - 22 revised IG post captions, all in the new voice</li>
            </ul>
          ...
          <Section id="coach-copilot" title="Coach Co-Pilot - Doctrine Tutor" colour="violet">
            ...
            <Note>New: there is a full step-by-step course at <a href="/dashboard/copilot-guide" className="text-[#000000] underline">Guide → Co-Pilot</a> (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/copilot-guide</code>) — one lesson per capability with worked examples, plus a downloadable branded handout. Point new coaches there.</Note>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Where it works, and how it changes by page</p>
            <StatusList items={[
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What you can ask it (read-only, it writes nothing)</p>
            <StatusList items={[
            ...
            <p className="font-semibold text-[#0F1115] mt-4">The feedback loop</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What it will NOT do</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
          ...
          <Section id="operator-console" title="Operator Console - Run the Business by Talking to It" colour="violet">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">What it can do</p>
            <StatusList items={[
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Nothing sends without you</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Seeing its working</p>
          ...
          <Section id="support" title="Support Tickets - Report an Issue" colour="violet">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Tab 1: Report</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Tab 2: My tickets</p>
            ...
            <p className="mt-3">When Kade updates a ticket, you get an email with the status and any note verbatim - and the ticket in the drawer updates the next time you open it. Kade sees every ticket in his own admin inbox at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/support</code>.</p>
          ...
          <Section id="lead-pipeline" title="1. Lead Pipeline" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Readiness Scorecard on Lead Detail</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Scorecard Lead Creation</p>
            ...
            <p className="mt-2">Leads created this way are tagged with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">source_detail: scorecard</code>. This is now the primary lead entry path.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Fat Map Zone Typing (from 2026-06-24)</p>
            ...
            <p className="mt-2">The zone is stored on the lead (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scorecard_profile</code> + confidence) and shown on the <strong>coach notification email</strong> as a Fat Map Zone card alongside sex/age, so you arrive at the call already knowing the likely pattern instead of reconciling it from scratch. The same typing feeds the pre-call brief. Legacy leads (pre-2026-06-24, no sex/storage captured) fall back to the older score-pattern guess.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Lead Quality Filter (Red Flag Test)</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-1">
              <li><strong>Approach (behaviour):</strong> When training/nutrition stops producing results, what is your honest first response? <span className="text-[#9CA2AB]">A/B = good fit. C (push harder) and D (frustrated, want program changed) = red flag - exactly the prescription-over-interpretation mindset BR is built to correct.</span></li>
              <li><strong>Investment readiness (qualification):</strong> If we identify what is blocking your progress, are you in a position to invest? <span className="text-[#9CA2AB]">A (ready now) / B (1-3 months) = good. C (just exploring) / D (free only) = red flag - not a coaching buyer.</span></li>
            </ul>
            <p className="mt-2">Each lead is scored: <strong className="text-[#0F1115]">green</strong> (zero red flags), <strong className="text-[#B06E1F]">yellow</strong> (one), <strong className="text-[#8F2D2D]">red</strong> (both). Quality dot appears on the avatar in the leads list and a Lead Quality block appears on the lead detail page below the section breakdown. Red-flagged leads should not be pushed to a Zoom call unless they push for it themselves.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Post-Scorecard CTAs (state-based split)</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-1">
              <li><strong>Depleted (5-8):</strong> Free 30-minute call only. A PDF will not unstick a body in protection mode. CTA links to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">bodyrecode.au/book?from=scorecard_depleted</code>.</li>
            ...
            <p className="mt-2">The Body Decode Report itself: a personalised web-based analysis of their body state, section scores, and what to stop and start doing. Purchased via Stripe at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">$37 AUD</code> and delivered automatically by email as a unique link at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">app.bodyrecode.au/report/[token]</code>.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
            ...
            <p className="mt-2">Report purchases are recorded as <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scorecard_reports</code> rows in the database. No manual handling required - Stripe webhook creates the report and sends the email automatically.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Self-Guided Program (Downsell)</p>
          ...
          <Section id="zoom-1" title="2. Zoom - Call Companion" colour="teal">
            ...
            <ol className="space-y-1.5 list-decimal list-inside text-[#4A4F57] text-sm mt-2">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Training context capture (Stage 1)</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Hot spot definition</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Coach Drawer</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Notes panel actions</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="coaching-entry" title="3. Coaching Entry" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Path A — fee first (default, recommended)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <ol className="space-y-1.5 list-decimal list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Path B — convert first, bill later</p>
          ...
          <Section id="deliberate-start" title="7b. Deliberate Start Window (IEEP)" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Duration</p>
            <p>Locked at <strong>two weeks, non-negotiable per doctrine</strong>. The IEEP duration cannot be shortened or extended.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What happens during the window</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What does NOT happen during the window</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="client-portal" title="8. Client Portal" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-2 mb-1">Sign-in</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-2 mb-1">What the portal shows</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li>Your Read - the published Foundational Read appears here once you generate it (see section 10b)</li>
              ...
              <li>Supplement Stack (added 2026-07-21) - coach-assigned substances at <strong>/portal/[token]/supplements</strong>. Tile only appears when at least one substance is assigned. Substance library lives in code (see <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/supplement-substances-seed.ts</code>) with three tiers per substance (Essential / Enhanced / Elite). Coach assigns the substance at <strong>/dashboard/clients/[id]/supplements</strong>; client sees all three tiers and picks the one that fits their budget. 28 substances in the library as of 2026-08-17. Add a new substance by running the deep-research skill, saving the report to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/00_PLAYBOOK/supplement_research/</code>, and adding an entry to the seed lib. Only OTC / Listed complementary medicines - S4/S8 stays with Arete Protocol. <strong>From 2026-09-08 supplements generate alongside the nutrition plan</strong> rather than on a separate screen: generating a plan now also proposes supplements and writes them onto it. This was built on 1 Sep and then never connected to anything, so every plan since had an empty supplement section. Nothing is prescribed automatically, a fresh suggestion arrives unassigned and stays invisible to the client until you accept it, and only what you have already accepted carries forward. If the supplement side fails the food plan still saves, deliberately. <strong>The approve half was connected 2026-09-08 too</strong>: accepting a suggestion now marks it on her live plan and places it against the meal it is taken with, so she sees it in her plan under &quot;Take with this meal&quot; instead of on a separate page. Withdrawing one removes it from her plan as well. Accepting one substance never re-derives the others.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Coach ↔ Client Messages</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Draft a Reply (2026-07-28)</p>
            <p><strong>Draft a reply</strong> on any client card writes a first pass for you, grounded in that client&apos;s own artefacts: their Foundational Read, program, nutrition plan, recent check-ins, intake and medications, plus the conversation so far and whatever page they were looking at when they asked. It lands in your reply box with a blue border and a &ldquo;Drafted for you&rdquo; strip. <strong>It writes nothing to their thread and sends nothing.</strong> Edit it, send it, or hit Discard.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Client Feedback Channel</p>
            <p>Every portal landing now has a <strong>Share feedback</strong> card under Resources. Clients submit free-text feedback under one of five categories: <code>portal_experience</code>, <code>coaching_experience</code>, <code>feature_request</code>, <code>bug</code>, <code>other</code>. Each submission writes to the <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">client_feedback</code> table and emails Kade a notification with the body inlined (so a reply can go straight from the email if needed).</p>
            <p>Every broadcast email sent to clients now ends with a <strong>Tell us what would help</strong> section linking to the same form. Pattern is canonical via <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/broadcast-feedback-footer.ts</code> - drop it into any future broadcast HTML template so the feedback channel is always present.</p>
            ...
            <p>Migration: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">sql/2026-05-13_client_feedback.sql</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Sessions (Face-to-Face Clients)</p>
            ...
            <p className="mt-2">To book an individual session from the dashboard, go to the Face-to-Face Sessions page and use the <strong>Book a session</strong> form in the Booked Sessions panel. Pick the date, time, and duration - this creates a <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">client_sessions</code> record. The session then shows as <strong>Confirmed</strong> in the client portal once the client confirms attendance via the reminder email.</p>
          ...
          <Section id="client-onboarding" title="9. Client Onboarding" colour="teal">
            ...
            <Training title="What the intake is building">
              ...
              <p className="mt-3"><strong>Hormonal Status (added 2026-09-13).</strong> A short section straight after the identity questions: sex recorded at birth, current hormone therapy, periods, hormonal contraception, pregnancy or a birth in the last 12 months, testosterone or anabolic use, and how energy, drive, sex drive and recovery compare with a year ago. Questions only show when they apply, so someone who answers Male is never asked about periods. Sex at birth stays the hard gate for the two hormone-linked patterns, exactly as in the locked Fat Map definitions. Any hormone therapy, a pregnancy or birth in the last year, and current or past testosterone or anabolic use are confounders: the read holds its pattern at low confidence and points you to a referral conversation, never to advice about the therapy. Periods set the Estrogen-Shift phase and are described as the client reported them, never as a menopause stage. The how-do-you-feel answers can support a falling-drive read only alongside falling strength or muscle, are never given as a reason for where fat sits, and the read never suggests a hormone test. <strong>Two answers alert you straight away</strong> (added 2026-09-13): pregnant now, and using testosterone or an anabolic compound without a prescription. Your intake email turns red with a Needs attention subject, and a red card sits at the top of their profile saying what to do. Every other hormonal answer, including past use and a birth in the last year, is raised inside the read instead, so the alert stays rare enough to be noticed.</p>
              <p className="mt-3"><strong>Gynae surgery and cancer (added 2026-09-16, written by a client).</strong> Kimberly Hamilton finished her intake and emailed a rewrite. The form used to reach a hysterectomy sideways, through the periods question, and then asked a woman with no uterus whether she was pregnant. It now asks <strong>Have you had a hysterectomy or surgery involving your ovaries?</strong> directly, and records <strong>one ovary</strong> separately from both, because that is the difference between a normal hormonal picture and reduced reserve with an earlier transition. Periods and pregnancy hide once the uterus is gone. <strong>Cancer</strong> is now asked too (completed, in treatment, monitored, or discuss privately) with a follow-up on whether it affected hormones; the detail stays with you in private. <strong>Hormone-blocking medication</strong> is an option on the hormone therapy question, where before it would have been filed under Other. Anyone <em>currently receiving treatment</em> raises a coach alert, the same as pregnant-now. The read is told that a hysterectomy keeping the ovaries is not a menopause, and that a flat week during cancer treatment is treatment, not behaviour. <strong>Existing clients have no answers to these</strong> until their next Progress Check, or until you set them by hand.</p>
              <p className="mt-3"><strong>Direction of change (added 2026-09-14).</strong> Women are also asked whether where their body stores fat has changed over the last few years: stayed on the hips and thighs, moving from the hips and thighs to the middle, always the middle, or not sure. It is the other half of the Estrogen-Shift discriminator alongside periods, and until now only the scorecard asked it, and the read never saw that answer. <strong>If she already answered it on the scorecard, the intake does not ask again</strong>: her answer is carried in with a short note, because she gave it before any pattern was shown to her. The read now also receives her scorecard answers on where she stores fat, direction of change and cycle, marked as given before she saw a result. Moving from the hips and thighs to the middle supports Estrogen-Shift strongly; always the middle argues against it. In the Progress Check it is asked as whether it has changed since her last read.</p>
              <p className="mt-3"><strong>Periods, and women with none (added 2026-09-15).</strong> The scorecard, Body Decode and founding forms used to ask &quot;Where are you in your cycle?&quot; with four answers: regular, irregular, perimenopausal, postmenopausal. A woman with no periods who is not past menopause had no true answer, and it asked women to call themselves perimenopausal, which is a medical call. All of them now ask <strong>&quot;Which best describes your periods now?&quot;</strong>: regular, irregular, none for 12 months or more, stopped after surgery or medical treatment, stopped or changed by hormonal contraception, pregnant or a baby in the last 12 months, or none for another reason. The intake asks the same. <strong>If periods stopped after surgery or treatment, she is asked whether her ovaries were removed or stopped working.</strong> A hysterectomy that keeps the ovaries stops periods but not hormones; removing them, or radiotherapy or chemotherapy that stops them, counts like menopause. Ovaries removed, not sure, pregnant or recent birth, and none for another reason all hold her pattern at low confidence. &quot;None for another reason&quot; is also worth a conversation, because periods stopping without an explanation can mean under-eating or something medical; the read raises it as a GP conversation. Irregular periods at 35 to 44 now count toward hormonal change, and a woman whose fat has always sat evenly is treated like one whose fat was always central, which argues against Estrogen-Shift. Older answers of &quot;Perimenopausal&quot; still work and show as the older question on the lead.</p>
              <p className="mt-3"><strong>No clear pattern (added 2026-09-14).</strong> The read can now say that no single pattern fits, which the locked Fat Map definitions call Indeterminate. It does this only when nothing points cleanly at one of the four, when the body is in Post-Optimisation (a Ready body has no compensation pattern to describe), when the only supported pattern is ruled out or cannot be confirmed because sex at birth is unresolved, or when the questions that decide a pattern were not answered. It is not a hedge: if one pattern leads, even weakly, the read names it at low confidence. On the profile it shows as <em>No clear pattern yet</em>, with <em>Leaning toward</em> a pattern where the evidence leans, and the Watch for note says what would settle it. It replaces any provisional funnel pattern on the client record, and the recovery and supplement suggestions are told not to tailor to a pattern.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-6 mb-2">Updates section (post-onboarding follow-ups)</p>
            <p>The <strong>Updates</strong> section on the client profile (under the Intake row) is the container for any post-onboarding task the coach has queued for the client to complete on their portal. It only appears once the foundational intake is complete &mdash; there&apos;s nothing to &quot;update&quot; before the baseline is in. Each item below is its own named card so when more update types ship (delta intake, full re-intake, block-end auto-prompt &mdash; see <a href="https://github.com/BodyRecode/body-recode-mvp" className="text-[#000000]">project_deferred_reassessment_flows</a>) they slot in alongside without restructuring.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Updates &middot; Supplementary intake (backfilling new fields)</p>
            <p>When new fields are added to the foundational intake after a client has already submitted theirs (e.g. medications on 2026-05-11, dietary context on 2026-05-12, consumption detail &ndash; meals per day, fluids, caffeine, alcohol &ndash; on 2026-06-03), existing clients don&apos;t lose access to those fields. <strong>Hormonal Status (added 2026-09-13) is in the follow-up form, and the form now asks each client only what they are missing.</strong> A client who already did the medications and diet follow-up gets just the hormonal questions, about a minute. A client missing both gets both. A client who has answered everything gets medications and diet again, for when you want to update those. The client profile shows an amber &quot;No hormonal status on file&quot; line on the Supplementary intake row while it is missing. After they submit, regenerate the CFFS so the read uses the answers. The supplementary intake card on the Updates section has three states:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Not sent yet</strong> &mdash; click <strong>Add follow-up to portal</strong> to create a pending supplementary <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">intake_invitations</code> row with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">kind=&apos;supplementary&apos;</code>. The portal landing page detects this and surfaces a teal &quot;A quick follow-up from Kade&quot; card next time the client signs in.</li>
              <li><strong>Pending</strong> &mdash; once the card exists, two extra actions appear: <strong>Email link</strong> (sends the client a branded reminder via Resend with the Outlook-safe shell + plain-text URL fallback, logged as <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">supplementary_intake_invite</code> in client_communications) and <strong>Copy follow-up link</strong> (puts the <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/intake-supplement/&#123;token&#125;</code> URL on the clipboard for DM/SMS). The default is still portal-only; the email is the explicit escape hatch for clients who don&apos;t log in between weeks.</li>
              <li><strong>Complete</strong> &mdash; row collapses to the completion timestamp. No actions.</li>
            </ul>
            <p className="mt-3"><strong>What the client sees:</strong> a single-page form at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/intake-supplement/&#123;token&#125;</code> with up to two blocks, only the ones they are missing: the intake&apos;s Hormonal Status questions (same wording, same show-only-when-it-applies rules), and medications + 8 dietary/consumption fields (restrictions, preferences, typical day, meals per day, fluids, caffeine, alcohol, eating environment). About a minute for hormonal only, ~4 minutes for both.</p>
            <p><strong>What submit does:</strong> works out again on the server which blocks the client was shown (a block they never saw is never written), saves hormonal answers to the most recent intake row, raises the same Needs attention alerts as the intake (pregnant now, or non-prescribed testosterone or anabolic use), updates the most recent intake row with the dietary fields, writes medications to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">clients.medications</code>, marks the invitation complete, sends Kade a coach notification email, and stops there. <strong>The CFFS is NOT auto-regenerated</strong> (changed 2026-06-21, mirrors the Medications + Dietary editors). The Foundational Synthesis panel on the client profile renders an amber &quot;Supplementary newer than CFFS&quot; banner with a Regenerate button when <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">intake_invitations.completed_at &gt; cffs.generated_at</code>; the section also auto-opens and the section header shows a &quot;Supplementary newer &mdash; regenerate&quot; attention pill. Coach reviews the new dietary + medication context, then clicks Regenerate when ready.</p>
          ...
          <Section id="cffs" title="10. CFFS - Coach-Facing Foundational Synthesis" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">When is the CFFS generated</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What the CFFS contains</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Visual Signal Integration (Fat Map sees the baseline photos)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to tell which CFFS read the photos</p>
            <p>Each CFFS row that ran through the multimodal flow stores two extra fields, which surface on the coach panel:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Photo badge</strong> in the panel footer next to the Generated date. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">Photos ✓ 3/3</code> in teal means the photos were attached at generation time. <code className="bg-[#EDEDEA] px-1 rounded text-[#6E747D] text-[12.5px]">Photos ✗ Not provided</code> in muted grey means no photos went into the prompt (older CFFS rows have no badge at all). Hovering shows the count.</li>
            ...
            <p>Migration: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">sql/2026-05-13_cffs_visual_signal_fields.sql</code>.</p>

            <p>The CFFS is paired with a client-facing version called the <strong>Foundational Read</strong> (see next section). The two are generated from the same intake and stay consistent with each other. The CFFS is yours to interpret. The Foundational Read is what the client sees.</p>
          ...
          <Section id="foundational-reading" title="10b. Foundational Read - Client Facing" colour="teal">
            <p>The Foundational Read is the client-facing translation of the CFFS. It is generated from the same intake using a separate prompt, takes the CFFS as additional input so the two stay consistent, and is written in supportive but conservative language that the client can read in 90 seconds.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">How to generate</p>
            <p>On the client profile, scroll to the <strong>Foundational Read - Client Facing</strong> section directly under the CFFS. Click <strong>Generate &amp; Publish</strong>.</p>
            <p>That does two things:</p>
            <ol className="space-y-1 list-decimal list-inside text-[#4A4F57] text-sm">
              <li>Drafts the read via Claude (~10 seconds).</li>
              <li>Auto-publishes it to the client portal at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/foundational-reading</code>.</li>
            </ol>
            <p className="mt-2">Generating does <strong>not</strong> email the client. When you&apos;re ready to tell them it&apos;s live, click the <strong>Notify client</strong> button on the same panel (it appears once the read is published). It sends a branded email from <strong>{coach().email}</strong> linking straight to their read, and the pill flips to <strong>Notified</strong>. Use this for a brand-new client whose reading is their first deliverable; otherwise the client is also brought into the portal when you publish their first training or nutrition plan.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Pills and state</p>
            <p>Two pills surface the read state at a glance, sitting next to the section title:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Live in portal</strong> (teal dot) - the read is currently visible to the client.</li>
              <li><strong>Notified</strong> (envelope icon) - the email has been sent. Hover to see when.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Regenerate, Unpublish, Republish</p>
            ...
            <p><strong>Unpublish</strong> takes the read down from the portal without deleting it. The portal card disappears and the read page returns a friendly &ldquo;not yet available&rdquo; message. Use if you regenerate and want a moment to review before re-exposing the new version.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Preview, PDF, Client view</p>
            <p>From the read card header you have three quick links:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <Training title="Prompt safety rails">
              <p>The read prompt inherits the CFFS doctrine: pattern-based interpretation, conservative under uncertainty, no prescriptions, no diagnostic labels, no causal claims. It also explicitly forbids motivational language, em dashes, and exclamation marks. The prompt is in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/client-reading-prompt.ts</code>.</p>
          ...
          <Section id="medications-analysis" title="10c. Medications Analysis + Reading" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Disclosure scope expanded 2026-06-04</p>
            ...
            <p>Why: structured PED tracking belongs to <a className="text-[#0F1115] underline" href="/dashboard/business">Arete Protocol</a>, not Body Recode. BR captures via the existing free-text <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">clients.medications</code> field for interpretive purposes only, so the CFFS reads the body accurately. The CFFS prompt now has explicit reading rules for this context: do not read body comp gains or recovery capacity as a clean training-stimulus signal when performance compounds are present; never moralise; never recommend cessation; do not name specific compound classes back to the client in any narrative field that propagates to client-facing readings.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Coach view: Medications Analysis</p>
            <p>On <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/clients/[id]</code> directly below the Medications editor card. Click <strong>Generate analysis</strong> to draft. Claude (Haiku 4.5) reads the medications text + the latest CFFS + intake (DOB, gender, occupation, goal) + active program block + active nutrition plan, and returns a JSON structure with one row per medication. Each row shows:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Client view: Medications Read</p>
            ...
            <p>The read has four sections, FR/PR/NR voice:</p>
            <ol className="space-y-1 list-decimal list-inside text-[#4A4F57] text-sm">
            ...
            <p>The read is a <strong>draft until you Publish</strong>. Click <strong>Publish to portal</strong> to expose it to the client at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/medications-reading</code>; it also appears as a card next to the Foundational Read on the portal landing. Click <strong>Unpublish</strong> to hide it again without deleting. No email is sent on publish — the client discovers the read next time they open their portal.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Staleness signals</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-1">Empty state</p>
            <p>If the client has no medications recorded, the analysis returns immediately with an empty-meds JSON structure (no Claude call), and the read is generated with a pre-canned &quot;nothing to account for right now&quot; copy. Saves a Claude credit.</p>
          </Section>
          ...
          <Section id="weekly-checkins" title="11. Weekly Check-Ins and CFWS" colour="teal">
            ...
            <p><strong>The review queue.</strong> Every check-in that comes in lands at <strong>Check Ins</strong> in the sidebar (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/checkins</code>). It is the one place to work through them rather than opening clients one at a time.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Today&apos;s Focus counted a draft as a reply (fixed 2026-09-07).</strong> The Check Ins queue above has always shown Draft ready and Sent as different things, but Today&apos;s Focus built its &quot;already answered&quot; list from any feedback row, and the auto-draft writes one the moment the client submits. So the &quot;respond to check-in&quot; prompt could never appear, and a reply you had not sent looked done. It now counts a check-in as answered only once the email has actually gone. Unanswered check-ins older than 14 days are deliberately left off Today&apos;s Focus, because a reply that late reads worse to the client than none, and a dormant client&apos;s last check-in would otherwise sit there forever. They stay listed as Draft ready in the Check Ins queue at any age.</li>
            </ul>
            ...
            <p><strong>Readiness ratings are anchored to the CFFS</strong>, not re-derived each week. The rubric holds the CFFS rating for each of the four dimensions unless the week gives real evidence to move it, and one week can only move a dimension one notch. Until 2026-09-07 the automatic path never passed the CFFS through at all. The rubric landed 2026-05-18 but only the manual Regenerate button honoured it, so every CFWS generated automatically from a check-in between those dates was rated cold, which skews Amber. Fixed 2026-09-07. Ratings from here on are anchored, and may sit differently to older ones on file.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Alcohol signal in the check-in (added 2026-06-03)</p>
          ...
          <Section id="signal-monitoring" title="11b. Signal Monitoring and Reassessment Triggers" colour="teal">
            <p>The system watches the four CFWS readiness signals (Capacity, Schedule, Regulation, Behaviour) week over week and surfaces flags when conditions defined in the <strong>Signal Monitoring and Reassessment Triggers v1.0</strong> doctrine are met. The doctrine itself is at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/.../Performance_Coaching_Framework_Master_Folder_v1/Signal_Monitoring_and_Reassessment_Triggers_v1.0.md</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Drift definitions</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">CFFS reassessment triggers</p>
            <p>A reassessment is recommended when ANY of the following fires.</p>
            <p className="text-[12.5px] text-[#6E747D] mt-3 mb-1"><strong>Signal-based triggers</strong> (suppressed when CFFS &lt; 21 days old, see Early-program suppression below):</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>The CFWS engine sets <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">reassessment_language_triggered: true</code></li>
            ...
            <p className="text-[12.5px] text-[#6E747D] mt-3 mb-1"><strong>Time-based triggers</strong> (always fire regardless of CFFS age):</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How the four readiness ratings get scored (added 2026-09-08)</p>
            ...
            <p>Green means not currently limiting, Amber means limiting, Red means this is the thing holding everything else back. Only one should normally be Red: if three are Red, that tells you nothing about where to start. And on a re-run, if nothing in the evidence changed, the rating should not change either. <strong>On screen these now read as Clear, Limiting and Binding</strong> (23 Sep 2026), which are these same three sentences said as words instead of as traffic lights; what is stored is unchanged.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Triggers now retire themselves (added 2026-09-07)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Early-program signal-trigger suppression (added 2026-05-18)</p>
            ...
            <p>Constant: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">SIGNAL_BASED_TRIGGER_FLOOR_DAYS = 21</code> in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/readiness-monitor.ts</code>. Rationale captured in §3a of the doctrine doc.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">CFWS readiness rating discipline (tightened 2026-05-18)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Reassessment is a temporal construct - it cannot apply at intake-time</p>
            ...
            <p className="mt-2">Therefore: <strong>an intake-derived CFFS will never have <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">reassessment_flagged: true</code></strong>. The CFFS prompt does not ask the LLM to set this field at generation; the server forces it to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">false</code> on insert. The flag becomes settable only later, by the Signal Monitoring engine, when one of the trigger conditions actually fires against accumulated CFWS data.</p>
            <Note>Historical bug fixed 2026-05-09. Prior to the fix, the CFFS prompt asked the LLM to write <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">reassessment_flagged: true | false</code> at intake with no guidance, and the model defaulted to true on most "Remediation / Partially Resolved" classifications. Five clients carried stale flags as a result; all were cleared and the prompt + insert path are now defensive against the same drift.</Note>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Where it surfaces</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The reassessment queue (added 2026-08-19)</p>
            <p>Before this, a fired trigger was rendered and nothing else happened, so acting on a regression depended on you opening that client&rsquo;s page that week. A trigger is now a <strong>record with a lifecycle</strong>: it stays <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">open</code> until you either send a Progress Check or dismiss it.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Reassessment depth</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Block end and macro arc</p>
          ...
          <Section id="recovery-regulation" title="11c. Recovery and Regulation" colour="teal">
            ...
            <p className="mt-2 text-sm text-[#6E747D]"><strong>Recovery Protocols (added 2026-07-21) is the sibling system.</strong> RRS clamps program/nutrition based on signals (this page). Recovery Protocols is the Layer 3 coach-side prescription tool - see the coach page at <strong>/dashboard/clients/[id]/recovery</strong> to assign sauna, contrast, cold plunge, compression boots, breathwork, deload weeks and more from a 33-protocol library filtered to what each client has equipment access for. (Red light was pulled on 20 September 2026; the count was also stale at 20.) Client sees active assignments only at <strong>/portal/[token]/recovery</strong>. RRS state can inform which protocols to assign (that&apos;s the future integration point); the two sit alongside each other but do not overlap.</p>
            <p className="mt-2">Doctrine source: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/.../12_Recovery_and_Regulation_System/</code> (Layer 2) and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">.../13D_Recovery_and_Regulation_Playbooks/</code> (Layer 3 execution). The full canonical reference renders live at <a className="text-[#0F1115] underline" href="/dashboard/recovery-regulation">Recovery</a>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The 10 playbooks (priority order, single dominant)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">RSIB — the weekly signal capture (Phase 2)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Router modes (env-controlled)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Disabled</strong> (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_ROUTER_ENABLED=false</code>): router does not run.</li>
              <li><strong>Observe-only</strong> (Phase 0 default — <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_OBSERVE_ONLY=true</code>): router evaluates and writes shadow audit rows to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">recovery_adjustments</code>. No states activated. No programs constrained.</li>
              <li><strong>Live soft gate</strong> (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_OBSERVE_ONLY=false</code>): states activate. Constraints flagged on program/nutrition gen as override-able policy.</li>
              <li><strong>Live hard gate</strong> (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_HARD_ENFORCEMENT=true</code>): states activate. Constraints hard-block program changes that violate doctrine.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Doctrine guards encoded</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Audit every transition</strong> (12E_04) — every router evaluation + state transition writes a <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">recovery_adjustments</code> row</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Where it surfaces</p>
            <p><strong>Recovery dashboard</strong> at <a className="text-[#0F1115] underline" href="/dashboard/recovery-regulation">/dashboard/recovery-regulation</a>: read-only doctrine reference page showing all 10 playbook manifests with their numeric constraints, exit criteria, escalation rules, and prohibitions. Layer 2 doctrine sourced live from Dropbox (Folder 12 + MSA RRS pillar).</p>
            <p>Per-client active state visualisation lands in Phase 4. Until then, audit rows in the <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">recovery_adjustments</code> table are the only output (visible via Supabase).</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Phase plan</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Phase 1 (DONE)</strong>: doctrine page + DB tables + router + state machine.</li>
              <li><strong>Phase 2 (DONE)</strong>: RSIB ingest from existing weekly check-in answers (the three questions per 13D_13 are already in Form A and Form B verbatim — no client-facing changes). Router evaluates after each CFWS lands. Per-client shadow log lives on the client profile, just below the readiness drift section. Backfill API at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">POST /api/recovery/backfill</code> derives RSIB from historical check-ins.</li>
              <li><strong>Phase 3 (CURRENT — soft-gate enforcement)</strong>: program generation and nutrition generation now read the active recovery state and apply the playbook&apos;s constraint envelope. Two layers: (a) the LLM is given a prompt section that tells it the active constraints, (b) post-LLM <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">clampProgramToRecoveryManifest</code> walks every exercise and enforces them as defence in depth. On the program-suggest page you&apos;ll see an amber <strong>Active recovery state</strong> banner with the constraints summary and a radio: <strong>Apply constraints</strong> (default, doctrinally correct) or <strong>Override with documented reason</strong> (writes a <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">constraint_overridden</code> audit row). Activation requires <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_OBSERVE_ONLY=false</code> in env — set in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">.env.local</code> by default; production needs the flag flipped manually.</li>
              <li><strong>Phase 4</strong>: hard-gate enforcement (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RRS_HARD_ENFORCEMENT=true</code>) — coach loses the override path entirely. Tier escalation alerts. Recovery state history view per client.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What the recovery clamp actually does</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Session removal / cap</strong>: removes the LAST N sessions of the week (preserves earliest = priority work). Caps total weekly sessions if <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">sessionsPerWeekCap</code> set.</li>
              <li><strong>Conditioning blocks stripped</strong>: any block whose label matches conditioning / capacity / finisher / cardio is removed when <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">conditioningBlocked</code> is true (most playbooks).</li>
              <li><strong>Testing exercises stripped</strong>: 1RM/3RM/5RM, max attempts, PR attempts removed when <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">testingBlocked</code> is true.</li>
              <li><strong>Progression-locked banner</strong>: stamped onto <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">weekly_pattern_summary</code> for the duration of the state.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Where to watch the router (Phase 2)</p>
          ...
          <Section id="rpe-creep" title="11d. RPE Creep Monitor" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How it works</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Severity tiers</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What you see</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What to do when it fires</p>
            ...
            <ol className="space-y-1.5 list-decimal list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Hold the block</strong> via Weekly Review → set direction to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">hold</code>. Keeps the prescription, signals no further progression this week.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What it does NOT do</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] text-[#9CA2AB] mt-4">Doctrine: Signal Monitoring §10 (2026-05-11 addendum). Thresholds are named constants in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/rpe-creep-monitor.ts</code>; revise both in lockstep.</p>
          </Section>
          ...
          <Section id="coaching-package" title="12. Coaching Package and Upgrades" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Non-billing (Contra / Comp)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Scheduling a delayed send</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Upgrade Companion</p>
          ...
          <Section id="clients-dashboard" title="13. Clients Dashboard" colour="teal">
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>CFWS readiness marks</strong> - Four marks (Capacity, Schedule, Regulation, Behaviour) from the latest weekly synthesis. <strong>They no longer carry a colour (23 Sep 2026)</strong>, because they were borrowing the readiness and Attention colours and teaching the same amber two meanings. Hollow means <strong>Clear</strong> (not limiting), soft means <strong>Limiting</strong> (a real constraint that shapes how much is asked), solid means <strong>Binding</strong> (the ceiling everything else is capped by). The stored values are still Green, Amber and Red.</li>
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <Note><strong>Progress Check heads-up (added 2026-09-14).</strong> A week before her Progress Check is due she gets a heads-up email: it opens next week after her weekly check-in, you will recognise the questions, about 15 to 20 minutes, have scales, a tape measure and somewhere for three photos ready. It runs on the same clock as the check (12 weeks from her last read, or earlier when her block reaches its final week), goes once per cycle, and is skipped when a check has already been raised or is due within a day.</Note>
            ...
            <Note><strong>Coach BCC: onboarding emails and ad-hoc nudges (revised 19 Sep 2026).</strong> You are copied on the emails a client gets while they are getting started, because that is when you need to see they are actually receiving things: portal access, intake invite, portal orientation, medical clearance required, the commencement fee link, and the subscription link. You are NOT copied on ongoing sends: session reminders, weekly check-in windows and drip steps, which would bury the ones that matter. <strong>Reading notifications are copied as well</strong> (foundational, nutrition, training and Progress Read), which they have been since 22 June 2026. Kade confirmed on 20 Sep 2026 that he wants to keep receiving them, so the rule is onboarding emails plus every reading a client is sent. Sign-in codes are deliberately excluded, since a copy of a one-time login code sitting in a second inbox is a security hole rather than a confirmation. Before this, portal access counted as a standard flow send and was not copied, which is how Joe&apos;s resent portal email reached him with no copy to you.</Note>
            ...
            <Note><strong>Today is different for a coach (2026-09-21).</strong> Your Today is unchanged. A coach signing in gets a different page entirely, because every section of yours is your business: posts, stories, leads, live metrics, decisions, the build board. None of it was about their clients, which made their front door the worst screen in the product. Theirs lists their actual week: a client who finished her intake and has heard nothing, a read written and unpublished, one published but not sent, a check-in waiting on an answer, an intake invited a fortnight ago and never started, and a read that was sent and never opened. Written as the thing they do rather than the state it is in, and ordered by who has been waiting on them longest rather than by what is oldest.</Note>

            <Note><strong>Your Practice (2026-09-21).</strong> The first screen built for you rather than for a client. Two things it shows that nothing else can. <strong>Who is slipping away:</strong> the system already watches whether a client&apos;s body is drifting, and it has never watched whether she is still turning up. Those are different questions, and a client can hold perfect readiness while being three weeks from cancelling. This counts whether she answered her check-ins, and whether she opened her last read, because somebody who still answers but has stopped reading what you send is leaving more quietly. <strong>What your book is made of:</strong> readiness and pattern across every client at once, so you can see what to get better at and which clients to stop taking. It is deliberately not a score and never a judgement about her body, and a client is left alone for her first three weeks because there is nothing yet to read into.</Note>

            <Note><strong>The co-pilot is now checked the same way (2026-09-21).</strong> Every read and every plan has been refused if it breaks a rule for that client. The co-pilot answered in a conversation and nothing checked it, which made it the one place the system could suggest something to you that it would have refused to write down. Both co-pilots are now checked against the same rules. When one of its answers breaks a rule, <strong>you never see that answer</strong>: it is thrown away, the model is told what it did, and it tries again. If all three attempts break the same rule you are told which one and why, rather than being shown something unsafe or a blank failure. <strong>Explaining a read is never blocked</strong>, which is the thing the co-pilot is for. Separately, a question now costs about four cents after the first one about a client, and the daily limit is forty rather than a hundred and fifty, which was set before anybody had measured the price.</Note>

            <Note><strong>The safety rules now cover every document a client opens (2026-09-20).</strong> Since 19 September the eating plan and three of the readings have been checked against this client&apos;s own medicines and answers before they save, and refused if they break a rule. Four were not covered, and they were the ones that matter most: the read itself, her weekly read, her progress read and the trajectory reading. All four now are. <strong>The read and the progress read refuse and save nothing</strong>, because a read that must not say something has not simply said it badly, and because a bad read feeds every plan written afterwards. The weekly read is told what it did wrong and tries again. <strong>Only her half of the progress read is checked</strong>: your own half is allowed to discuss her medicines, which is the whole point of it being yours. <strong>If you see one of these refusals</strong>, it is not a wording problem. Regenerate once, and if it repeats, check her medications and her health screen answers, because it means the engine is reaching for something it must not say for this person.</Note>

            <Note><strong>When a client asks what you hold, or asks to be removed (2026-09-20).</strong> Both are promised in the pilot agreement within 30 days and both are now real. An <strong>export</strong> produces everything held about one person in two forms: a complete machine-readable copy, and a readable summary that names each thing in plain words (her intake answers, her reads, the individual sets she logged, the emails sent to her). A <strong>deletion</strong> removes all of it, plus her uploaded photographs and documents, plus her name where a saved report quoted it rather than referencing her by number. <strong>It is a dry run unless you confirm</strong>, so the real thing is never the first time you see what goes. The list of places to look is asked of the database every time rather than written down, because the previous export was written with seven places in it and quietly missed the rest as the system grew. <strong>One thing it cannot do:</strong> reach backups. A copy taken last week still holds that person until it ages out, and the output says so rather than pretending otherwise.</Note>

            <Note><strong>Your own agreement, accepted in the app (2026-09-20).</strong> A client has never signed anything on paper: they read their coaching agreement in the portal, type their full name and it is recorded. A coach, until now, set a password and was in, with nothing recording that they had agreed to anything, which was the wrong way round, because the coach agreement is the one carrying the referral obligation, the screening obligation and the insurance requirement. <strong>Dashboard → Your agreement</strong> now holds it. <strong>The gate is off while the wording is a draft</strong>: nobody is asked to accept terms a lawyer has not read, and the page says so. Once the lawyer clears it, every coach is held at that page until they accept, including on any page added afterwards. Acceptance records the version, the name exactly as typed, the time, the address and the browser, and one row per version, so accepting one version and later another is two separate facts. A single word or a pair of initials is refused, because a name we filled in is not an acceptance.</Note>

            <Note><strong>Three internal alerts, and none of them ever reaches a client (2026-09-19 and 2026-09-20).</strong> <strong>Generation failure</strong>: one email per failure a coach actually saw across the nutrition, program and routine generators, sent only when the coach is not you, because your own failures are already on your screen and alerting on them would make the alert noise. A retry that succeeded is not a failure. <strong>Background job failed</strong>: every scheduled job now records its run, and a failure emails at the time, with a six hour quiet window per job so one broken job is one email rather than six a day. <strong>Background function gave up</strong>: one listener covers all twenty-six background functions, and any added later, by watching the platform&apos;s own failure event rather than wrapping each one by hand. The reason all three exist: the work a failed job was due to do does not happen, and does not happen by itself later. A check-in window that never opened stays shut.</Note>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Scorecard Follow-up Sequence (automatic)</p>
            <p><strong>Rewritten 24 Aug 2026:</strong> four of the five sold the retired $37 report and one of them sold nothing else. All four now point at <strong>The Body Decode</strong> at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">bodyrecode.au/decode</code>. These emails live in the database, not in code, so they were edited in place rather than re-seeded. <strong>Never click Re-sync on this workflow</strong> — the live copy is newer than the code seed, so a re-sync replaces good copy with old copy.</p>
            <p>Fires when someone completes the Readiness Scorecard. <strong>5 emails over 13 days</strong>. Each email is personalised to the lead&apos;s score and body state using <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{scorecard_score}}`}</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{scorecard_state}}`}</code>, and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{first_name}}`}</code>. Voice: leads with fat loss as the symptom (buyer language), introduces body state vocabulary as the diagnostic. Emails 1-2 push the $37 Body Decode Report; emails 3-4 push the free strategy call; email 5 names both options based on state.</p>
            <div className="space-y-1">
              <SeqRow day="Immediate" label="Email 1 - Your scorecard result: result + The Body Decode, call as backup" />
            ...
            <p className="font-semibold text-[#0F1115] mt-4">The Body Decode feedback capture (24 Aug 2026)</p>
            <p>Two capture points inside The Body Decode, and they measure different things. <strong>Accuracy</strong> is captured directly under her read the moment she first sees it, on a 1-5 scale: did the diagnosis actually land? <strong>Recommendation</strong> is captured at the end of day 5 on a 0-10 scale, after the Blueprint card rather than before it. Both land in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/feedback</code> under moments <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">decode_read</code> and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">decode_day5</code>. Read the low accuracy scores first: a read that misses tells you more than one that lands, and a high completion rate on a read that does not sound like her is a worse result than a low one. Consent emails are not automatic, so nothing is ever published without you sending the request yourself. Pull the whole cohort with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npx tsx --env-file=.env.local scripts/decode-cohort.ts --since 2026-09-01</code>.</p>

            <p className="font-semibold text-[#0F1115] mt-4">Body Decode Report Delivery + Follow-up Sequence (RETIRED 24 Aug 2026)</p>
            <p><strong>The $37 Body Decode Report is no longer sold, so this can no longer fire on a new purchase.</strong> The Body Decode (Funnel B Stage 1) gives every signup the same five-part read free on day 5, so the paid version was selling something she was about to be handed. Selling is closed at all three entry points. <strong>Delivery is deliberately still live</strong> — anyone who already bought keeps their report at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">app.bodyrecode.au/report/[token]</code>, and a session already in flight still completes. One tail remains: the live scorecard follow-up emails still link <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/get-report</code> and must be edited in the workflow UI, never re-seeded, because the live copy is newer than the code seed. That URL redirects to the scorecard meanwhile.</p>
            <div className="space-y-1">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Zoom 1 Booking Confirmation (automatic)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Zoom Booking Confirmation (you book it from the dashboard)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Rescheduling or cancelling a booking</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Dormant Lead Reactivation (you trigger it)</p>
            ...
            <Note><strong>Run the dry run before you send.</strong> <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">GET /api/admin/dormant-reactivation</code> shows exactly who would receive what, and who is excluded and why, without sending anything. Sending needs a POST with <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">?confirm=1</code>. Of the original 84: 8 were internal or test records including both of your own addresses, 13 had no body state so there was no read to send them, and 3 were inactive. 60 were sendable.</Note>

            <p className="font-semibold text-[#0F1115] mt-4">SMS send timing</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Duplicate workflow protection</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Custom Time Request + Pre-Call Form Chase (automatic)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">No-Show Re-engagement Sequence (manual trigger)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Zoom 1 Declined Follow-up Sequence (manual trigger)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Self-Guided Program Offer (automatic on decline)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Self-Guided Program Delivery (automatic)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Program Buyer Nurture Sequence (automatic)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Welcome Email (Post-Conversion)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Client Onboarding Notifications (to you)</p>
            ...
            <div className="space-y-1">
              ...
              <SeqRow day="Step 3" label="Foundational Intake submitted - with portal link. Turns red with a Needs attention subject if the client reports being pregnant now, or using testosterone or an anabolic compound without a prescription (added 2026-09-13). The same alert sits at the top of their profile." />
              <SeqRow day="Step 4" label="Baseline Documentation submitted - with portal link" />
            </div>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Writing instructions for a single block (added 2026-09-08)</p>
            <p>There are two places to give the engine instructions, and until now only one of them worked.</p>
            <p><strong>Coach guidance</strong> sits on the macro arc and is <em>standing</em>: it applies to every block you ever build for that client. Good for &quot;she wants glute emphasis, always&quot;.</p>
            <p><strong>The block brief</strong> is the text on the block itself, and it applies to <em>this block only</em>. Good for &quot;she has just done eight weeks of these lifts, do not repeat them&quot;, or &quot;keep the volume at the bottom of the range this time&quot;. Where the two disagree, the block brief wins, because it is the more recent and more specific instruction.</p>
            <p><strong>Until 8 Sep the block brief was never sent to the engine at all.</strong> It was collected from you, saved onto the record, and dropped. Three blocks in a row were built against written instructions the engine never saw: exclusion lists ignored, banned exercises used anyway, volume targets missed, training days moved. It looked like the engine disobeying. It was never asked.</p>
            <p>Also fixed the same day: when you do not specify training days, a new block now keeps <strong>the days the previous block actually used</strong>. It used to fall back to the availability the client ticked at intake months ago, so a new block could silently move someone who had trained Monday, Wednesday, Friday since July onto Tuesday, Thursday, Saturday. Nothing warned you; the only way to catch it was reading the day labels.</p>

            <p className="font-semibold text-[#0F1115] mt-4">Health Markers — Blood Test Upload (client self-serve, coach-gated)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Revising a plan versus regenerating it (added 2026-09-08)</p>
            <p>Kade&apos;s rule: <em>&quot;a regeneration should carry the current plan over and add one change in. We can&apos;t be changing the whole plan every time, no client will follow that.&quot;</em></p>
            <p>Generating a plan sends the brief to the engine and gets a brand new day back, every food and every meal rewritten. That is right when someone genuinely moves into a new phase, and wrong for almost everything else. It is why Samantha&apos;s step up in calories came back with her lunch moved to a different time, her salmon swapped for beef mince and her olive oil for tallow, none of which anyone asked for.</p>
            <p><strong>Revising carries her current plan across and changes only what you named.</strong> Everything else stays exactly as it was, down to the wording of each food. It saves as a new draft called (rev 2), (rev 3) and so on, and her current plan stays live until you promote it, so she is never without one.</p>
            <p>Her read carries across too and stays published. A change to one food does not make the explanation wrong, and clearing it would pull it out of her portal until someone rebuilt it. If a revision is big enough to change the explanation, regenerate the read yourself, which is a decision you make rather than something that happens quietly.</p>
            <p>Supplements carry across untouched. Changing the food must not change the supplements.</p>
            <p>Worked example, Razia on 8 Sep: her plan had been built on a bodyweight 12kg too low, so she was in a bigger deficit than intended. The revision raised her rice at lunch and her potato after training. <strong>Sixteen foods, two changed</strong>, fat untouched, no meal moved. That is what a client can actually follow.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Hormone results and the monthly cycle (added 2026-09-08)</p>
            <p>Labs print <strong>four</strong> different normal ranges for LH, FSH, oestradiol and progesterone, because what counts as normal depends where a woman is in her cycle. If the report does not say which, those four results arrive unreadable. Razia&apos;s August panel did exactly that, and an expensive test produced nothing on her hormones.</p>
            <p>The reader cannot solve this and deliberately is not allowed to. Its whole job is to copy the lab exactly and never substitute its own idea of normal, which is what keeps us on the right side of the line. So the choice of range now happens as a <strong>separate step afterwards</strong>: a plain calculation, not the AI. You give it the date her last period started, it works out which of the four ranges applies, and it writes that answer <strong>alongside</strong> the lab&apos;s original, never over the top of it.</p>
            <p>Where it lands: a result that sits outside the range for her phase gets lifted into its own group on the panel, headed &quot;outside the band that applies to this client&apos;s cycle phase&quot;. Without that it would sit under &quot;within range&quot;, because the lab never flagged it, and read as unremarkable. The client&apos;s own words about her cycle travel with it, so a caveat like &quot;mine are sometimes irregular&quot; stays attached and an approximate date never gets treated as fact.</p>
            <p>If anything is uncertain, the dates, the range or the value, it says nothing and the result keeps reading exactly as the lab printed it. <strong>A wrong range is worse than no range.</strong> Checks live in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/audit-cycle-phase-bands.ts</code>.</p>
            <p>The answer is written onto her results themselves, so it shows up everywhere you read them, not just in one place. On her results table the value is coloured and marked when it sits outside the range for her phase, and the range column shows which one was used and on what day. The lab&rsquo;s own range and its own verdict are left exactly as printed beside it, because that is the lab&rsquo;s call and this is ours.</p>
            <p>If you add or correct a period date on a panel that has already been read, run <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/backfill-phase-bands.ts</code> to bring the stored results into line. It shows you what would change before it writes anything.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The recovery library, corrected (20 September 2026, research pass R2)</p>
            <p><strong>Alcohol is now the first line of the sauna gate, and it was missing entirely.</strong> Across three forensic series, half of Finnish sauna deaths involved alcohol and 76 of 103 Korean autopsy cases were at or above 0.08 per cent. The prevention message from the people who studied it is to drink less and never leave someone who has been drinking alone in a hot room. That is now a hard no, with the never-alone rule attached.</p>
            <p><strong>We had the infrared guidance backwards.</strong> We sent depleted and heat-intolerant clients to infrared believing it gentler. At about 64 degrees for 45 minutes, inside the range we prescribed, it produced a heart rate of 153, plasma volume down almost 12 per cent, 1.4 litres of sweat an hour, and two of twelve healthy young adults could not finish. Tolerance tracks how hot the room is and how long you sit in it, not the wavelength. There is now a real entry dose, 55 degrees for 20 to 30 minutes, for exactly those clients.</p>
            <p><strong>The cold gate moved off cardiovascular clearance,</strong> which screens for the wrong thing. Death in cold water usually happens before the body cools, through the cold shock response in the first seconds, at a normal core temperature. The gate is now aligned to the Royal Life Saving position statement: never alone, head and neck out, 10 to 15 degrees, never after alcohol, get out slowly and sit down, and treat the first four sessions as the risky ones. One instruction reversed completely: <strong>do not tell anyone to hold their breath going in</strong>, because breath-holding with cold skin is the combination that kills apparently healthy people.</p>
            <p><strong>The vibration plate is no longer a bone strategy.</strong> No trial has ever reported a fracture outcome, the peak review recommends against vibration for bone density in postmenopausal women, and the trials ran at ages 60 to 93. It is now a low-barrier way in for a client who cannot yet load, with a hard stop for anyone with osteoporosis or a previous minimal-trauma fracture, who goes to their GP and an exercise physiologist instead.</p>
            <p><strong>Numbers and claims deleted because they had no source or were measured and found false:</strong> the 4-hour and 6-hour rules before a strength session, &quot;40 per cent of the magnitude&quot; of a plunge, the brain-dopamine framing, brown fat as a body composition lever, &quot;the fastest parasympathetic lever available&quot;, sauna as cardiovascular exercise, infrared penetrating deeper, steam clearing your airways, magnesium absorbing through skin, the massage gun reducing soreness or belonging in a warm-up, compression boots moving fluid, and every red light claim including its dose.</p>
            <p><strong>Breathwork now carries the rule that prevents deaths.</strong> Hyperventilating before a breath hold lowers the carbon dioxide that triggers your urge to breathe, so the urge is delayed while oxygen keeps falling and consciousness can go with no warning. In water that is drowning, and it kills about 4,000 people a year in the United States, most often men under 40. Keeping Wim Hof breathing out of the daily sequences was right and was not enough: the rule is now attached as an absolute to every protocol containing a hold, which includes box breathing and 4-7-8. There is also one shared exclusion list, taken from the trial that produced the evidence and labelled as an eligibility list rather than a clinical guideline, because we should not run a broader population than that trial did.</p>
            <p><strong>Coherent breathing is now slow breathing at 5 to 7 breaths a minute.</strong> The 5.5 was never special: every rate from 5 to 7 beat the control and none beat the others. &quot;Sustained&quot; confused a rise while you breathe with a lasting change at rest, which a 28-day trial looked for and did not find, and there is no blood pressure benefit across 22 trials and 17,214 people. The physiological sigh loses &quot;the fastest documented way to lower heart rate&quot;, contradicted by its own source, which found no heart rate change at all.</p>
            <p><strong>Our jet lag order was backwards.</strong> We had meal timing as the biggest lever. Four reviews name light, melatonin and sleep scheduling, and none of them names meal timing. Light is now first and fasting is last and labelled unproven. And on sleep debt: &quot;one long night is not enough&quot; holds, but &quot;a week is enough&quot; does not, because after a week at 5 to 7 hours a night, three full nights of 8 hours produced no measurable recovery of vigilance.</p>
            <p><strong>Red light has been pulled from the library</strong> (your decision, 20 September). It was the only protocol where we prescribed a dose that could not be sourced from any paper actually read, a mechanism contested inside its own field, and a sleep benefit whose only supporting results were device retailers&apos; blogs. Nobody had it assigned, so nothing was interrupted, and it is gone from the recovery suggestions too. The equipment options are deliberately kept, so an old client answer about owning a panel still makes sense. What would bring it back is a pass that recovers an actual dose, meaning wavelength, irradiance, distance and energy, from a trial in people rather than in cells.</p>
            <p><strong>Nothing else was pulled.</strong> The protocols are fine. It was the claims attached to them that were wrong. The library now holds 33.</p>
            <p>Every cold and device entry now says out loud that the literature is about 92 per cent male and aged 20 to 26, so anything quoted to a woman of 35 to 60 is an extrapolation rather than a finding about her.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The intake got a health screen, and an honest time (20 September 2026)</p>
            <p>Three research passes in one week added 30 questions. Measured properly, <strong>a woman of 45 who does not compete now sees 270 questions, 207 of them sliders and 26 needing her to type something.</strong> Two things followed from that.</p>
            <p><strong>The new questions are a different kind, so they moved.</strong> The intake asks how she is, so the engine can read a pattern. The thyroid, bone and iron questions ask whether a doctor should look at something before we prescribe anything. Those are screening, they have to be answered accurately, and they were sitting at the end of a long form after two hundred sliders, which is where attention is worst. They are now a <strong>Health screen</strong> of nine questions placed third, after identification and hormonal status, because two of them depend on answers there.</p>
            <p>Its wording says plainly that it is not a test and produces no result, that we cannot tell her anything about her thyroid, her bones or her iron from a questionnaire and will not try, and that being sent to her GP is a good outcome rather than a bad one. Iron&apos;s questions will join it rather than going on the end of the form.</p>
            <p><strong>The stated time is now 25 to 35 minutes, and it says it saves as you go.</strong> Fifteen to twenty was no longer true, and understating it is exactly what makes someone budget twenty minutes, hit halfway and abandon. Changed in the intake invitation, the portal access email, the marketing page and the purchase confirmation.</p>
            <p><strong>And it now saves across devices, not just in her browser.</strong> Until 20 September the draft lived in local storage, so she could stop and come back only on the same phone or laptop: starting on her phone and opening the link on her computer showed a blank form. Her answers are now also saved against her invitation, about a second and a half after she stops typing. When she opens it elsewhere, the fuller copy wins, and anything already on her screen takes precedence field by field so it can never overwrite what she can see. If the save fails she never notices, because the browser copy is still there.</p>
            <p><strong>Nothing is stored until she ticks the health consent</strong>, and that is enforced on our side rather than trusted to her browser. She ticks it on the first screen before any health question is asked, which is what makes holding a half-finished form defensible at all. Submitting clears the saved draft, because by then the answers live on her intake record and a second copy of her health information sitting on an invitation is a copy we would have to explain.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Iron: the engine now refuses to read a pattern until she has been seen (20 September 2026, research pass I1)</p>
            <p><strong>This one is structural rather than a wording fix.</strong> Our four patterns are exhaustive, which means a cause we do not recognise is not dropped, it is absorbed into the nearest pattern, and the nearest pattern for tiredness that sleep does not fix, harder sessions, breathlessness, feeling cold and low mood is recovery. So the system was not occasionally at risk of reading an iron problem as a recovery problem. As built, it would have read <em>every</em> iron problem as a recovery problem, because it had no other category available to it.</p>
            <p><strong>And a questionnaire cannot separate them.</strong> There is no sensitivity, no specificity and no likelihood ratio for symptoms against ferritin, and the guidelines are clear that the blood test is what distinguishes them. So the design is not to detect it. It is to refer, and to hold the interpretation until she has been seen. That rule sits outside the pattern model, because a rule inside the model would be subject to it.</p>
            <p><strong>The number that will catch you out, and it is on the client profile.</strong> In the randomised trials of iron for fatigue in women who were not anaemic, the <em>placebo</em> groups reported their fatigue dropping by 13 and 28.8 per cent. A coaching programme is at least as strong a placebo as a tablet. So a woman who feels noticeably better at week four is producing exactly the improvement the placebo arms produced, and <strong>feeling better is not evidence her iron is fine.</strong> Her measured numbers are not a check either: iron improves how someone feels without improving what they can do, so &quot;your numbers look fine&quot; is the expected picture rather than an inconsistency.</p>
            <p><strong>Five questions went into the health screen</strong>, tiered from routine to emergency, with the highest tier governing and the answers quoted back to her unranked. The cardiac question is the only one that stops training outright. There is deliberately no tiredness question: we already ask about fatigue and it would change nothing.</p>
            <p><strong>Two rules worth saying out loud.</strong> Never reassure her, because reassurance is the mechanism by which these things get missed. And there is no watchful-waiting path in this gate: never suggest she tries the plan first and comes back in a few weeks. Her word that she has seen a doctor is the only thing that clears it, never a photograph or a result.</p>
            <p><strong>On food:</strong> food maintains iron, it does not refill it. In the Australian trial that tested it, twelve weeks of a deliberately high-iron diet moved ferritin from 8.9 to 11, while an iron tablet moved it from 9.0 to 24.8 in the same women over the same time. Holding the line is the claim we can make, and we plan to the Australian red meat cap rather than the amounts those trials used.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What actually builds bone, and the hole we made ourselves (20 September 2026, research pass B1)</p>
            <p><strong>We made this hole.</strong> The recovery research killed the vibration plate bone claim, and from that moment a woman who said bone was her concern got a correct &quot;not the plate&quot; and nothing to do instead. This pass independently confirmed the removal was right and filled the gap.</p>
            <p><strong>The prescription is heavy, and that is the finding.</strong> Barbell work at 80 to 85 per cent of one rep max, five sets of five, twice a week, with about fifty impacts in the same session, for eight months or longer. Nothing lighter has reliably added density at the spine. A sedentary client earns it over six to twelve weeks first. <strong>A woman still cycling can start with impact alone</strong>, because impact by itself does raise hip density in that group. <strong>Once she is past her final period, impact alone has not worked</strong>, so the barbell stops being optional.</p>
            <p><strong>Two limits that are now on screen rather than buried.</strong> First, the age gap. The trial everyone quotes enrolled women averaging 65 and excluded anyone within five years of their final period, while our audience is 35 to 50. Exactly one trial has run in peri and early post menopausal women: forty people, a small spine effect, no hip effect. Every loading number is an extrapolation downward in age. Second, <strong>nobody has ever shown that exercise prevents a fracture.</strong> No exercise trial has been powered to test it, and the percentages in circulation come from drug trials. The engine is now barred from attaching a fracture-reduction percentage to training. What we may claim is slower loss plus better strength, balance and function.</p>
            <p><strong>Five questions were added.</strong> The most important asks whether she has broken a bone from a fall from standing height, because in Australia that counts as osteoporosis on its own whatever a scan says, and roughly doubles the risk of the next one. The one a coach misses by not asking covers lost height, a rounding upper back, or new mid-back pain, which is the pattern that can be a spinal fracture. Any of those stops load going on until her GP has looked.</p>
            <p><strong>With a diagnosis, the change is not &quot;go lighter&quot;.</strong> Under-loading is the more common error. The change is cleared, supervised for the first eight to twelve weeks by an exercise physiologist or physiotherapist, and tiered by fracture risk. Resistance still goes to 80 to 85 per cent, because that is the Australian prescription for that exact population. Out: loaded or end-range spinal flexion. In: teaching the hip hinge. We never hand someone a list of forbidden movements instead of teaching her to bend properly.</p>
            <p><strong>If a client asks about the vibration plate she bought on our old wording</strong>, the answer to give her is written out in full and sits in the coach note on that protocol. It says we were wrong, we took it down, her plate is not harmful and she did not waste her money, and the real cost is standing on it instead of hopping or lifting. It also keeps a job for it: a way in for someone who cannot load yet.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The engine will not cut her food while this is unchecked (20 September 2026, research pass T1)</p>
            <p><strong>The failure this prevents.</strong> The nutrition engine builds deficits. If a woman&apos;s weight will not move because her thyroid is underactive, the engine&apos;s natural next move is to cut her further. That is not a wrong answer, it is a harmful direction, and it is the reason this pass was run.</p>
            <p><strong>A questionnaire cannot sort this out, and the research proves it rather than asserting it.</strong> A thirteen-symptom score separated an underactive thyroid from a normal one at 0.91 in younger men and <strong>0.64 in older women</strong>, which is close to a coin toss in half our audience, and only three of those thirteen symptoms were more common in the people who actually had it. So the intake may <em>trigger a referral</em> and may <em>never</em> produce a likelihood, a score, a percentage or a pattern. If you ever see the system tell a client what her thyroid is doing, that is a bug.</p>
            <p><strong>What the hold does.</strong> While it is open, her energy target stays exactly where it is: no new deficit, no deepening of an existing one, no fasting window, no food group removed, no supplements. Training continues at her current load. The plan says so to her in fixed words, and the engine is refused if it writes anything else. It clears when she confirms she has been seen.</p>
            <p><strong>Why the hold, honestly.</strong> Not mainly because cutting further is dangerous, though it may be. Because cutting before the blood test <em>shifts the very results her doctor is about to read</em>. It is labelled in the code as a safety default rather than an evidence-based protocol, because no trial has compared holding against proceeding, and anybody who finds that rule later deserves the real answer.</p>
            <p><strong>Thyroid products are blocked for everyone</strong>, flag or no flag: iodine, kelp, seaweed, glandular products and high-dose selenium. Nine of ten marketed thyroid supplements that were tested contained real thyroid hormone, Australia is iodine sufficient, and excess iodine is associated with roughly 2.8 times the odds of an underactive thyroid. &quot;Optimal range&quot;, &quot;low-normal&quot; and &quot;suboptimal&quot; are now banned words too: across 21 trials and 2,192 adults, treating a mildly raised result moved thyroid symptoms by 0.01. A lower number is not a better number.</p>
            <p><strong>Four questions were added</strong>, mostly the case-finding list Australian guidelines already use and which we were collecting and ignoring. The symptom question asks what <em>changed</em> in the last year rather than how she feels now, because change is the only framing with any published discriminating value. The trigger is deliberately low: one tick on the history list is enough, since a low threshold costs a doctor&apos;s appointment and a high one costs a missed case.</p>
            <p><strong>Two things to watch for as a coach.</strong> Fast weight loss with high energy may not be a win: in women around forty with an overactive thyroid, gym work capacity was half of predicted and the tissue lost first is muscle. And treating an underactive thyroid does not produce the fat loss a client expects, because the weight that comes off is largely water. If you do not say that, she hears that her thyroid was the problem and waits for the scale to solve itself.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">There is a database backup now, and there was not one before (20 September 2026)</p>
            <p><strong>Every copy of this data lived inside one Supabase project.</strong> I went looking to test whether a backup could be restored and found there was nothing to restore: the Supabase tool needs Docker to take a dump, Docker is not installed, and nothing in Dropbox was a database backup. If that project had been deleted, suspended over billing, or compromised, the recovery path was to ask Supabase and hope.</p>
            <p><strong>Run <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run backup</code></strong> and it writes every row of every table to Dropbox, under 00_Project_HQ &gt; 09_Archive_and_Backups &gt; database, in a folder stamped with the date and time. The first run took 116 tables and 5,386 rows. It needs no new software. Then <strong><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run backup:verify</code></strong> proves it: every live table present, every file holding what it claims, rows deep rather than empty shells. It prints BACKUP VERIFIED or it refuses.</p>
            <p><strong>Two design decisions worth knowing.</strong> The list of tables is asked of the database rather than kept in the script, because a hand-kept list fails silently the first time someone adds a table and forgets, and the backup then keeps reporting success while missing data. And a single failed table fails the whole run, because a backup that is complete except for one table is not a backup and must not be able to look like one.</p>
            <p><strong>The files are covered too, since 20 September.</strong> Run <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run backup:files</code> and it downloads every progress photograph, blood panel document and clearance letter to Dropbox beside the database backup, then <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run backup:files:verify</code> proves each one is present, the right size and not an empty stub. The first run took 96 files. That half matters more than it sounds: a database row can often be reconstructed from somewhere, but a photograph a client took in her bathroom in week one cannot be retaken in week one. Public marketing assets are skipped by default because they are reproducible and big enough that including them would stop anyone running this.</p>
            <p><strong>The structure is captured too, and it was not in version control at all.</strong> Six of the core tables, including clients, intakes and leads, had no CREATE TABLE anywhere in the repository: they were made through the Supabase interface over eighteen months and never written down. Every backup now asks the database to describe itself and saves that beside the rows, as JSON and as readable SQL. The verifier refuses a backup that has no structure in it.</p>
            <p><strong>And it has now been restored end to end.</strong> On 20 September the whole thing was rebuilt into an empty PostgreSQL: 116 of 116 tables, 102 of 102 policies, 17 functions, no errors, and all 5,389 rows back. It was checked by asking it real questions rather than counting rows: fifteen clients by name, intakes joining to their clients, twenty-two programs with sessions intact, and the coach-scoping policies still in force. Run it yourself with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run backup:restore-test</code>, which only ever talks to a database on your own machine.</p>
            <p><strong>Rehearsing it is what made it work.</strong> The first attempt failed with 1,015 errors and built 68 of the 116 tables, and six separate bugs came out of watching it break: Supabase-provided schemas that exist nowhere else, missing authentication functions, foreign keys created before the keys they point at, duplicate indexes, custom types not captured at all, and functions written after the policies that call them. None of those would have been found by reading the code. That is the difference between having a backup and knowing you have one.</p>
            <p><strong>The honest caveat.</strong> This rebuilds a plain database, not a Supabase project. Storage buckets, real sign-in accounts and realtime are not in it. In a true disaster you would be rebuilding onto a new Supabase project and re-inviting logins, with all the client data intact.</p>
            <p><strong>The daily health check now watches it for you.</strong> It reports how old the newest backup is and fails past eight days. A backup run by hand does not break; it gets forgotten in a busy fortnight, and that check is the part that notices.</p>
            <p><strong>Do it before anything risky</strong>, and get into the habit of running it weekly. The output contains client health information, so it lives in Dropbox and nowhere public, and old backups should be pruned rather than kept forever.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">You now find out when a generation fails for someone else (19 September 2026)</p>
            <p>Every other health check watches your funnel. This one watches whether the engine works in another coach&apos;s hands, which is what actually decides whether a pilot survives. Until now the eating plan engine wrote failure telemetry nobody reads, the training block and routine generators wrote nothing at all, and none of it told anyone. A real failure returned to the coach on 8 September sat in a table unnoticed.</p>
            <p><strong>Now every failure a coach actually saw is recorded</strong>, with what they were told, and <strong>you are emailed immediately when the coach is not you</strong>. Your own failures deliberately do not email you: you are the one clicking the button, so the error is already on your screen, and alerting on it would train you to ignore the alert. They still show in the daily health check, which reports the last 24 hours grouped by what failed.</p>
            <p>A retry that then succeeded is not a failure and is not recorded. That is the difference between a log you read and a log you stop reading.</p>
            <p><strong>Also fixed while building it:</strong> the daily routine generator was still gated on your email address, so no other coach could produce a routine at all. It now uses the same ownership rule as everything else and refuses a client the coach does not own.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Adding a coach, and a coach bringing their clients (19 September 2026)</p>
            <p><strong>A coach is invited now, not created.</strong> Business &gt; Coaches takes a name, an email and their business name, and sends one email with a link that works once and lasts fourteen days. They set their own password, which means you never type anyone else&apos;s again. Their account and their platform configuration are created together and the invitation is only marked used once both have succeeded, so a failure halfway leaves them a working link rather than locking them out. Re-inviting the same email cancels the old link rather than leaving two live ones, and you can revoke one before it is used. If the email fails to send, the invitation still exists and you can read the link out over the phone.</p>
            <p>They land on an empty dashboard. That is correct and it is the point of the scoping work: a coach sees only their own clients, and nobody sees theirs.</p>
            <p><strong>A coach never types a client&apos;s details.</strong> Only a name and an email. Everything the engine reasons from comes from the client&apos;s own intake, in their words, which is both faster and more accurate than a coach relaying it. So a coach arriving with 30 existing clients has a list, not thirty forms to fill in.</p>
            <p><strong>Clients &gt; Import a list</strong> takes that paste. Commas, tabs or semicolons, header row ignored, name or email first, phone optional. <strong>Check the list</strong> is a dry run: it writes nothing and shows what would happen to every row, including the lines it could not read and why. Anyone already on that coach&apos;s list is skipped rather than duplicated, so running it twice is safe, which matters because people do. Each new client gets an intake waiting for them; whether the intake email goes out is a tick box, so a coach can import quietly and invite in their own time.</p>
            <p>Both are proven by tests rather than by hand: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/test-coach-invitation.ts</code> runs the whole invitation through the real database and deletes everything it made, and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/test-bulk-import-parse.ts</code> covers ten paste shapes.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The training doctrine rules, decided (19 September 2026)</p>
            <p>The four training rules have been checked in code and written into your note since 14 September, but never acted on, because when they were written seven of eight blocks broke them and you had approved every one. Rather than guess, I measured all 22 blocks ever generated: 10 broke at least one rule, 36 breaks in total, and 34 of the 36 were the same rule.</p>
            <p><strong>The injured-joint rule was mostly wrong, and is now narrowed.</strong> It said exclude every exercise that stresses an injured joint, so it was flagging Dead Bug, Bird Dog, Plank and Glute Bridge for someone with a sore back: exercises prescribed <em>for</em> the joint rather than loads on it. Thirteen of the thirty-four flags were exactly that. It now fires only on externally loaded work, which takes it from 34 flags to 21 and makes the note worth reading. It still only writes a note, never blocks, because a hip thrust for hip pain is your judgement to make. An exercise with no load profile recorded still flags, so missing data can never hide a break.</p>
            <p><strong>The two Remediation rules now retry once.</strong> If a block loads the spine outside the primary slot, or uses high-stability work in Remediation, the engine regenerates just those exercises and checks again. If the second attempt is clean it uses it and tells you what happened; if not, the original block stands with the break in your note. It fired on one exercise across 22 blocks, so this costs almost nothing, and a failed correction never costs you the block.</p>
            <p><strong>The red-day rule is waiting for data, deliberately.</strong> It is the rule with the clearest clinical logic and almost no evidence either way, because only 2 of 22 blocks recorded the readiness they were built under. That was not missing data: readiness was written down only when a weekly carry-forward changed something, and left blank otherwise, which read as &quot;no readiness&quot; when it meant &quot;used the assessment unchanged&quot;. Every block now records what it was built on and where that came from, so in a few weeks there is something real to decide with.</p>
            <p>The measurement is repeatable: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/audit-program-doctrine-live.ts</code> re-runs it over every block, and the rule tests are at 14 cases.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The safety gates are now enforced, not requested (19 September 2026)</p>
            <p>Everything the research produced went into the prompts first, which means the engine was <em>asked</em> not to do these things. It complies almost always, and almost always is the standard that stops being good enough the moment other people&apos;s clients are on the platform and you are not reading every plan.</p>
            <p><strong>So the nutrition engine now checks its own output and refuses.</strong> Every part of a generated plan a client could read, including the coach reasoning, is scanned before the plan can be saved. A breach fails the plan and the engine is told why and tries again, exactly like the banned-word check that already existed for readings. Seven rules are enforced: naming a salt substitute or potassium product for a client whose medicines hold potassium; a potassium-containing electrolyte drink for the same client; any daily fluid figure for a client behind the fluid gate, whether it is in litres, millilitres or glasses; changing salt up or down for that client; prescribing fasting, keto or very low carbohydrate to someone on an SGLT2 inhibitor; any salt or fluid change for someone on lithium; and any show-week number for a competitor, including carbohydrate loads, water loads, sodium and potassium figures and anything naming diuretics.</p>
            <p><strong>The check is client-specific, which is the point.</strong> &quot;Use a lite salt on your eggs&quot; passes for most people and fails for someone on spironolactone. A litre target passes for most people and fails for someone on an antidepressant of the SSRI type. A check that fired on everyone would be switched off inside a week, so <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/test-safety-gates.ts</code> tests both directions: 23 cases, half of them proving the same sentence passes for a client the rule does not cover. It prints SAFETY GATES HOLD.</p>
            <p>If you see one of these in a validation failure, it is not a generation wobble. It means the engine wrote something that is unsafe for that specific person, and it will keep being refused until it is gone.</p>
            <p><strong>It now covers five generators, not one.</strong> The nutrition plan, the daily routine, and the three client-facing readings (foundational, nutrition and program) all run the same check before anything can be saved. The routine generator matters most of them, because it is the surface that used to reach for a morning water or salt habit, which is exactly what the research took away.</p>
            <p>On a reading, a breach behaves like leaked jargon: it fails, the engine is told what it did, and it writes the whole thing again. If it breaks the same rule three times the reading does not publish, and the message you get says plainly that it is a safety gate rather than a wording problem, because those two send you to different places. That message asks you to tell me, since it means the engine is reaching for something it must not say for that person.</p>
            <p><strong>Still to do:</strong> the higher-consequence programming rules still live only in prompt text. That is the rest of this step.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Lifters, heat and competitors (added 19 September 2026, research pass E1b)</p>
            <p><strong>Eighteen questions were added to the training section, and eleven of them are what anyone sees.</strong> The other seven stay hidden unless the client says they are preparing for a physique competition, so the great majority of people never meet a question about federations or fluid tablets. A woman is only asked about her cycle during prep if she both competes and was not recorded male at birth. The intake is now {getTotalQuestions()} questions.</p>
            <p><strong>What everyone is asked:</strong> whether the gym is air-conditioned or hot, how long a typical session runs, whether they work outdoors or somewhere hot, how heavily they sweat, salt marks on clothing, whether they have ever weighed themselves either side of a session, cramps and whether those happen at rest, past heat exhaustion or collapse, dark urine after training, and whether they use creatine, pre-workout or a stimulant fat burner.</p>
            <p><strong>What each one actually changes</strong>, because a question that changes nothing is worse than no question. A cool gym and a short session tell the nutrition engine explicitly NOT to prescribe electrolytes or a drinking target. A hot gym, a session over 90 minutes, a heavy sweater or outdoor work unlocks the in-session wording and the 500 to 700 mg of sodium per litre figure, and only then. Past heat illness blocks sauna and heat progression without medical clearance. Dark urine after training slows load progression and raises a flag. Cramps at rest or at night become a GP referral instead of a salt suggestion. Ticking creatine stops the engine ever repeating the cramp and dehydration myth, and reminds you that a creatinine-based kidney result reads high on creatine, which is a lab interpretation point rather than a kidney problem. Saying they compete switches on the refusal to generate any show-week numbers.</p>
            <p><strong>Seven of these raise a flag on the client profile</strong> in the same amber block as the others: cramps at rest, dark urine, past heat illness, competing while using fluid tablets or the other listed compounds, planning to use potassium products, a past collapse or palpitations around a show, and periods stopping during prep. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/test-training-context.ts</code> proves the sixteen cases and prints TRAINING CONTEXT HOLDS.</p>
            <p>The answers are stored together rather than as separate fields, and an answer to a hidden question is never kept, so someone who says they compete, fills in the show questions and then changes their mind does not keep a federation on file.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The fluid and potassium gates, and the referral list (added 17 September 2026)</p>
            ...
            <p><strong>The potassium gate</strong> turns on for anyone with kidney disease, heart failure, liver disease, adrenal insufficiency, a past high potassium result, or on a medicine that holds potassium: ACE inhibitors, sartans, spironolactone, eplerenone, finerenone, amiloride, triamterene, Entresto, heparin, ciclosporin, tacrolimus, trimethoprim. The wording is: &ldquo;{STANDARD_POTASSIUM_GATE}&rdquo;</p>
            <p><strong>The fluid gate</strong> turns on for anyone with a doctor-set fluid limit, a past low sodium result, or on fluid tablets, an antidepressant of the SSRI or SNRI type, carbamazepine, lithium, an SGLT2 inhibitor or desmopressin. The wording is: &ldquo;{STANDARD_FLUID_GATE}&rdquo;</p>
            <p><strong>Where they fire:</strong> the nutrition generator and the daily routine generator both read the client&apos;s medications and health flags and get told, before they write anything about water or salt, which gate is on and what they are not allowed to say. The screen is deliberately generous, because a false positive costs a client one cautious paragraph and a false negative costs her a supplement she should not be taking. It reads free text, so if it has misread someone, you override it. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">scripts/test-electrolyte-gates.ts</code> proves the fourteen cases and prints GATES HOLD.</p>
            <p><strong>Three of the referrals now fire on their own</strong>, on the client profile, in amber, above the fold. They are the ones we can see from what she has already told us: strong salt cravings alongside unintended weight loss, dizziness on standing or darkening skin and gums; dizziness on standing in someone on a medicine that changes fluid or salt; and a standing note that her treating team owns the fluid and salt rules whenever either gate is on. Each says what she reported and who to see, and never what it might be. Checked against the whole roster on the day it went in: one client matched, correctly, on an antidepressant of the SSRI type, and nobody matched wrongly.</p>
            <p><strong>Still to do:</strong> the gates are in front of the models but no validator enforces them, and the rest of the referral list below stays documentation, because most of it depends on something happening later rather than on an intake answer.</p>
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Referral list: stop the advice and refer</p>
            <p>When any of these is reported, all fluid, salt, potassium, electrolyte, sauna and heat advice stops and the referral is what she gets instead.</p>
            <p className="mt-3"><strong>Call 000 or go to an emergency department</strong></p>
            <ul className="list-disc ml-5 space-y-1 mt-1">
              {EMERGENCY_REFERRALS.map(r => (
                <li key={r.trigger}>{r.trigger} <span className="text-[#9CA2AB]">({r.source})</span></li>
              ))}
            </ul>
            <p className="mt-3"><strong>See a GP soon, and pause the advice</strong></p>
            <ul className="list-disc ml-5 space-y-1 mt-1">
              {GP_REFERRALS.map(r => (
                <li key={r.trigger}>{r.trigger} <span className="text-[#9CA2AB]">({r.source})</span></li>
              ))}
            ...
            <ul className="list-disc ml-5 space-y-1 mt-1">
              {TRAINING_REFERRALS.map(r => (
                <li key={r.trigger}>
                  <span className="text-[#8A5514] font-medium">
                    {r.action === 'call-000' ? '000: ' : r.action === 'sports-dietitian' ? 'Sports dietitian: ' : 'GP: '}
                  </span>
                  {r.trigger} <span className="text-[#9CA2AB]">({r.source})</span>
                </li>
              ))}
            </ul>

            <p><strong>Sauna and steam gates rewritten (17 September 2026).</strong> The heat protocols carried four exclusions each, and two of them were wrong. "Currently dehydrated or fasted more than 16 hours" had no source behind the sixteen hours at all, and it is now "has not eaten or had anything to drink for most of the day", with one genuine hard no in its place: anyone on an SGLT2 inhibitor, the "-gliflozin" diabetes medicines, who is fasting, eating very low carbohydrate or in a hard cut, because that combination can produce a dangerous acid build-up even when their blood sugar reads normal. Pregnancy was a flat no and is now a gated yes: doctor or midwife first, and if they agree, 70 degrees or less for 20 minutes or less. There is a new line for men trying to conceive, because regular sauna lowers sperm count for a few months and recovers after stopping. Added: the heart, blood pressure, kidney, liver, adrenal and diabetes gates, the illness gate, and the list of medicines that change how the body handles heat, which is where most of the real risk sits. Age on its own is explicitly not a reason to exclude anyone, since healthy older adults tolerate sauna fine. All three heat protocols, traditional, infrared and steam, now share one list, so the next correction only has to be made once. Evidence: research pass E1a, section A3.</p>

            <p><strong>Electrolytes are now situational, not a habit (17 September 2026).</strong> Four places told clients to take electrolytes on a schedule: the daily routine generator used "electrolytes on waking" as its worked example, both saunas ended with "rehydrate with electrolytes", the pre-session guide said to add a pinch of salt or a tab, and the Challenge supplement list had them as a daily item. None of it had support, and the pre-session guide also claimed dehydration costs more performance than people realise, where the measured drop-off starts around three per cent of body mass, which an ordinary session does not reach if you drink when thirsty. Everywhere it now says plain water, with an electrolyte drink named only for a long session, heavy sweating in heat, or illness. The generator is additionally barred from suggesting salt or electrolytes to anyone on a fluid or salt limit or on a potassium-holding blood pressure medicine. The salt in a recipe stays, because that is seasoning. Evidence: research pass E1a, sections A4 and A5.</p>

            <p><strong>Water target corrected (17 September 2026).</strong> The Challenge and Blueprint nutrition pages told everyone to drink two to three litres of water a day, plus a pinch of salt in the morning glass and electrolytes during training. None of that had a source. The Australian reference is about 2.1 litres of <em>all</em> drinks a day for women and 2.6 for men, and tea, coffee and milk count toward it, so the old number asked most women for well above the reference in plain water alone, and it was unsafe for anyone whose doctor has capped their fluid. About two in three Australian adults already eat more salt than the target, so telling them to add more was working against them. The pages now say about two litres of drinks a day, more in heat and heavy sweat, pale urine as the check, water during training with an electrolyte drink only for long or very sweaty sessions, and a line that a doctor's fluid or salt limit overrides us. Evidence: research pass E1a, sections A6, A1 and A5.</p>

            <p><strong>Salt cravings changed meaning (17 September 2026).</strong> The intake question about salty or savoury cravings used to count as a strain signal, on nothing. No human study found stress raises salt intake, salt liking is mostly learned and falls within months of eating less salt, and adrenal fatigue is not a recognised condition, so that phrase is now blocked from anything a client reads. The question stays, because it matters in one specific way: a high answer <em>together with</em> weight lost without trying, dizziness on standing, or skin and gums looking darker now raises a GP referral in the read. Those three are now asked directly, next to the craving question (fm_04a to fm_04c), rather than hoped for in free text, and all three are scored neutral because they are referral inputs rather than load. Ongoing nausea and unshakeable fatigue still count when they show up in her notes or the sleep and stress sections. On its own it says nothing and the read stays quiet about it. If a doctor has told her to eat extra salt, every salt-reduction suggestion switches off. Evidence: research pass E1a, section A8.</p>
            <p><strong>Adults only, enforced (17 September 2026).</strong> The Performance scorecard now offers Under 18 as an age option, and picking it stops the scorecard: nothing is sent, no lead is created, and she is pointed to her doctor or an accredited practitioner who works with younger athletes. The foundational intake refuses at the route if the date of birth is under 18, so it cannot be posted around the form. This was an open item on the peer review control sheet: reading where a developing body holds fat risks feeding disordered eating, and the doctrine's exclusions were written for adults.</p>
            <p><strong>Consent is now asked at the point of collection (17 September 2026).</strong> The foundational intake will not move off its first screen until she ticks a box agreeing to us collecting her health information, and the blood upload will not submit until she ticks one about the panel. Both show a short notice she can expand: what we collect, why, who else sees it and in which country, that a model writes the first draft and a coach reviews it, how long we keep it, and how to complain. Both ticks are stored with a timestamp, because a tick nobody recorded is the same as no tick. Intakes and panels from before that date have no timestamp, which is expected.</p>
            <p><strong>Client blood read paused (17 September 2026).</strong> The client-facing reading, the one that told her in plain words what her panel showed and why it mattered, cannot be generated or published for now. Writing a client an explanation of what her results mean is the single feature most likely to put Body Recode inside the medical device rules, so it is switched off until a lawyer rules on it. Everything else is unchanged: markers are still transcribed, lab-flagged values still go to her GP, the coach analysis and Research Lens are still yours, and an approved panel still feeds her plan. One published reading from June stays where it is, and unpublishing still works. Switching it back on is one environment setting, no code change.</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Research Lens (coach-only thinking tool)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Weekly Check-In Window Open</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Weekly Check-In Confirmation (to client)</p>
            <p>Sent automatically when a client submits a check-in form. Dark-themed branded email confirming receipt.</p>

            <p className="font-semibold text-[#0F1115] mt-4">Weekly Check-In Notification (to you)</p>
            <p>Sent automatically when a client submits a check-in form. Includes the form type and a link to the client profile.</p>

            <p className="font-semibold text-[#0F1115] mt-4">Weekly Check-In Coach Feedback (manual — you trigger it)</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#DCDCD7] text-sm">
              ...
              <li><strong>Eating anchors are grounded in the active nutrition plan (2026-06-21).</strong> When next_focus prescribes a meal count, protein anchor, or any prescribed metric, the number must match <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">nutrition_plans.meal_frequency</code> / <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">protein_anchor_g</code> exactly. Pre-2026-06-21 the generator had no nutrition-plan awareness and Ruby-Cate W6 and W7 both produced &quot;three meals&quot; anchors against a 4-meal plan. The generator now loads the active plan and the system prompt forbids inventing meal counts. If no plan is on file, eating anchors are off the table entirely; pick a different lever.</li>
              ...
              <li><strong>Session counts are grounded like meal counts (2026-08-17).</strong> Any session count in any field must match <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">programs.training_frequency</code> or what the client actually logged this block week. A mismatch triggers the same auto-retry as a meal-count mismatch. Sets, reps, loads, RPE values and exercise names stay banned — the anchor can say &quot;hold all three sessions&quot;, never &quot;drop the squat to 3 sets of 8&quot;.</li>
            </ul>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Auto-Response Pipeline (2026-06-15 — explicit approval gate)</p>
            ...
            <ol className="space-y-1 list-decimal list-inside text-[#4A4F57] text-sm">
              <li>Client submits Form A or B → <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">submit-weekly-checkin</code> route fires the Inngest event <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">weekly-checkin/submitted</code> with the check-in id.</li>
              <li>Auto-response worker waits 30 seconds (settle delay), then gates on: <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">clients.auto_checkin_response_enabled</code> (default true; per-client opt-out on the profile), <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">coach_skipped_at</code> not set, no existing feedback row (coach didn&apos;t beat the worker). <strong>Every gate exit stamps <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">weekly_checkins.auto_response_attempted_at</code> + <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">auto_response_failure_reason</code></strong> so silent drops are visible in the DB.</li>
              <li>Worker calls the shared <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">generateFeedbackDraft</code> helper (same path the manual Generate button uses). On a clean draft, it inserts the feedback row with <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">auto_generated_at</code> and a random <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">approval_token</code> (column default <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">gen_random_uuid()</code>).</li>
              <li><strong>Worker emails Kade an [Approve] preview</strong> containing the client&apos;s full check-in answers (organised by section) + the three-field AI draft + an <strong>Approve &amp; Send</strong> button pointing at <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">/api/coach/approve-checkin-response?token=…</code>. Best-effort: preview-send failures are logged but never abort the worker (feedback row + token still in DB; dashboard remains the fallback).</li>
              <li><strong>Kade clicks Approve &amp; Send.</strong> The endpoint loads the feedback by token, checks it isn&apos;t already sent and the check-in isn&apos;t skipped, sends the branded email to the client, BCCs <strong>{coach().email}</strong>, stamps <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">email_sent_at</code> + <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">coach_approved_at</code>, and logs to client_communications with meta <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">approved_via: &quot;email_button&quot;</code>. Returns a small branded confirmation page in the browser. Idempotent: clicking the link twice returns &quot;Already sent at …&quot;.</li>
            ...
            <p><strong>Rescue cron (2026-06-14).</strong> <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">/api/cron/weekly-checkin-auto-rescue</code> runs every 4h (<code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">0 */4 * * *</code>). Re-fires the <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">weekly-checkin/submitted</code> Inngest event for any check-in submitted &gt;6h ago where the auto-response pipeline never touched it (<code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">auto_response_attempted_at IS NULL</code> AND no feedback row AND client opted in). Backstop for transient Inngest delivery failures and silent function drops.</p>
            <p><strong>EMAIL_INVENTORY note:</strong> the client-facing feedback email itself (template + body + signature) is unchanged. The [Approve] preview email TO Kade is new (2026-06-15); see the Weekly Check-in Coach Feedback Approval Preview entry. Same Resend send path, same COACH_BCC on the client send, same client_communications kind <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">weekly_checkin_feedback</code>; approval-button sends are flagged in meta with <code className="bg-[#F2F2EF] px-1 rounded text-[#0F1115] text-[12.5px]">approved_via: &quot;email_button&quot;</code> for audit.</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Face-to-Face Session Booked (to client + to you)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Coaching Start Reminder</p>
          ...
          <Section id="communications" title="16. Communications Timeline" colour="teal">
            <p className="font-semibold text-[#0F1115]">Lead detail page, rebuilt 12 Aug 2026</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-2">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Communications</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Client detail page</p>
            ...
            <Note>Historical sends from before this feature shipped are best-effort backfilled from existing per-event timestamps (subscription link, portal email). Everything sent from now on is logged exactly as it goes out. To extend the log to a new email type, call <code className="text-[#0F1115]">logClientCommunication()</code> from <code className="text-[#0F1115]">@/lib/client-communications</code> alongside the <code className="text-[#0F1115]">resend.emails.send()</code> call.</Note>
          </Section>
          ...
          <Section id="assets" title="16b. Assets" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What is listed</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="offboarding" title="16c. Ending an Engagement" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Revoke access, retain records</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">The notes field matters more than the reason</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Reinstating</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Retention</p>
          ...
          <Section id="publishing-readings" title="16d. Publishing Reads to a Client" colour="teal">
            <p>Generating a read no longer publishes it. The Foundational, Program and Nutrition reads are <strong>drafts until you publish them</strong>, which is a separate click on each panel.</p>

            <Note><strong>Why this changed (2026-08-01).</strong> All three used to go live in the client portal the instant they were generated, which meant the first person to read a client&apos;s Foundational Read was the client. One published asserting &ldquo;everything going on with your family&rdquo; about a client who had never mentioned family. She ended her engagement over it.</Note>

            <p className="font-semibold text-[#0F1115] mt-3">The publish check</p>
            <p>Publishing runs an automatic check and <strong>refuses</strong> if it finds either of these:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>A life circumstance the client never mentioned.</strong> Family, partner, children, caring for someone, a bereavement, a new job. If it is in the read and nowhere in their intake, CFFS or your guidance, it will not publish. If they did mention it, it passes.</li>
            ...
            <Note><strong>This is not a review.</strong> It catches sentences that assert something your data contradicts or never contained. It cannot tell you whether a read is any good. A clean check means nothing was caught, not that it is right. Read it before you publish.</Note>
          </Section>
          ...
          <Section id="admin-actions" title="17. Admin Actions" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-2">Admin Actions panel</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="system-health" title="17b. System Health Check" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What it checks</p>
            <p>The check runs 19 tests across four groups every day:</p>

            <p className="font-semibold text-[#0F1115] mt-3">1. Infrastructure</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">2. Write Smoke Tests</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">3. Data Integrity</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Who counts as an active client, corrected 20 September 2026.</strong> Four of the checks below each had their own idea of it, and every one of them excluded clients you had ended but included clients you had <strong>frozen</strong>. So the report chased four offboarded people to finish an intake, and two frozen ones to submit a check-in, every day for weeks. One definition now decides it, so a check added later cannot forget. <strong>A client who will not do weekly check-ins by arrangement</strong> can now be marked as such on their file, with the reason, and is left out of the chase and counted separately in the report. That decision used to live in notes while the system chased them daily.</li>
              <li><strong>Background jobs</strong> (added 20 September 2026) - two different failures in one row. Any scheduled job that failed in the last 24 hours, which already emailed at the time, so this is the daily total that turns a job failing every few hours into a visible pattern. And, more importantly, any job that has <strong>not run inside its own window</strong>. That second one is the only way a job which quietly stopped being scheduled is ever noticed, because it produces no error anywhere: nothing ran, so there is nothing to find. A job recorded under a name nobody put in the schedule list is named too, since a job that cannot be missed is a job nobody is watching.</li>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">4. Automation + Pipeline</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What it fixes automatically vs what needs you</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Viewing run history</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Downloading a run as a file</p>
          ...
          <Section id="platform-buildout" title="17e. The Build board, and the two boards it replaced" colour="teal">
            <p><strong>Since 14 Sep 2026 there is ONE build board: Dashboard → Product → Build.</strong> It shows everything being built, for the Body Recode read, the coaching engine and Strenn, in the order it actually gets built. Each step carries a label for the products it serves: <strong>Strenn</strong>, <strong>Read</strong> (the Body Recode read sold on its own) and <strong>Coaching</strong>.</p>
            <p className="font-semibold text-[#0F1115] mt-4">Why one board</p>
            <p className="text-[#4A4F57] text-sm">Three boards meant three percentages and three &quot;next up&quot;s for one person building one engine. The Build board is the only build order. The SaaS Launch board stays separate because it answers a different question: whether anybody is buying.</p>
            <p className="font-semibold text-[#0F1115] mt-4">The stages</p>
            <p className="text-[#4A4F57] text-sm">Re-ordered 20 Sep 2026 to match the decision that the coach platform ships first. <strong>Strenn is a working name</strong>, chosen 14 Sep after Rey was checked and dropped, held until an attorney clearance comes back. Older documents still say Rey and mean the same product.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Already built</strong> — the finished parts of the read and the engine, verified against the code on 14 Sep.</li>
              <li><strong>First · Body Recode SaaS</strong> — what stands between here and a coach paying: a coach seeing only their own clients (done), a coach signing themselves up and bringing their list (done), doctrine enforced in code, the pilot agreement, pricing, billing, a support loop, data rights, monitoring, and the evidence pack for club conversations.</li>
              <li><strong>First · Better inputs</strong> — measurements with a source and a competence rule, machine readings and device data taken seriously instead of trusted blindly.</li>
              <li><strong>First · Evidence</strong> — the research passes that gate go-live. Six of ten done.</li>
              <li><strong>Both · Engine without a coach</strong> — every plan checked against the doctrine before it saves, the next block building itself, progression without a coach deciding, programming to the equipment she has, tests, and cost at a thousand subscribers.</li>
              <li><strong>Both · Company, Clinical safety, Legal and privacy, Security</strong> — the entity, an independent clinician reviewing the doctrine, pre-exercise and disordered-eating screening, medical device status, the privacy work with a December 2026 deadline, and the security items from access logging to a penetration test.</li>
              <li><strong>Strenn · Name and demand, then Product</strong> — clear and file the name, prove women will pay, then the consumer read, signup, the subscription, her plan on screen and the weekly loop.</li>
              <li><strong>Strenn · Stage 2 and Stage 3</strong> — the phone app and voice, readiness changing today&apos;s session, soreness triage and safe swaps; then Strenn answering from her own read between sessions, symptom check-ins, bloodwork and clinician access.</li>
              <li><strong>Later · Platform customers, and Later</strong> — the coach screen for someone who has never read the doctrine, other companies&apos; software, then wearables, machine measurements, full meal plans behind an evidence gate and the second audience.</li>
            </ul>
            <p className="font-semibold text-[#0F1115] mt-4">How it stays honest</p>
            <p className="text-[#4A4F57] text-sm">Nothing is written on the Build board itself. Every step is recorded once, in the file for its part of the system (<code>saas-buildout-manifest.ts</code> for the read, <code>performance-coaching-buildout-manifest.ts</code> for the engine, <code>rey-buildout-manifest.ts</code> for Strenn), and <code>src/lib/build-sequence.ts</code> arranges them. A step cannot be done in one place and open in another. A step added without a place in the order appears at the top as <strong>Unsorted</strong> instead of vanishing. The Today page reads the same order, so it can never disagree about what is next.</p>
            <p className="font-semibold text-[#0F1115] mt-4">The two older boards (history)</p>
            <p className="text-[#4A4F57] text-sm">Still reachable under Settings, no longer in the sidebar. They hold the phase-by-phase history and are where statuses are edited. Their original description follows.</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">The Body Recode board — what each phase covers</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Phase 3 · Better inputs, the where and the why</strong> <em>(cycle phase SHIPPED 9 Sep — the weekly read now knows where in her cycle a check-in week sits)</em> — accept richer inputs from any source, require none. <strong>Two halves.</strong> The machines answer <em>where</em>: accept measurements from any source, tagged with where they came from. Measurements become a list carrying <em>what, the number, and where it came from</em>, so adding a machine later is a label rather than a rebuild. The doctrine is a <strong>competence map, not a ranking</strong>: DEXA speaks to android/gynoid ratio and regional lean; InBody and Evolt to segmental muscle and fluid, never absolute fat percentage and never across machines; a 3D scan to shape only, since it cannot tell muscle from fat; a tape to circumference if plausible. ⚠ Every one of them says <em>where</em>, none says <em>why</em>. The second half is the <em>why</em> inputs: cycle phase (a verified gap — the weekly read does not know if she is on day 3 or day 24), an apnoea screen, grip strength, blood pressure, measured metabolic rate against predicted, and a CGM to measure Insulin-Drift rather than infer it. Salivary cortisol is named and deferred; genetic and microbiome testing are deliberately rejected. NOT blocked by the gate; it sits after door 2 because it must not be done instead of finding a coach.</li>
              ...
              <li><strong>Phase 6 · Security and data handling</strong> — what the SYSTEM does, as distinct from what the documents say. Sub-processor register (⚠ the privacy policy currently names nobody, while client data goes to Anthropic on every read), a route-guard audit, a re-runnable tenant isolation proof, access control, retention and deletion, a breach process, and the security questionnaire answer pack every platform sends before their engineers are allowed near you.</li>
            </ul>

            <p className="font-semibold text-[#0F1115] mt-4">The Collective phases — now on the PERFORMANCE COACHING board (moved 9 Sep 2026)</p>
            <p className="text-[#4A4F57] text-sm">The Collective was designed for coaches running the whole Performance Coaching product under their own brand, on BR doctrine. That is Layer 2 white-labelled, not the read, so these moved off the Body Recode board along with the tenancy, branding and billing work built for them. Door 2 depends on that multi-coach plumbing; it is tracked once, where it was built for, rather than on both boards.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">How to read it</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">The Today runbook hook</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Source of truth &amp; discipline</p>
          ...
          <Section id="speed-to-lead-sms" title="17f. Speed-to-Lead SMS" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What triggers a send</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Send-window rules (AEST)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Send guards (enforced in <code>sendLeadSms</code>)</p>
            <ol className="space-y-1 list-decimal list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">STOP / opt-out</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Dashboard</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Canonical docs</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Tenancy note (SOT)</p>
          ...
          <Section id="partner-billing" title="17g. Partner Billing (Kade's billing of the Collective)" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Active Client counter</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Invoicing (v1 is manual)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Canonical files</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="doctrine-parameters" title="17h. Doctrine Parameters (Mode A+)" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What can be tuned (six parameters, all optional)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What can NOT be tuned</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Editing</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Consumption (v1 surface, v2 wiring)</p>
          ...
          <Section id="licensee-readiness" title="17d. Licensee Readiness: Audits + Versioning + Validators" colour="teal">
            <p>Ruby-Cate&apos;s nutrition plan audit (2026-06-09) surfaced a class of error that&apos;s critical for licensing: AI-generated artefacts that look plausible but were produced under doctrine versions that no longer reflect the current rules. Her published Foundational Read contained &quot;mid-arc compression&quot; and &quot;sympathetic dominance&quot;, her Nutrition Read contained &quot;downregulating&quot; three times and &quot;wired-but-tired&quot;, and her substitution list claimed &quot;100g dry rice ↔ 150g raw potato — equal carb substitution&quot; (3x off). All banned in weekly-check-in feedback for a month, but never enforced on FR/PR/NR because each generator carried its own ad-hoc list.</p>
            <p>Five system changes shipped 2026-06-09 to close this gap:</p>

            <p className="font-semibold text-[#0F1115] mt-4">1. Shared banned-terms constant (item B)</p>
            <p>All client-facing generators now import the same regex list from <code>src/lib/banned-client-terms.ts</code>. The Foundational Read, Program Read, Nutrition Read, and Progress Read generators each run <code>findLeakedTerms</code> on their JSON output before persisting. If any banned term appears (CFFS, CFWS, mid-arc, spatial patterning, downregulate, sympathetic dominance, etc.), the API returns a 500 and the coach is prompted to Regenerate. Single source of truth means adding a new banned term in one place blocks it across every generator.</p>

            <p className="font-semibold text-[#0F1115] mt-4">2. Backfill audit dashboard (item A)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">3. Doctrine version stamps everywhere (item D)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">4. Food reference table (item C)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">5. Substitution-equivalence validator wired in (item E)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">6. Pre-publish audit pill on the client profile (item H)</p>
            <p>Every Foundational Read / Program Read / Nutrition Plan section header on the client profile now shows a green / amber / red pill: <strong>green</strong> = audit passes, <strong>amber</strong> = review (stale doctrine version or validator warnings), <strong>red</strong> = regenerate (banned terms leaked or blocking validator errors). Click the pill to expand and see the specific failures (which banned terms, which validator codes, which doctrine version mismatch). All checks happen server-side at page render so there&apos;s no client-side latency.</p>

            <p className="font-semibold text-[#0F1115] mt-4">7. Doctrine version coverage summary (item G)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">8. Versioned change log per client (item I)</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What&apos;s still queued</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="onboarding-nudges" title="17c. Onboarding Nudges and Form Drafts" colour="teal">
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Form drafts - clients can resume mid-form</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Foundational Intake ({getTotalQuestions()} questions)</li>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">Automated reminder emails</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Tasks tracked</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Reminder cadence</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="font-semibold text-[#0F1115] mt-3">Medical Clearance gating</p>
            ...
            <p className="font-semibold text-[#0F1115] mt-4">What you see vs what gets tracked</p>
          ...
          <Section id="training-program" title="20. Training Program - PTS (Performance Training System)" colour="teal">
            <p className="mt-2"><strong>Which week of the block it is (fixed 21 Sep 2026).</strong> Block weeks now run <strong>Monday to Sunday</strong>, anchored to the Monday of the week the block started, so they match the calendar week you and the client both mean. Before this they ran from whichever day the block was generated: two blocks made on a Tuesday meant Monday was the last day of the old week, so the log page showed a week that was already fully logged and today&apos;s session could not be recorded. Earlier versions of the same fault rolled the week at the activation <em>time</em> of day, and refused every log once a block passed its end date. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npm run test:block-week</code> covers all three.</p>
            <p className="mt-2"><strong>Sessions stuck &quot;in progress&quot;.</strong> Opening a session and not finishing it leaves a shell with the exercises listed but no sets, reps or loads, and it makes the week look done. Mark those <strong>abandoned</strong>, never completed and never deleted: completing one counts it as a session they did and inflates adherence, deleting it loses the record, and the logging code already skips abandoned rows so a fresh session can start.</p>
            <Note><strong>Doctrine check on every new block (added 2026-09-14).</strong> When a block is generated, four rules that used to live only in the instructions are checked in code: no spine-loading exercises when regulation readiness is Red; in Remediation, no spine-loading exercises outside the primary slot and no high-stability exercises; and no exercises that mainly stress a joint the client currently reports pain in. Any break is listed at the top of the block&apos;s Weekly Structure notes as &ldquo;DOCTRINE CHECK, N rule breaks to review&rdquo;. It does not stop the block saving: you decide whether each is right for this client. Separately, the rule that every exercise must come from the approved library now actually works; it had been checking the wrong field and refused nothing.</Note>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Single entry point — programs always start from a macro-plan block</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The Generation Flow</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Training Age Modulation (CRITICAL)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Medications Modulation</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-3 mb-1">Hormonal-class (enforced deterministically by the doctrine clamp)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-3 mb-1">Non-hormonal categories (applied by the engine during generation, surfaced in weekly_pattern_summary)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Program Structure</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step 5 - Weekly Review (Client Portal)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-6 mb-2">Programs Index (On the Floor View)</p>
            <p>Top nav <strong>Programs</strong> (or <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">⌘K → Programs</code>) opens the floor view: every active client&apos;s current training block in a single mobile-first card grid. One tap on a card opens that client&apos;s training program page.</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Deleting plans</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Workout logging (Phase A)</p>
            <p>Clients can now log what they actually lifted, set by set, live in the gym. The flow:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Client opens <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/&#123;token&#125;/program</code> and taps the new <strong>Log a session →</strong> button.</li>
              ...
              <li><strong>A finished block used to block logging entirely (fixed 2026-09-08).</strong> Once a block passed its planned end date, the system refused to record any session at all: it returned &quot;week 9 is past the block end&quot; and saved nothing. Blocks routinely run over, because you build the next one when the check-in and progress data are in rather than on the day the calendar says. In that gap the client keeps turning up, and every session they did was thrown away. It cost two of Razia&apos;s real sessions. Sessions in an overrun block are now recorded against the block&apos;s final week, and the pill reads &quot;keep logging, sessions count to the final week&quot; instead of implying logging has closed. The block-end prompt already fires by then, so nothing is lost by accepting the session.</li>
              <li><strong>Two logging faults fixed 2026-09-07.</strong> Both surfaced when Kade trained Cristobal in person and could not log the session. (1) The block week rolled over at the <em>time of day</em> the program was activated rather than at midnight, so at 8am on a Monday the page still showed the previous block week, whose sessions were all already logged, leaving nothing to start. It is now anchored to midnight Brisbane on the block&apos;s start date. (2) Today&apos;s session was matched by comparing the WHOLE day_label against the weekday name, and real labels are compound (&quot;Monday — Full Body A (Squat / Push / Pull)&quot;), so the match never succeeded, the Start CTA never appeared on the day a session was due, and the evening SMS nudge never fired. There is now one shared matcher that reads the weekday out of the label, used by the portal log index, the coach train page, the evening nudge and Greg&apos;s session reminder.</li>
            ...
            <Note>Logged data is captured in three new tables: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">session_completions</code> (one per session × week), <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">session_exercise_completions</code> (one per exercise, with prescribed-vs-actual + substitutions), <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">exercise_set_logs</code> (one per set). The prescription is snapshotted at session start so a mid-block program regeneration cannot retroactively change what was logged.</Note>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What&apos;s coming in Phase B + C</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Phase B partial (DONE 2026-05-10)</strong>: block-end email notifications. Daily cron at 7:30am Brisbane scans all active programs and emails <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{coach().email}</code> when (a) any client&apos;s block has 7 days remaining, or (b) any client&apos;s block hits day 0. Branded dark template. Idempotent — one email per (client × program × event), so re-runs of the cron never spam. New table <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">block_end_notifications_sent</code> enforces it.</li>
              ...
              <li><strong>Phase C</strong>: auto-fill the Recovery Router&apos;s <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">session_repeatability</code> signal from logged data (compare last week&apos;s avg loads to this week&apos;s); surface &quot;missed &gt;2 sessions&quot; as a router signal.</li>
            </ul>
          
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-6 mb-2">Set volume, and what to do when they also run (2026-08-30)</p>
            ...
            <div className="overflow-x-auto mt-2">
              <table className="text-[12.5px] w-full">
                <thead><tr className="text-[#6E747D] text-left"><th className="font-medium pb-1">Phase (advanced tier)</th><th className="font-medium pb-1">Min</th><th className="font-medium pb-1">Target</th><th className="font-medium pb-1">Max</th></tr></thead>
                <tbody>
                  <tr className="border-t border-[#E4E4E0]"><td className="py-1">Restoration</td><td>12</td><td><strong>14</strong></td><td>16</td></tr>
                  <tr className="border-t border-[#E4E4E0]"><td className="py-1">Accumulation</td><td>14</td><td><strong>17</strong></td><td>20</td></tr>
                  <tr className="border-t border-[#E4E4E0]"><td className="py-1">Intensification</td><td>13</td><td><strong>16</strong></td><td>18</td></tr>
                  <tr className="border-t border-[#E4E4E0]"><td className="py-1">Realization</td><td>13</td><td><strong>16</strong></td><td>18</td></tr>
                </tbody>
              </table>
            </div>
            ...
            <Note><strong>It stops inflation, it does not force a reduction.</strong> The ceiling does not move, so anything you deliberately write between the floor and the ceiling still stands. What changes is that a lighter block is no longer silently pushed back up on regeneration. Recorded on the block in <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">concurrent_endurance_sessions</code>, so a block also stops being blind to the fact the client runs.</Note>
          ...
          <Section id="program-reading" title="20b. Program Read - Client Facing" colour="teal">
            <p>The Program Read is the client-facing translation of the active training block. It sits at the top of the client&apos;s program page so the &ldquo;why this block&rdquo; frames every session they open. It is the bridge from the Foundational Read (state and patterns) to the prescription (sessions, sets, reps), written so the client understands what this block is for, what it will ask of their body, and how we will read it as it unfolds.</p>

            <p>It is generated by Claude Haiku 4.5 using the client&apos;s latest published Foundational Read as the state context plus the active program row as the prescription context. The two reads read as one voice. The Foundational Read sets the state; the Program Read shows how the state shapes the block.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to publish a Program Read</p>
            <p>On the client profile, open <strong>Training Program</strong>. The <strong>Program Read - Client Facing</strong> panel sits directly above the active program body. Click <strong>Generate &amp; Publish</strong>. The reading:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Reads the latest published Foundational Read for voice and state context (required — the panel will refuse to generate without one).</li>
              ...
              <li>Auto-publishes it to the top of <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/program</code>.</li>
              ...
              <li>Also makes the cream-on-black premium-deliverable version available at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/program/reading</code> via the &quot;View as document&quot; link on the portal card.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The five sections</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>01 Why this block</strong> - Anchors the block in the body state from the Foundational Read. What we are trying to shift this time, in the client&apos;s own language.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Coach Guidance, edit, and re-publish</p>
            <p>Same affordances as the Foundational Read panel:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Unpublish / Republish</strong> - Hide the read from the portal without deleting the text.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Doctrine guardrails</p>
            <p>Same content rules as the Foundational Read: no sets / reps / loads / RPE / percentages, no specific exercise names, no calorie or macro targets, no diagnoses, no causal claims, no em dashes, no exclamation marks. The body is interpreted as coherent, never broken. Conservative resolution overrides optimistic interpretation. Whenever the &quot;not doing yet&quot; section touches on fat loss or weight, the AI must reassure the client that outcomes typically follow as a downstream consequence of building capacity first.</p>

            <Note>The Program Read is per-block, not per-client. Each new program row gets its own reading. Generating a new block clears the prior reading state and creates a fresh canvas. The Foundational Read is the constant; the Program Read evolves with each block.</Note>
          </Section>

          {/* Block-end Trajectory Reading - client-facing read of the CFWS arc */}
          <Section id="trajectory-reading" title="20c. Progress Read - Client Facing" colour="teal">
            <Note><strong>The new Progress Read (14 Sep 2026).</strong> For Progress Checks on the near-full form there is a <strong>Progress Read</strong> tab on the client. When she has submitted, click <strong>Generate Progress Read</strong> (4 to 6 minutes). It re-derives the whole read from her Progress Check laid over her intake, the new measurements and photos, the weekly check-ins since and any approved bloods, alongside her previous read and the section-by-section comparison. It shows readiness then and now, the pattern (and, if it changed, the evidence), the four readiness ratings, <strong>Her version</strong> exactly as she will see it, and a <strong>For you only</strong> area: operating rules, competing read, constraints, flags, watch items, non-directives. The rules are enforced in code: readiness moves at most one step, the hormone-linked patterns follow sex at birth, a pattern change must name its evidence, and her version may not use internal terms. It never touches the Foundational Read. <strong>Publish to her portal</strong> re-runs the pre-publish check on her version and shows it in her portal (her home page card and Your reads, where it becomes her current read and the Foundational Read becomes her first read). It sends nothing. <strong>Notify her</strong> then emails &ldquo;your Progress Read is ready&rdquo;, BCC to you. Her version includes her readiness in four parts, each as one plain sentence (capacity, your week, regulation, consistency), never as Green, Amber or Red. Unpublish takes it back out of her portal. <strong>Once published it becomes her current read</strong>: the weekly read, weekly feedback drafts, new training blocks, eating plans, the suggesters, guidance drafts, the co-pilot, the Direction page, recovery and supplement suggestions, and medication and blood panel reads all work from its findings, and her readiness label on the portal, the profile and the coaching roster follow it. A draft never does. Unpublishing reverts all of that automatically. The Foundational Read itself is never changed. Older checks keep the panel below on the Training page.</Note>
            <p>The Progress Read is the client-facing read of the whole training block, written once the block has finished. Where the Foundational Read is the client translation of the CFFS (a single snapshot) and the Program Read frames the prescription, the Progress Read is the client translation of the <strong>CFWS arc</strong>: it reads the SEQUENCE of weekly syntheses across the block and tells the client how their signal moved over time, not where it sits in any one week. It is the fifth reading and the first that reads time, not a moment.</p>

            <p>It sits below the Program Read on the client&apos;s program page once published, and is also available as a standalone document. It exists so the client can step back from the week-to-week, see the shape of where they have been travelling, and trust that the work compounded even on the flat weeks.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to publish a Progress Read</p>
            <p>On the client profile, open <strong>Training Program</strong>. The <strong>Progress Read - Client Facing</strong> panel sits directly below the Program Read panel. Unlike the Program Read, it is <strong>coach-gated like the Foundational Read</strong>: generating produces a DRAFT only, and a separate publish step surfaces it and emails the client.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>The panel shows a <strong>block-status note</strong>. The read is designed for block end; before then it shows the current week of the block (e.g. &ldquo;week 4 of 6&rdquo;). You can still generate an early draft from the weeks completed so far, with a confirm.</li>
              <li><strong>Generate draft</strong> reads every non-archived CFWS row in the block&apos;s week range (oldest first), plus the published Foundational Read for voice. It writes a draft and does NOT publish or email.</li>
              ...
              <li><strong>Publish &amp; notify</strong> surfaces the read at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/program</code> and, the first time this block is published, emails the client (&ldquo;your Progress Read is ready&rdquo;). Republishing never re-emails.</li>
              <li>The standalone document lives at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/portal/[token]/program/trajectory-reading</code> via the &quot;View as document&quot; link.</li>
            </ul>
            ...
            <Note>Per-block, like the Program Read. Each program row gets its own Progress Read once its block completes. Coach-gated end to end: nothing reaches the client until you publish.</Note>

            <Note><strong>Notify Client (restored 2026-06-22).</strong> Publish to portal and notification email are now two separate clicks, mirroring the Program / Nutrition Notify Client pattern. <strong>Publish</strong> surfaces the read on the client portal; once published, a <strong>Notify Client</strong> button appears for the explicit send. Email stamps <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">programs.trajectory_reading_email_sent_at</code> and the button label flips to <strong>Notify Again</strong>. The earlier 2026-06-09 decision to drop the auto-email was kept in spirit (publish doesn&apos;t auto-fire), but block-end readings are their own reflection moment and need their own coach-gated notify path rather than waiting for the next program publish to be the client touchpoint.</Note>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-6 mb-2">Progress Read - re-scoring body state at block-end (2026-08-11)</p>
            <p>The <strong>Progress Read</strong> is the same Progress Read with one addition: it re-scores the client&apos;s body state (Depleted / Transitioning / Ready) <strong>then vs now</strong>. It answers the client&apos;s real question at block-end - &ldquo;have I actually moved?&rdquo; - the way Equinox re-runs a fitness assessment. The pattern (Stress-Stored, Insulin-Drift, etc.) is <strong>held</strong>; only the state moves. A re-read never re-diagnoses the pattern, it only nudges confidence in it.</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
              <li><strong>Send Progress Check.</strong> At block-end a <strong>Send Progress Check</strong> button appears above the read panel. One click emails the client the re-assessment. <strong>From 14 Sep 2026 it is the near-full re-ask</strong>: 231 of the intake questions (everything except identity, sex at birth, sign-off and past injury history), &ldquo;what has changed since your last read&rdquo; first, then her measurements and three photos, about 15 to 20 minutes. Each old answer is hidden until she answers, then shown beside her new one; she can mark an old answer as never right, which is kept as its own record and never changes the original; it saves as she goes. Checks created before 14 Sep stay on the old 24-question form. <strong>Two timing gates apply:</strong> she must have reached the <strong>final week</strong> of her block (revised 31 Aug 2026 from &ldquo;the block must have ended&rdquo;), and this week&apos;s check-in must be in, so she never gets both asks at once. A blocked send explains why and offers &ldquo;Send it anyway&rdquo;. Logs <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">progress_check_invite</code>.</li>
              <li><strong>Client submits.</strong> You get a notification email with a link back to the program. For the near-full check it says, in her words, what has changed; which sections moved compared with last time (a section only counts as moved when enough of its questions moved the same way); how many old answers she disputed; any injury questions to watch; and whether her medications answer differs from the profile, which is <strong>never overwritten</strong> automatically. Pregnant now, or non-prescribed testosterone or anabolic use, turns it red. Nothing publishes on its own.</li>
              <li><strong>Generate.</strong> Click Generate on the read panel. It reads the block&apos;s weekly arc <em>and</em> the Progress Check (for the near-full check, the computed section-by-section comparison rather than 231 raw answers), and produces the read plus a <strong>State Re-Score</strong> card (previous state → new state, direction, a plain-language rationale, and a pattern-held note). Review and edit as normal.</li>
              <li><strong>Publish + Notify.</strong> Same two clicks as any reading. When a re-score is present the client&apos;s document is titled <strong>Progress Read</strong> and leads with a &ldquo;Where you are now&rdquo; section; without a Progress Check it stays the plain Progress Read.</li>
            </ul>
            <Note><strong>If a read keeps refusing to generate.</strong> Readings are audited for internal terminology before they save, and the generator now redrafts up to three times on its own. If all three fail, the error names the phrase and says so, because a phrase that repeats is usually a <em>source</em> collision rather than a bad draft: something in the prompt is feeding the model a word the audit will not let it say back. That is exactly what happened on the first Progress Read ever attempted - the check asks &ldquo;I feel wired but tired&rdquo;, which is banned in client-facing reads, so every draft quoted it and was rejected. Questions like that now carry a separate prompt-safe phrasing: the client still reads the natural wording, the model never sees the banned term. <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">npx tsx scripts/audit-question-text.ts</code> checks all 285 questions and fails if a new one collides.</Note>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-6 mb-2">Carrying the re-score into the next block (2026-08-30)</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
              ...
              <li>What the block was actually built against is recorded on the program row in <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">body_state_at_generation</code>, with the override and your note beside it, so a block never silently loses the reason its level was set the way it was.</li>
            </ul>
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Where the re-scored state shows up (2026-08-30)</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
              ...
              <li><strong>The client portal waits for you to publish.</strong> Until the Progress Read is published the portal still says the foundational state. The client should meet a new state inside a read you have approved, not via a line quietly changing before you have said anything to them.</li>
              <li>The CFFS row is never written to. The foundational read and its published client read are untouched.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Readiness moves too (2026-08-30)</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm mt-2">
              ...
              <li>The suggest page shows the whole table - each domain, its intake value, the weekly verdict, and whether it will carry or be held - before you opt in. Carrying is the default, since the weekly read is the live one.</li>
              <li>Recorded on the block in <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">readiness_at_generation</code> along with the weeks that justified it.</li>
            </ul>
          ...
          <Section id="macro-arc" title="21. Macro Training Arc" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The Three Time Horizons</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="program-coach-guidance" title="21b. Program Coach Guidance" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">When to use it</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Drafting guidance with AI</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What it can and cannot do</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Scope and persistence</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="nutrition-coach-guidance" title="21c. Nutrition Coach Guidance" colour="teal">
            <Note><strong>Change one thing (added 2026-09-14).</strong> On a client&apos;s Nutrition page, above Regenerate, <strong>Change one thing</strong> adjusts her live plan without rewriting it. Describe the change (&ldquo;carbs up 50g, spread over the meals where she already eats carbs&rdquo;), click <strong>Show me the change</strong>, and you see each food that changes, the day&apos;s calories and macros before and after, and a warning if more than one macro moves by more than 8g, the number of meals changes, or a food is swapped rather than resized. Anything the change would break that the plan did not already have is shown in red and needs a tick to continue. <strong>Create revised draft</strong> saves it as a draft with the change noted in the coach guidance; everything else in the plan is carried across exactly, including the reading and supplements. Her live plan does not change until you click Approve. Use Regenerate only for a new block or a new direction.</Note>
          ...
          <Section id="nutrition-plan" title="22. Nutrition Plan - HABNS" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step 1 - Prescription Suggestion</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Dietary Context (HARD CONSTRAINTS for the engine)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step 2 - Plan Generation</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Validator Hard Rules (added 2026-05-25, last updated 2026-05-26)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Appetite-Suppression Hard Rules (added 2026-05-25)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Food Selection Doctrine (HABNS variety + Body Recode tier ban)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Weight Conventions</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Protein Anchor — Deterministic, Not LLM Math</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-3 mb-1">Hormonal-class</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-3 mb-1">Non-hormonal categories (surfaced in rationale, do not change calorie / macro targets unless explicitly indicated)</p>
            <p className="text-[12.5px] text-[#4A4F57] mt-1 mb-2"><strong>Rewritten 17 September 2026</strong> from research pass E1a. The old single line said &quot;beta-blockers / antihypertensives: hydration and electrolyte balance matter more&quot;, which was backwards for half the drugs it covered: fluid tablets lose potassium, while ACE inhibitors, sartans and spironolactone hold it, so pushing electrolytes at that second group was wrong advice for the people most at risk. Evidence: <code>00_PLAYBOOK/electrolyte_research/2026-09-17_E1a_RESULT_base_and_safety_gates.md</code>, section A7.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>Beta-blockers</strong> (metoprolol, atenolol, bisoprolol, propranolol, carvedilol, nebivolol): the issue is not hydration. They cap heart rate, so heart-rate zones and 220-minus-age do not work and intensity is set by effort or the talk test. They also reduce heat shedding, so hot sessions and sauna build up gradually. With insulin or a sulfonylurea, low blood sugar warning signs may be dulled.</li>
              <li><strong>Fluid tablets / diuretics</strong> (hydrochlorothiazide, indapamide, chlorthalidone, furosemide): extra sodium, potassium and fluid lost, especially in heat. Drink to thirst plus a planned amount for long or hot sessions. No forcing plain water, no low-salt diet, no potassium or electrolyte products.</li>
              <li><strong>Potassium-sparing classes</strong> (ACE inhibitors, sartans, spironolactone, eplerenone, amiloride, triamterene, sacubitril/valsartan): these <em>hold</em> potassium. Never salt substitutes, potassium supplements or high-potassium electrolyte drinks. Normal fruit, vegetables and dairy are fine unless their doctor says otherwise.</li>
              <li><strong>Calcium channel blockers</strong> (amlodipine, felodipine, nifedipine): ankle swelling is the drug, not salt or fluid. Never advise cutting either for it.</li>
              <li><strong>SGLT2 inhibitors</strong> (any &quot;-gliflozin&quot;): hard gate. No keto, very low carbohydrate, fasting or aggressive cut without the prescriber, because ketoacidosis can happen with normal blood glucose.</li>
              <li><strong>Lithium:</strong> hard gate. No salt or fluid changes, no heat or sauna block, no routine anti-inflammatories, without the prescriber.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Bridge Mode — Staged Ramp for Chronic Under-Eaters (added 2026-05-25)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Doctrine Versioning + Stale Hint (added 2026-05-26)</p>
            <p>Every plan is stamped with the current nutrition doctrine version at generation time (format <code>YYYY-MM-DD[.N]</code>). The coach plan view diffs this against the current value via <code>isDoctrineStale(plan.doctrine_version, &apos;nutrition_plan&apos;)</code> — when stale AND the plan has a non-null version, a soft [#F2F2EF] &quot;Doctrine update available&quot; card appears below the identity card with a regenerate CTA. Plans with null version (generated before the migration) are grandfathered and show nothing. <strong>Single source of truth: <code>src/lib/doctrine-versions.ts</code> (<code>DOCTRINE_VERSIONS.nutrition_plan</code>)</strong> — bump there when you ship a meaningful validator rule / threshold / prompt change. The legacy <code>NUTRITION_DOCTRINE_VERSION</code> in <code>nutrition-validation.ts</code> is now a re-export of the consolidated source (do not edit it directly; that was the cause of the 2026-06-22 staleness regression where freshly regenerated plans appeared stale immediately).</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Validator Telemetry Dashboard (added 2026-05-26)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step 3 - Draft Review</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Client View Preview (added 2026-05-28)</p>
            <p>The <strong>Client view</strong> and <strong>Document</strong> buttons on the nutrition read panel open a modal overlay rendering the client&apos;s portal page inside an iframe. You see exactly what the client sees, pixel-perfect, without leaving the coach dashboard. Close via Esc, backdrop click, or the X button. Coach scroll position and draft state are preserved across the round trip. Same pattern applies to the Foundational Read and Program Read panels.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step 4 - Weekly Review (Client Portal)</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
              ...
              <li><strong className="text-[#B06E1F]">Staying steady</strong> - no notable change. Monitor for a week or two. Consider whether macros need a small adjustment.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Key Concepts</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="nutrition-reading" title="22b. Nutrition Read - Client Facing" colour="teal">
            <p>The Nutrition Read is the client-facing translation of the active nutrition plan. It sits at the top of the client&apos;s nutrition plan page (the portal&apos;s /my-plan view) so the &ldquo;why this plan&rdquo; frames every meal they open. It is the bridge from the Foundational Read (state and patterns) to the prescription (meals, macros, structure), written so the client understands what this plan is for, what it will ask of their body, and how we will read it as it unfolds.</p>

            <p>It is generated by Claude Haiku 4.5 using the client&apos;s latest published Foundational Read as the state context plus the active nutrition_plans row as the prescription context. The three readings (Foundational, Program, Nutrition) read as one voice. The Foundational Read sets the state; the Program Read shows how the state shapes the block; the Nutrition Read shows how the state shapes how we feed the body right now.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to publish a Nutrition Read</p>
            <p>On the client profile, open <strong>Nutrition Plan</strong>. The <strong>Nutrition Read - Client Facing</strong> panel sits directly above the active plan body. Click <strong>Generate &amp; Publish</strong>. The reading:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Reads the latest published Foundational Read for voice and state context (required — the panel will refuse to generate without one).</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Notify Client (2026-06-09)</p>
            <p>Reading-published auto-emails were scrapped 2026-06-09 across Foundational Read, Program Read, and Progress Read. The Body Recode product position is now: <strong>only plan publishes notify the client</strong>. One Notify per training block, one Notify per nutrition plan — no more reading-publish noise. Readings still generate and live in the portal; they just don&apos;t email.</p>
            <p>Once the active nutrition plan has a published Nutrition Read, a <strong>Notify Client</strong> button appears in the plan view header. Click to send the new-plan email to the client and stamp <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">nutrition_plans.published_to_client_at</code>. If the client was already notified for this plan, the button label switches to <strong>Notify Again</strong> with the prior send date shown — useful when a plan revision is significant enough to warrant a second nudge. The Training Program view carries a mirror button stamping <code className="bg-[#EDEDEA] px-1 rounded text-[#0F1115] text-[12.5px]">programs.published_to_client_at</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Five sections</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>01 Why this plan</strong> - Anchors the plan in the body state from the Foundational Read. What we are trying to support with food right now, in the client&apos;s own language.</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Coach Guidance and inline edits</p>
            <p>Same affordances as the Foundational Read and Program Read panels:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Unpublish / Republish</strong> toggle takes the read down from the portal without deleting it. The client view falls back gracefully.</li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Content rules</p>
            <p>Same content rules as the Foundational Read and Program Read, adapted to nutrition: no calorie or macro numbers, no specific food names (food categories allowed), no meal timing prescriptions or fasting protocols, no diagnoses, no causal claims, no em dashes, no exclamation marks. The body is interpreted as coherent, never broken. Conservative resolution overrides optimistic interpretation. Whenever the &quot;not doing yet&quot; section touches on fat loss or weight, the AI must reassure the client that body composition changes typically follow as a downstream consequence of stabilising the underlying system first.</p>

            <Note>The Nutrition Read is per-plan, not per-client. Each new nutrition_plans row gets its own reading. Regenerating a plan clears the prior reading state on the new row and creates a fresh canvas. The Foundational Read is the constant; the Program Read and Nutrition Read evolve alongside each block and plan.</Note>
          </Section>
          ...
          <Section id="business-engine" title="Business Engine - Overview" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Modules</p>
            <div className="grid gap-1.5">
              {[
                ...
                <div key={item.label} className="flex items-start gap-3 bg-[#EDEDEA]/50 rounded-lg px-3 py-2">
                  <span className="text-[#B06E1F] font-semibold text-[12.5px] shrink-0 mt-0.5 w-24">{item.label}</span>
                  <span className="text-[#6E747D] text-[12.5px]">{item.desc}</span>
                </div>
              ))}
            </div>
          </Section>
          ...
          <Section id="ceo-dashboard" title="CEO Dashboard - Company Scorecard" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How the status colours work</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Setting your targets</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The Weekly Pulse ritual</p>
          ...
          <Section id="be-crm" title="23. CRM & Pipeline" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Pipeline Stages</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Contact Detail</p>
          ...
          <Section id="be-bookings" title="24. Bookings" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Availability</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Blocked Times</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What Happens on Zoom Booking</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Face-to-Face Session Booking (from Client Portal)</p>
            <p>Face-to-face clients can reschedule a session directly from their portal. When they book a slot, a <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">client_sessions</code> record is created with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">status = scheduled</code>, and a branded confirmation email goes to both the client and you. Booked slots are blocked and won&apos;t appear for other clients.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Session Reminder Emails</p>
            <p>Every day at 8:00 am Brisbane time, a cron job scans for sessions scheduled in the next 20–28 hours that haven&apos;t had a reminder sent yet. The client receives a branded email with a <strong>Confirm attendance →</strong> button. Clicking that link marks the session as confirmed (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">confirmed_at</code> is set) and notifies you by email. The session then shows a <strong>Confirmed</strong> badge in the portal and on the dashboard client profile. If the session is already confirmed, the link shows a friendly &quot;already confirmed&quot; message instead.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Calendar Auto-Sync (Mac Calendar)</p>
            ...
            <p className="mt-1 font-mono text-[12.5px] text-[#000000] bg-[#FFFFFF] rounded-lg px-4 py-2">webcal://bodyrecode.au/api/calendar/feed?key=CALENDAR_FEED_KEY</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">IG Story Posting Reminders (Mac Calendar)</p>
            ...
            <p className="mt-1 font-mono text-[12.5px] text-[#000000] bg-[#FFFFFF] rounded-lg px-4 py-2">webcal://bodyrecode.au/api/calendar/feed/stories?key=CALENDAR_FEED_KEY</p>
            <p className="mt-2">Use the <strong>same key</strong> as the bookings feed above (just change the path to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/feed/stories</code>). Subscribe the same way (New Calendar Subscription → auto-refresh Every 15 Minutes). Once subscribed it is fully automatic - new stories, copy changes, and the weekly Blueprint beat all flow in with no manual import. <strong>One-time:</strong> if you previously imported a static story-reminders file, delete that calendar first so it does not double up with the live feed.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Manual Bookings</p>
          ...
          <Section id="be-automations" title="25. Automations" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">System Automations</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Manual Triggers</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Custom Workflows</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Triggers</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Step Types</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Building a Workflow</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Scorecard Follow-up Sequence (Custom Workflow)</p>
            <p>The 9-step sequence lives as a custom workflow in the DB. It uses trigger <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">form_submitted</code> with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{ form: 'scorecard' }`}</code>. Emails are personalised using:</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-2">
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{scorecard_score}}`}</code> - e.g. 7</li>
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{scorecard_state}}`}</code> - e.g. Transitioning State</li>
              <li><code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{first_name}}`}</code> - lead&apos;s first name</li>
            </ul>
          ...
          <Section id="be-campaigns" title="26. Campaigns" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Creating a Campaign</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li>Write the body - use <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">{`{{first_name}}`}</code> to personalise</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Sending</p>
          ...
          <Section id="be-funnels" title="27. Funnels" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Creating a Funnel</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What Happens on Submit</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="be-inbox" title="28. Inbox" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What Shows in the Thread</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Sending an Email</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Receiving Replies</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Inbox List</p>
          ...
          <Section id="be-payments" title="29. Payments" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Payment Links</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Products</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Automatic Recording</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Manual Payments</p>
            <p>Use <strong>Record Payment</strong> to log cash, bank transfer, or any payment that didn&apos;t come through Stripe.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Failed Payments</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Sub-pages</p>
          ...
          <Section id="payments-tracker" title="29b. Client Payment Tracker" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">First-time setup (run once)</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Per-client view</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Cross-cut Client Status table</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How the cache stays fresh</p>
            <p>Stripe is the source of truth. The cache (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">client_subscriptions</code> table) is maintained three ways:</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">When Foundational Read won’t auto-detect</p>
            ...
            <p className="text-[12.5px] text-[#9CA2AB] mt-4">Doctrine / spec: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/2026-05-13_PAYMENTS_FOUNDATION.md</code>. Feature registry entry 26.</p>
          </Section>
          ...
          <Section id="be-analytics" title="30. Analytics" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Metrics</p>
            <StatusList items={[
          ...
          <Section id="be-sources" title="31. Lead Sources" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">QR Code URLs</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Scorecard URLs</p>
            ...
            <Note>The leads.source column has a CHECK constraint that only accepts a fixed set of values (quiz, other, gym_floor, instagram, facebook, direct). Any unmapped <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">?source=</code> param falls through to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">source=other</code> with the raw value preserved in source_detail. This was tightened 2026-04-30 after a gym_complementary submission failed. To add a new normalised source, edit <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">SOURCE_MAP</code> in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/app/api/scorecard/submit/route.ts</code>.</Note>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Digital Channel URLs</p>
          ...
          <Section id="partner-room" title="Partner Room - Private Investor / Partner Overview" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to use it</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The one rule</p>
            ...
            <p className="mt-3 text-sm text-[#6E747D]">Guest link format: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">app.bodyrecode.au/room/&#123;token&#125;</code>. Data lives in the <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">partner_rooms</code> table.</p>
          </Section>
          ...
          <Section id="saas-launch" title="SaaS Launch Board - Is Anyone Actually Buying It" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The two boards</p>
            <p><strong>SaaS &rarr; Launch</strong> (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">/dashboard/saas</code>) answers <em>is anybody buying it</em>. <strong>SaaS &rarr; Buildout</strong> answers <em>what has been built</em>. The buildout board has existed since 9 Sep but lived in Settings where nothing linked to it; it moved into the sidebar on 12 Sep. Build status stays on the buildout board and its manifest file stays the source of truth for that. Nothing on the Launch board is typed by hand.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Why every number is live</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How to read it</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The Strenn price test (added 14 Sep 2026)</p>
            <p>The top of the Launch board now shows the price test running at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">bodyrecode.au/founding</code>. A woman answers two minutes of questions, sees her readiness and likely pattern, then sees the new app at $199 a year or $29 a month, and can join a founding list. No payment is taken. The page is hidden from search: send it to people who already know you, with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">?source=</code> on the end (for example <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">?source=email_list</code>) so you can see where each woman came from.</p>
            <p className="mt-2"><strong>The pass mark was set before it ran, and is printed on the board so it cannot move:</strong> of the women who see the price, 1 in 5 or more joining means go ahead; fewer than 1 in 10 means rethink the price or the offer; anything between means keep sending people to it. The board says &ldquo;too early&rdquo; until 30 women have seen the price. Men are counted separately and kept out of the rate. The rate is split by women who train and women who do not, and shows the answers to the price, how soon she wants to start, and whether she wants a coach in her ear.</p>
          ...
          <Section id="be-ads" title="32. Ads" colour="amber">
            <p>Meta ads feed the top of the funnel. Clicks go to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">performance.bodyrecode.au/scorecard</code> where the Meta Pixel (ID <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">972772552072010</code>) fires four events as the prospect moves through the funnel:</p>
            <StatusList items={[
            ...
            <p className="mt-3">The actual Purchase event still needs wiring on bodyrecode.au&apos;s Stripe success page (separate repo) and Schedule on /book confirmation. Until those are wired, conversion attribution stops at InitiateCheckout. All ad-data analysis lives in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/07_ADS</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">File Structure</p>
            <p>All ads analysis lives at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">Dropbox/01_BODY_RECODE/07_ADS/</code></p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Weekly Report - Every Friday</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Export data from Meta Ads Manager - Ad Sets tab - set date range - export CSV or Numbers</li>
              <li>Drop the file into <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">RAW_DATA/</code> before 9am Friday</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Active Campaign Setup</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
              ...
              <li><strong>Destination:</strong> <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">performance.bodyrecode.au/scorecard?source=facebook_ad_[adset]</code></li>
            </ul>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Pixel</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
              <li>Pixel ID: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">972772552072010</code> - named Body Recode in Meta</li>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Scaling Framework</p>
            <ul className="space-y-1.5 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="be-reels" title="32b. Reels (film, ingest, publish)" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">1. Film</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">2. Check the take (reel doctor)</p>
            ...
            <p className="mt-2 text-[12.5px] text-[#6E747D]"><strong>What it cannot do.</strong> It cannot hear tone or warmth, cannot see whether your eyes were in the lens, and cannot tell a confident take from a flat one. The ranking is mechanical - treat it as a shortlist that saves you scrubbing through eight takes, not a verdict. Captions still does eye-contact correction and burned captions better.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">3. Drop</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">4. Ingest</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">5. Publish or schedule</p>
            ...
            <p className="mt-2 text-[12.5px] text-[#6E747D]"><strong>Why it can take a few minutes.</strong> Meta transcodes video asynchronously, unlike images which are ready in seconds. The publisher waits up to five minutes for the container to report FINISHED before publishing. A reel that still has its TO FILM placeholder is refused outright, so a placeholder card can never reach the feed.</p>
          </Section>
          ...
          <Section id="be-content-engine" title="33. Content Engine" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Hooks</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Messages</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">CTAs</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Generate</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">The maths</p>
            <div className="mt-2 bg-[#EDEDEA]/60 rounded-lg p-4 text-[12.5px] text-[#4A4F57] font-mono leading-relaxed">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Outputs</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">AI Reel Generation</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Posting the Reel</p>
            ...
            <p className="mt-4">Reel generation requires four environment variables: <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">ELEVENLABS_API_KEY</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">ELEVENLABS_VOICE_ID</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">HEYGEN_API_KEY</code>, and <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">HEYGEN_AVATAR_ID</code>. If any are missing the button will return an error.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Full Reel Production Flow</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">Step 1 - Build a B-Roll Library (one-time)</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">Step 2 - Generate Talking Head (Content Engine)</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">Step 3 - Post-Production</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">Step 4 - Post</p>
            ...
            <p className="mt-3 text-[12.5px] font-semibold text-[#6E747D]">Complete Pipeline</p>
            <div className="mt-2 bg-[#EDEDEA]/60 rounded-lg p-4 text-[12.5px] text-[#4A4F57] font-mono leading-relaxed">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Card Library Tab</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Card Styles</p>
            <p>The graphic API generates 1080×1080 PNG cards. All styles use the brand dark background (<code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">#FFFFFF</code>). A full visual reference with example images is saved at <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">Dropbox/01_BODY_RECODE/07_MARKETING/04_CONTENT_LIBRARY/card-designs/card-designs-reference.html</code>.</p>
            <p className="text-[12.5px] font-semibold text-[#9CA2AB] mt-3 mb-1">Text Cards</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-semibold text-[#9CA2AB] mt-3 mb-1">Body State Cards</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>body-state</strong> - Left coloured border card. Use <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">accent=red</code> (Depleted), <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">accent=amber</code> (Transitioning), <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">accent=teal</code> (Ready).</li>
            </ul>
            <p className="text-[12.5px] font-semibold text-[#9CA2AB] mt-3 mb-1">Photo Cards (uses kade.jpg)</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-semibold text-[#9CA2AB] mt-3 mb-1">Carousel Cards</p>
            <p className="text-[#6E747D] text-[12.5px] mb-1">All carousel cards share a left teal border stripe for visual consistency when swiped.</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
              <li><strong>carousel-hook</strong> - Slide 1. Big hook headline, optional sub-copy, Swipe indicator.</li>
              <li><strong>carousel-slide</strong> - Interior numbered slides. Use <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">n=2</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">n=3</code> etc. for each slide number.</li>
              <li><strong>carousel-cta</strong> - Final slide. Teal pill CTA driving to scorecard or check-in. Use <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">label=</code> to override CTA button text.</li>
            </ul>
            <p className="text-[12.5px] font-semibold text-[#9CA2AB] mt-3 mb-1">Conversion Cards</p>
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm">
          ...
          <Section id="be-strategy" title="34. Strategy Hub" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Content Calendar</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Native Instagram Publishing (2026-06-30)</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#4A4F57] text-sm mt-1">
              ...
              <li>Posted state persists on the row (<code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">ig_post_id</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">ig_post_url</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">posted_at</code>) so re-clicking shows the live URL instead of re-publishing.</li>
            </ul>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]"><strong>Stories publish only when the row is marked story_auto.</strong> Meta&apos;s API strips link stickers, countdown stickers and polls, and the tap on a sticker is the completion signal that recovers story ranking - so a story carrying one still goes up by hand. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">story_auto</code> marks the plain-image ones that were never going to have a sticker, and those publish themselves like any other post. Two differences from a feed post: a story has no caption, so all the text has to be in the image, and Meta will not accept a scheduled publish time for stories, so our own cron fires them at the moment they should be live rather than handing them over in advance. Everything else on the calendar is tracked the same way.</p>
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Two accounts, from 2026-08-20</p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]"><strong>@body_recode_ and @kade_dunstone_ both publish natively.</strong> The personal brand was the only channel with no automation, so it died whenever Kade got busy — five days quiet in July, then <strong>twelve days from 8 Aug with 73 finished posts sitting behind it</strong>, every one with a caption and a graphic. The morning cadence alert fired for fifteen straight days, so another alert was never the fix.</p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]"><strong>Each account has its own credential pair and there is NO fallback.</strong> If the personal vars are missing, a personal post refuses to publish and says so; it never drops back to the Body Recode token. That prevents Kade&apos;s personal posts appearing on @body_recode_ in front of the client audience, which has no undo. The code can only check the vars <em>exist</em> though — it cannot tell that the wrong Page&apos;s token was pasted in, which is why the setup guide makes you verify <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">GET /&lt;id&gt;?fields=username</code> returns <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">kade_dunstone_</code> before going further.</p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]"><strong>The BR footer is skipped on personal posts.</strong> It reads &quot;More from our founder → @kade_dunstone_&quot;, which is right on the brand account and nonsense on the personal one.</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Measurement · the missing permission</p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]"><strong>Neither token can read insights.</strong> Both were generated with four permissions and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">instagram_manage_insights</code> is not among them, so reach, saves and shares are unreadable on <strong>every post either account has ever published</strong> — 44 on @body_recode_ and counting. Publishing is entirely unaffected; this is a read permission only.</p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]">Fix: regenerate both tokens with that permission added and update the env vars. Then <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">npx tsx --env-file=.env.local scripts/ig-insights.ts</code> reports reach, saves, shares and likes per brand and per format, with top and bottom performers. <strong>Until then every content decision on both accounts is taste, not evidence.</strong></p>
            <p className="text-[12.5px] mt-2 text-[#4A4F57]">Token + IG Business Account ID configured one-time via env vars (Vercel body-recode project only). Token is a long-lived User Access Token with the 4 perms: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">instagram_basic</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">instagram_content_publish</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">pages_show_list</code>, <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">pages_read_engagement</code>. Regenerate via Graph API Explorer every ~60 days. Full setup walkthrough in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/2026-06-30_Instagram_Native_Publishing.md</code>.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The 5 Topics You Own</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Body State Terminology</p>
          ...
          <Section id="be-social-profiles" title="35. Social Profiles" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Instagram - Field by Field</p>
            <div className="space-y-3">

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Name</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">Body Recode</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Username</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">@body_recode_</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Bio - Line 1</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">Performance coaching for people whose bodies stopped responding.</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Bio - Line 2</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">Body state interpretation. Training. Nutrition.</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Bio - Line 3</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">↓ Find out which state you&apos;re in (2 min)</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Link in Bio</span></div>
                <div className="px-4 py-3 font-mono text-sm text-[#0F1115] select-all">performance.bodyrecode.au/scorecard?source=instagram</div>
              </div>

              <div className="bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b border-[#E4E4E0]"><span className="text-[12.5px] font-medium text-[#6E747D]">Account Type</span></div>
                <div className="px-4 py-3 text-sm text-[#0F1115]">Creator or Business - not Personal</div>
              </div>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Tracked Source URLs</p>
            <div className="space-y-2">
              {[
                ...
                <div key={row.source} className="flex items-center gap-3 bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg px-4 py-2.5">
                  <span className="text-[#6E747D] text-sm w-36 shrink-0">{row.source}</span>
                  <span className="text-[#0F1115] font-mono text-[12.5px]">{row.url}</span>
                </div>
              ))}
            </div>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Personal Brand (@kade_dunstone_) — Content Kit + Calendar</p>
            <p>The <strong>Business → Personal Brand → Content Kit</strong> tab documents the visual identity and the 4-week launch plan. Scheduling is <strong>not</strong> separate - the posts live in the one Content Calendar on <strong>Marketing Strategy → Content Calendar</strong>, filtered by <strong>brand = Personal Brand</strong>, alongside Body Recode, AI Co-Founder and The Collective. The 16 launch posts (4/week Mon/Wed/Fri/Sun, drawn from the Script Library) are seeded via <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">sql/2026-06-04_seed_personal_brand_calendar_posts.sql</code>.</p>
            <p className="mt-2"><strong>Brand colour = Clay.</strong> One signature colour across the whole feed - paper tint #FDF8F1, ink #1A1E26, accent/solid #8F2D2D - deliberately distinct from Body Recode (Signal Blue), AI Co-Founder (indigo) and The Collective (sky blue). Pillars are told apart by the eyebrow label, not colour.</p>
            <p className="mt-2"><strong>Card system</strong> (all via the graphic endpoint, clay is the default theme): <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">style=personal</code> = editorial text card (Source Serif 4 headline, clay eyebrow + rule, @kade_dunstone_ wordmark, no logo); add <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">num=</code> + <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">cue=swipe</code> for carousel slides and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">theme=clay-solid</code> for the solid close slide. <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">style=personal-photo</code> = photo card with <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">layout=top|overlay|split|inset</code> and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">photo=1-8</code>. Square + story. ~1 in 4 posts carries a photo; framework posts are carousels; the rest are clay cards. A carousel row stores comma-separated slide URLs in its <em>graphic</em> field.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">LinkedIn (Body Recode Channel)</p>
            ...
            <p className="mt-2">Full strategy at <strong>Business → Marketing Strategy → LinkedIn tab</strong>. 12-week pipeline document at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/LINKEDIN-BODY-RECODE-12-WEEK-PIPELINE.md</code>.</p>
            <p className="mt-2">Leads land tagged <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">source=linkedin</code> in the CRM, filterable separately from Instagram on the leads page. Realistic ramp to first booking is 6-10 weeks - slow-burn channel, not primary conversion engine.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Highlight Covers</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Content Pillars</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Posting Cadence</p>
            <div className="space-y-1">
              {[
                ...
                <div key={row.day} className="flex items-center gap-3 bg-[#EDEDEA] border border-[#E4E4E0] rounded-lg px-4 py-2.5">
                  <span className="text-[#6E747D] text-sm w-24 shrink-0">{row.day}</span>
                  <span className="text-[#0F1115] text-sm font-medium w-40 shrink-0">{row.type}</span>
                  <span className="text-[#6E747D] text-sm">{row.desc}</span>
                </div>
              ))}
            </div>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Launch Sequence</p>
            <ol className="space-y-1.5 list-decimal list-inside text-[#4A4F57] text-sm">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Terminology Rule</p>
            <p>Public content and the scorecard use: <strong className="text-[#0F1115]">Depleted / Transitioning / Ready</strong></p>
            <p className="mt-1">The CFFS coaching system uses: <strong className="text-[#0F1115]">Remediation / Optimisation / Post-Optimisation</strong></p>
          ...
          <Section id="be-website" title="36. Website Analytics" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Stats</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Daily Chart</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Time Range</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Live Pages</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Data Accuracy Note</p>
          ...
          <Section id="ch-overview" title="Challenge Overview" colour="teal">
            <p className="rounded-lg border border-[#E4E4E0] bg-[#FAFAF8] px-3 py-2 text-[12.5px] leading-relaxed"><strong>Body Decode paused, 17 September 2026.</strong> The five daily videos are being finished, so nobody new can enrol. The signup form at /decode now takes her details for the waitlist instead, the scorecard emails, the bio link and the Performance scorecard all say coming soon (never reopening, so it never reads as something she missed), and Decode stays her recommended next step. Names land in <strong>Business &rarr; Product Waitlist</strong> under Body Decode, and she gets a short waitlist email. The two people already part-way through keep their portals. Opening it is one setting, <code>NEXT_PUBLIC_DECODE_LIVE</code> set to true, no code change.</p>
            <p className="mt-3">The 14-Day Body Decode Challenge is a standalone consumer product that runs entirely independently of the Performance Coaching platform. Participants sign up at <strong>bodyrecode.au/challenge</strong>, receive a personal portal link, and move through a 14-day structured reset with daily coaching, training, nutrition, and automated SMS support.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Model</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Purpose in the funnel</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Key URLs</p>
            <StatusList items={[
          ...
          <Section id="ch-landing" title="Landing Page" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Sections on the page</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Signup form behaviour</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Pre-launch waitlist mode (2026-06-12)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Body Recode Collective EOI pair (2026-07-08, fires immediately on Fit Scorecard submit)</p>
            <p>New expression of interest via the Fit Scorecard at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">bodyrecode.au/collective/apply</code> triggers a synchronous send-pair from <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">POST /api/collective/submit</code> after the row insert.</p>
            ...
            <p className="mt-2"><strong>Distinct Collective sub-brand:</strong> warm-charcoal (#1A1E26) accent, editorial "The Collective" wordmark, brand-first signature (no Kade personal photo) — signals the coach-facing B2B programme identity vs consumer BR emails&apos; Signal Blue + Kade-founder-byline shape. Composed from Collective-brand primitives in <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/collective-email-shell.ts</code> wrapping the same shared <code>darkEmailShell</code>.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Waitlist welcome + coach-notify pair (2026-07-08, fires immediately on join)</p>
            <p>New signup to <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">product_waitlist</code> for <strong>challenge</strong> / <strong>blueprint</strong> / <strong>membership</strong> triggers a synchronous send-pair from <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">POST /api/product-waitlist</code> before the response returns.</p>
            ...
            <p className="mt-2"><strong>Related file:</strong> <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/product-waitlist-welcome-email.ts</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Founding list confirmation (2026-09-14, the Strenn price test)</p>
            <p>Joining the founding list at <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">bodyrecode.au/founding</code> sends one branded confirmation from <strong>{coach().email}</strong>, BCC&apos;d to you. It confirms the founding price is kept for as long as she stays subscribed and that she will hear when the app opens. It does not name the app or give a date. Sent once; a retake or a second click does not resend. These women are stored separately from leads, so none of them receive the scorecard emails.</p>
            <p className="mt-2"><strong>Related file:</strong> <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">src/lib/rey-founding-email.ts</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Launch-day waitlist email broadcast (2026-06-29, fires Mon 13 Jul 2026)</p>
            <p>Single-event broadcast that converts the accumulated <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">product_waitlist</code> rows on launch day. Same hour <strong>NEXT_PUBLIC_CHALLENGE_LIVE</strong> flips to <strong>&apos;true&apos;</strong>, run the broadcast script: <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">cd ~/body-recode-mvp &amp;&amp; set -a &amp;&amp; source .env.local &amp;&amp; set +a &amp;&amp; npx tsx scripts/launch-day-waitlist-email.ts --live</code>.</p>
          ...
          <Section id="ch-enrollment" title="Enrollment Flow" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Duplicate enrollment handling</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Token</p>
          ...
          <Section id="ch-portal" title="Participant Portal" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What the portal shows</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Day calculation</p>
            <p>Day is calculated server-side on every page load as <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">Math.floor((now - enrolledAt) / 86400000) + 1</code>, clamped between 1 and 14. Day 1 is the day of enrollment. Day 2 starts 24 hours after enrollment.</p>
          ...
          <Section id="ch-day-zero" title="Day 0 Body Decode Intake" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Why it exists</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Skip logic for scorecard signups</p>
            <p>Critical UX: scorecard signups must NOT see the intake form again. The portal checks <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">leads.scorecard_profile</code> on load — if populated, the intake auto-skips and the enroller goes straight to PAR-Q. So the Day 0 intake is exclusively for non-scorecard enrollers.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">State-routed result card</p>
            ...
            <p className="mt-2">Continue Challenge always stays the default action — honours the free 14-day Challenge promise the enroller signed up for. Ascension is the OPTION, not a redirect. CTAs route to <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/blueprint?from=challenge_day_zero&state=transitioning</code> and <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/membership?from=challenge_day_zero&state=ready</code> for attribution.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How data persists</p>
            <p>POST <strong>/api/challenge/day-zero-intake</strong> writes to the SAME columns the public scorecard writes to: <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">leads.scorecard_score</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">scorecard_body_state</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">scorecard_profile</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">scorecard_section_scores</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">biological_sex</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">age_band</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">fat_storage</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">cycle_status</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">approach_response</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">investment_readiness</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">lead_quality</code>. Uses the shared <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">typeFatMapProfile()</code> from <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">src/lib/fat-map-profile.ts</code>. Same body-state thresholds as scorecard (≤8 Depleted, ≤11 Transitioning, ≥12 Ready). Stamps <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">challenge_enrollments.body_decode_intake_completed_at</code> so the portal advances past the gate, and logs a <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">day_zero_intake_completed</code> lead event.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Source attribution</p>
            <p>Whether a lead&apos;s Fat Map zone was classified via the scorecard or via Day 0 intake is derivable from <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">challenge_enrollments.body_decode_intake_completed_at</code> — non-null means the data came from inside the portal. No separate scorecard_source column needed.</p>
            ...
            <Note><strong>It changes the typing too, not just the wording.</strong> Answering &quot;moved to my middle&quot; or &quot;stayed on my hips&quot; types her Estrogen-Shift at high confidence, because she said it rather than us guessing. And &quot;always been my middle&quot; now blocks the Estrogen-Shift route entirely and types her Stress-Stored, because in Estrogen-Shift the middle fills faster than the hips and thighs while Stress-Stored was central from the start. (Reworded 11 Sep 2026: through the transition itself both compartments are still gaining, so nothing actually leaves the lower body until after the final period. The typing logic is unchanged.)</Note>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Fat Map v2.0 alignment (6 Aug 2026)</p>
            <p>Three fixes landed together, all enforcing <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">Fat_Map_Definitions_LOCKED.md</code> v2.0.</p>
            <ul className="list-disc ml-5 space-y-1 mt-2">
              ...
              <li><strong>The Day 7 Check-In gained a phase-2 route.</strong> The oestrogen option previously ended &quot;Storage on hips and thighs&quot;, which is phase 1 only, so phase-2 women picked the post-meal sluggishness option and typed as Insulin-Drift. That option now covers both phases, and a third signal question (<code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">sq3</code>) asks the direction-of-travel discriminator. It is shown <em>only</em> to women in the menopausal band, via <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">isMenopausalBand()</code> in <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">src/lib/pattern-mapping.ts</code>. Only the &quot;moved toward my middle&quot; answer overrides the sq2 result.</li>
              <li><strong>Brief regeneration was silently mistyping leads.</strong> <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/api/admin/regenerate-pre-call-briefs</code> never passed biological_sex, age_band, fat_storage or cycle_status, so every regenerated brief was typed as if the lead had answered nothing. Fixed.</li>
            </ul>
          ...
          <Section id="ch-forms" title="PAR-Q and Health Declaration" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">PAR-Q</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Health Declaration</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Reminders (added 2026-08-14)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">How completions are saved</p>
            <p>Both forms call <strong>POST /api/challenge/forms</strong> with the token and form type. The API saves a timestamp to <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">parq_completed_at</code> or <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">health_dec_completed_at</code> on the enrollment. PAR-Q answers are also saved as JSON to <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">parq_responses</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">UX flow — merged into ONE form (2026-08-14)</p>
            ...
            <p>Anyone part-way through the old two-step flow still sees only the piece they owe — <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">ParqForm</code> and <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">HealthDecForm</code> are both retained for that case. On completion the section is replaced by a cleared confirmation banner and the Training and Nutrition cards unlock without a page reload.</p>
          ...
          <Section id="ch-leaks" title="Where the Challenge actually leaks" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Three fixes shipped 14 Aug</p>
            ...
            <p><strong>3. Portal visits are now logged.</strong> They were logged nowhere at all. There is a <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_day</code> column but the portal recalculates the day from <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">enrolled_at</code> and never writes to it, so it said nothing about whether anyone turned up. That made the largest leak in the funnel invisible: we could not tell whether people went quiet on day 2 or day 9, and those need completely different fixes. <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">logPortalVisit()</code> writes one <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">challenge_portal_opened</code> lead event per enrollment per day. Read it with <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">npx tsx --env-file=.env.local scripts/challenge-attendance.ts</code>, which charts attendance across the 14 days and names the biggest single day-to-day drop.</p>
          ...
          <Section id="ch-resources" title="Training and Nutrition Pages" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Training Plan - /challenge/[token]/training</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Nutrition Guide - /challenge/[token]/nutrition</p>
            <StatusList items={[
          ...
          <Section id="ch-quiz" title="Body Decode Check-In" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Structure</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The four biological patterns</p>
            <StatusList items={[
              { label: 'Stress-Stored (a)', desc: 'Cortisol and adrenaline driving storage around the midsection. Maps to Fat Map MZ1. Colour: red #8F2D2D.' },
              { label: 'Insulin-Drift (b)', desc: 'DB slug: metabolic-drift. Insulin staying elevated too long, blood sugar instability, storage across mid-back, lower back and love handles plus deep abdominal (front spared), carb cravings, post-meal fatigue. Male-leaning per doctrine. Colour: amber #B06E1F.' },
              { label: 'Estrogen-Shift (c)', desc: 'DB slug: hormonal-shift. Oestrogen-driven conservation state, hip and thigh storage, water retention, cycle irregularity, mood variability. Female-only per doctrine. Maps to Fat Map MZ3. Colour: purple #4A4F57.' },
              { label: 'Androgen-Decline (d)', desc: 'DB slug: system-overload. Testosterone signalling decline, reduced muscle tone, reduced drive, capacity slipping despite consistent effort. Male-only per doctrine. Maps to Fat Map MZ4. Colour: teal #0F1115.' },
            ]} />

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">On submission</p>
            <p>Pattern is determined client-side from Q2 answer + gender (a/b/c/d gender-keyed to a slug via <strong>src/lib/pattern-mapping.ts</strong>). Progress score counts markers answered as &quot;better&quot;. The result key, all answers, and a timestamp are saved via <strong>POST /api/challenge/quiz</strong>. <strong>The API branches on currentDay:</strong> pre-Day-14 it sends the Day 7 Progress email (no pattern, no Blueprint CTA - just progress score + per-marker breakdown + Week 2 guidance + Day 14 teaser). Day-14+ (late-takers) it sends the Day 14 Body Decode Report email immediately. <strong>The Day 14 email is pattern-focused, NOT a progress recap.</strong> Single bridge callback line references the Day 7 score, then five pattern cards: pattern hero + What this pattern means + Where this shows up + What this is NOT (anti-shame misreads) + Your three pattern-specific actions + Blueprint ascension. Email composition lives in shared builders at <strong>src/lib/challenge-checkin-emails.ts</strong>. Pattern content (whatItMeans/whereItShows/whatItIsNot) lives in <strong>src/lib/checkin-patterns.ts</strong>. The Blueprint CTA on the Day 14 Body Decode Report links to <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/blueprint?source=challenge_day14_report</code>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Return visits</p>
            <p>The <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/check-in</code> page fetches <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">quiz_result</code>, <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">quiz_answers</code> and currentDay. Three states: (1) no result + currentDay {'>='} 7: form shows. (2) result exists + currentDay {'<'} 14: <strong>Day 7 in-portal view</strong> shows - progress score card + per-marker breakdown + Week 2 guidance + Day 14 teaser. Same content as the Day 7 Progress email but rendered as a substantive page, not a wait-marker. <strong>No pattern reveal, no Blueprint CTA.</strong> (3) result exists + currentDay {'>='} 14: full Body Decode Report shows - bridge callback line + pattern hero + What this means + Where it shows up + What this is NOT + actions + Blueprint CTA. Mirrors the Day 14 email exactly. Discoverable via the new <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/day-14</code> framing page (linked from the portal home Body Decode Report card), or directly via <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">/check-in</code>.</p>
          ...
          <Section id="ch-automation" title="Automation Sequence" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Inline (synchronous on signup)</p>
            ...
            <p className="text-[12.5px] italic text-[#6E747D] mt-2">Both run in parallel via Promise.all and each logs a lead_events row (challenge_welcome_sent / challenge_coach_notified) with the Resend message id, so the lead timeline shows whether each email actually left the platform.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">challengeSequenceFunction - email sequence (Inngest)</p>
            <div className="space-y-2 mt-1">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">challengeCheckinPromptFunction - Body Decode Check-In prompt (Inngest)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">challengeIntakeReminderFunction - Day 0 scorecard reminder (Inngest)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Environment variables required</p>
            <StatusList items={[
          ...
          <Section id="ch-sms" title="SMS Coaching Sequence" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Timing structure</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Per-day messages</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Template variables</p>
            <p>Templates use <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">%FIRST%</code> and <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">%URL%</code> placeholders. The <code className="bg-[#EDEDEA] px-1 rounded text-[#000000] text-[12.5px]">renderSms()</code> helper substitutes them at send time. Source of truth: <strong>SMS_MORNING</strong> + <strong>SMS_AFTERNOON_BOOST</strong> constants in <strong>src/lib/inngest-functions.ts</strong>.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Retired</p>
          ...
          <Section id="ch-database" title="Database and Supabase" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">challenge_enrollments columns</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Required SQL migrations</p>
            ...
            <pre className="text-[12.5px] bg-[#EDEDEA] text-[#000000] rounded-lg p-4 mt-2 overflow-x-auto whitespace-pre-wrap">{`ALTER TABLE challenge_enrollments
  ...
  ADD COLUMN IF NOT EXISTS quiz_answers jsonb;`}</pre>
          ...
          <Section id="ch-prelaunch" title="Pre-Launch Checklist" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Recording</p>
            <div className="space-y-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Environment Variables (Vercel)</p>
            <div className="space-y-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Supabase</p>
            <div className="space-y-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">End-to-end test</p>
            <div className="space-y-2">
          ...
          <Section id="bp-sales" title="Sales Page" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Checkout form</p>
          ...
          <Section id="bp-purchase" title="Purchase Flow" colour="teal">
            <p>When Stripe fires <strong>checkout.session.completed</strong> with <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">metadata.type === &apos;blueprint_purchase&apos;</code>, the webhook runs the following steps:</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Pattern assessment gate</p>
          ...
          <Section id="bp-portal" title="Member Portal" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Tab overview</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Conditional cards on Home tab</p>
            <StatusList items={[
          ...
          <Section id="bp-patterns" title="Biological Patterns" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Training sessions</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Pattern-specific rules (key differences)</p>
            <StatusList items={[
          ...
          <Section id="bp-checkin" title="Weekly Check-In" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">The 8 markers</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">API</p>
            <StatusList items={[
          ...
          <Section id="bp-automation" title="Automation and Emails" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">/api/cron/funnel-week-advance (primary)</p>
            <p>Daily cron at 7am Brisbane. Recomputes the week every enrollment is owed straight from the purchase date - <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">floor((now - purchase_date) / 7 days) + 1</code> - and advances <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_week</code> to it, sending the check-in prompt email on that transition. It covers Blueprint, Membership and Extension. Because the week is derived rather than counted, a missed or failed day catches up the next morning and the schedule cannot drift.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">blueprintWeekAdvanceFunction (secondary)</p>
            <p>Sleeps 7 days then advances <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_week</code> from 1 to 2, sleeps again, advances to 3, and so on up to week 6, sending the same prompt email plus a reminder if the check-in is still outstanding 2 days later. Its advance is monotonic, so whichever mechanism reaches a week first wins and neither can move a client backwards.</p>

            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Why there are two</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Check-in email cadence (per week)</p>
            <div className="space-y-1 mt-2">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">blueprintEmailSequenceFunction</p>
          ...
          <Section id="bp-database" title="Database" colour="teal">
            <p className="text-[12.5px] font-medium text-[#6E747D] mb-2">blueprint_enrollments</p>
            <StatusList items={[
              { label: 'id', desc: 'UUID primary key' },
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">blueprint_checkins</p>
            <StatusList items={[
          ...
          <Section id="mb-overview" title="Membership Overview" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">What members get</p>
            <StatusList items={[
          ...
          <Section id="mb-sales" title="Sales Page" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Blueprint integration</p>
          ...
          <Section id="mb-purchase" title="Purchase Flow" colour="teal">
            <p>When Stripe fires <strong>checkout.session.completed</strong> with <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">metadata.type === &apos;membership_purchase&apos;</code>, the webhook runs the following steps:</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Ascension from Blueprint</p>
          ...
          <Section id="mb-blocks" title="Block Structure" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Block progression</p>
            <StatusList items={[
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Content structure</p>
          ...
          <Section id="mb-checkin" title="Check-In and Trends" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Trends dashboard</p>
          ...
          <Section id="mb-automation" title="Automation" colour="teal">
            <p className="text-[12.5px] font-medium text-[#6E747D] mb-2">membershipWeekAdvanceFunction</p>
            <p>Triggered by the <strong>membership/enrolled</strong> Inngest event. Sleeps 7 days then advances <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_week</code> within the current block. On each advance it sends a check-in prompt email. If no check-in is submitted within 2 days, a reminder fires. After week 6, advances <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_block</code> to the next block and resets <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">current_week</code> to 1. Checks <code className="text-[#0F1115] text-[12.5px] bg-[#EDEDEA] px-1 py-0.5 rounded">cancelled_at</code> before each step.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Block advance logic</p>
            <div className="space-y-1 mt-2">
          ...
          <Section id="mb-database" title="Database" colour="teal">
            <p className="text-[12.5px] font-medium text-[#6E747D] mb-2">membership_enrollments</p>
            <StatusList items={[
              { label: 'id', desc: 'UUID primary key' },
              { label: 'token', desc: 'Unique 64-char hex token. Used in all portal URLs.' },
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">membership_checkins</p>
            <StatusList items={[
          ...
          <Section id="mb-library" title="Library and State Field Guides" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Token routing</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">PDF reader</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Adding a new asset</p>
          ...
          <Section id="mb-bolt-ons" title="Bolt-on Store and Protocol Packs" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Member entry points</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Library gating (important)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">AI Deep-Dives — instant_engine fulfilment (Phase C.9)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Store index</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Per-pack ad page</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Checkout and delivery</p>
            ...
            <p className="text-[12.5px] font-medium text-[#6E747D] mt-4 mb-2">Adding a new pack</p>
            <StatusList items={[
...
function Section({ id, title, colour, children }: { id: string; title: string; colour: 'teal' | 'amber' | 'violet'; children: React.ReactNode }) {
  const accent = colour === 'amber' ? '#B06E1F' : colour === 'violet' ? '#9CA2AB' : '#0F1115'
  return (
    <div id={id} className="br-card overflow-hidden scroll-mt-8">
      <div className="flex items-center gap-2.5 px-6 py-4 border-b border-[#E4E4E0]">
        <span
...
function ChecklistItem({ text }: { text: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-4 h-4 rounded border border-[#DCDCD7] shrink-0 mt-0.5" />
      <p className="text-[#4A4F57] text-sm leading-relaxed">{text}</p>
    </div>
  )
}
...
function Training({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="bg-violet-50 border border-violet-400/20 rounded-lg px-4 py-3 space-y-1">
      ...
      <div className="text-[12.5px] text-[#4A4F57] leading-relaxed space-y-1">
        {children}
      </div>
    </div>
  )
...
function StatusList({ items }: { items: { label: string; desc: string }[] }) {
  return (
    <div className="grid gap-1.5">
      {items.map(item => (
        <div key={item.label} className="flex items-start gap-3 bg-[#EDEDEA]/50 rounded-lg px-3 py-2">
          <span className="text-[#0F1115] font-semibold text-[12.5px] shrink-0 mt-0.5">{item.label}</span>
          <span className="text-[#6E747D] text-[12.5px]">{item.desc}</span>
        </div>
      ))}
    </div>
...
function FlowRow({ trigger, from, to, auto }: { trigger: string; from: string; to: string; auto: boolean }) {
  return (
    <div className="flex items-start gap-3 bg-[#EDEDEA]/50 rounded-lg px-3 py-2.5">
      <span className={`text-xs font-bold shrink-0 mt-0.5 w-16 ${auto ? 'text-[#0F1115]' : 'text-[#B06E1F]'}`}>
        {auto ? 'AUTO' : 'MANUAL'}
      </span>
      <div className="flex-1 min-w-0">
        <p className="text-[12.5px] text-[#4A4F57]">{trigger}</p>
        {from !== '-' && (
          <p className="text-[12.5px] text-[#9CA2AB] mt-0.5">
            <span className="text-[#6E747D]">{from}</span>
            <span className="mx-1.5">→</span>
            <span className="text-[#0F1115] font-medium">{to}</span>
          </p>
        )}
      </div>
    </div>
...
function SeqRow({ day, label }: { day: string; label: string }) {
  return (
    <div className="flex items-start gap-3 bg-[#EDEDEA]/40 rounded-lg px-3 py-2">
      <span className="text-[12.5px] font-semibold text-[#0F1115] shrink-0 w-20">{day}</span>
      <span className="text-[12.5px] text-[#4A4F57]">{label}</span>
    </div>
  )
}
