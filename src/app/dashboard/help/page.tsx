      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="zoom-1" title="2. Zoom - Call Companion" colour="teal">
            ...
            <p className="mt-2"><strong>Rebuilt 12 Aug 2026.</strong> The old version had four stages split into Listen and Pitch halves, plus an objection library, a language library and a full how-it-works explainer inside it. It is now a single scroll shaped like the public how-it-works page: a numbered spine, one stage at a time, nothing competing for attention.</p>
            <ol className="space-y-1.5 list-decimal list-inside text-[#3A3A3A] text-sm mt-2">
              <li><strong>Set the agenda, then listen</strong> - the opening script verbatim, then four questions to ask. If the lead has scope flags, working through them is added here.</li>
              <li><strong>What they already told you</strong> - their pre-call form answers verbatim. Only appears if they completed it.</li>
              <li><strong>Walk them through the read</strong> - the lead-with line, the mechanism, the state, and the pattern with the right amount of confidence attached.</li>
              <li><strong>What coaching actually is</strong> - the bridge from their own words, then the four things that make up the system.</li>
              <li><strong>Where they go next</strong> - the offer mapped to their state, with a hard stop on pitching 1:1 to anyone who answered &quot;just exploring&quot;, plus the objections most likely for their state.</li>
              <li><strong>Close and hand off</strong> - what to give them regardless of outcome, and the closing line.</li>
            </ol>
            <p className="mt-2">A call timer runs in the header, notes open in a side drawer and save to the lead, and the outcome buttons at the bottom set the status and fire the declined follow-up when you mark someone Out.</p>
            <Note><strong>Same source as the brief.</strong> Every stage is generated by the same builder that produces the written pre-call brief, so the screen you read during the call cannot drift from the one you read before it. If the lead has scope flags, they render above stage one, exactly as they do in the brief.</Note>
