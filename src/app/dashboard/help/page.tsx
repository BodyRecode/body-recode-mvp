      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="client-portal" title="8. Client Portal" colour="teal">
            ...
            <Note>This is deliberately not a live chat. There is no typing indicator, no read receipt shown to the client, and no push notification. It is an async coaching thread - set the expectation with clients that you reply within your normal working rhythm, and keep WhatsApp as the urgent channel.</Note>
