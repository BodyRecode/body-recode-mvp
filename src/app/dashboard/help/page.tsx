      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="client-onboarding" title="9. Client Onboarding" colour="teal">
            ...
            <p className="mt-3"><strong>What the client sees:</strong> a single-page form at <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">/intake-supplement/&#123;token&#125;</code> with up to two blocks, only the ones they are missing: the intake&apos;s Hormonal Status questions (same wording, same show-only-when-it-applies rules), and medications + 8 dietary/consumption fields (restrictions, preferences, typical day, meals per day, fluids, caffeine, alcohol, eating environment). About a minute for hormonal only, ~4 minutes for both.</p>
            <p><strong>What submit does:</strong> works out again on the server which blocks the client was shown (a block they never saw is never written), saves hormonal answers to the most recent intake row, raises the same Needs attention alerts as the intake (pregnant now, or non-prescribed testosterone or anabolic use), updates the most recent intake row with the dietary fields, writes medications to <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">clients.medications</code>, marks the invitation complete, sends Kade a coach notification email, and stops there. <strong>The CFFS is NOT auto-regenerated</strong> (changed 2026-06-21, mirrors the Medications + Dietary editors). The Foundational Synthesis panel on the client profile renders an amber &quot;Supplementary newer than CFFS&quot; banner with a Regenerate button when <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">intake_invitations.completed_at &gt; cffs.generated_at</code>; the section also auto-opens and the section header shows a &quot;Supplementary newer &mdash; regenerate&quot; attention pill. Coach reviews the new dietary + medication context, then clicks Regenerate when ready.</p>
          ...
          <Section id="foundational-reading" title="10b. Foundational Read - Client Facing" colour="teal">
            ...
            <Training title="Prompt safety rails">
              <p>The read prompt inherits the CFFS doctrine: pattern-based interpretation, conservative under uncertainty, no prescriptions, no diagnostic labels, no causal claims. It also explicitly forbids motivational language, em dashes, and exclamation marks. The prompt is in <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">src/lib/client-reading-prompt.ts</code>.</p>
          ...
          <Section id="medications-analysis" title="10c. Medications Analysis + Reading" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-1">Client view: Medications Read</p>
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Writing instructions for a single block (added 2026-09-08)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Revising a plan versus regenerating it (added 2026-09-08)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Hormone results and the monthly cycle (added 2026-09-08)</p>
            ...
            <p>If you add or correct a period date on a panel that has already been read, run <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">scripts/backfill-phase-bands.ts</code> to bring the stored results into line. It shows you what would change before it writes anything.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The recovery library, corrected (20 September 2026, research pass R2)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The intake got a health screen, and an honest time (20 September 2026)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Iron: the engine now refuses to read a pattern until she has been seen (20 September 2026, research pass I1)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">What actually builds bone, and the hole we made ourselves (20 September 2026, research pass B1)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The engine will not cut her food while this is unchecked (20 September 2026, research pass T1)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">There is a database backup now, and there was not one before (20 September 2026)</p>
            ...
            <p><strong>Run <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">npm run backup</code></strong> and it writes every row of every table to Dropbox, under 00_Project_HQ &gt; 09_Archive_and_Backups &gt; database, in a folder stamped with the date and time. The first run took 116 tables and 5,386 rows. It needs no new software. Then <strong><code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">npm run backup:verify</code></strong> proves it: every live table present, every file holding what it claims, rows deep rather than empty shells. It prints BACKUP VERIFIED or it refuses.</p>
            ...
            <p><strong>The files are covered too, since 20 September.</strong> Run <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">npm run backup:files</code> and it downloads every progress photograph, blood panel document and clearance letter to Dropbox beside the database backup, then <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">npm run backup:files:verify</code> proves each one is present, the right size and not an empty stub. The first run took 96 files. That half matters more than it sounds: a database row can often be reconstructed from somewhere, but a photograph a client took in her bathroom in week one cannot be retaken in week one. Public marketing assets are skipped by default because they are reproducible and big enough that including them would stop anyone running this.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">You now find out when a generation fails for someone else (19 September 2026)</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Adding a coach, and a coach bringing their clients (19 September 2026)</p>
            ...
            <p>Both are proven by tests rather than by hand: <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">scripts/test-coach-invitation.ts</code> runs the whole invitation through the real database and deletes everything it made, and <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">scripts/test-bulk-import-parse.ts</code> covers ten paste shapes.</p>

            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The training doctrine rules, decided (19 September 2026)</p>
            ...
            <p>The measurement is repeatable: <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">scripts/audit-program-doctrine-live.ts</code> re-runs it over every block, and the rule tests are at 14 cases.</p>

            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The safety gates are now enforced, not requested (19 September 2026)</p>
            ...
            <p><strong>The check is client-specific, which is the point.</strong> &quot;Use a lite salt on your eggs&quot; passes for most people and fails for someone on spironolactone. A litre target passes for most people and fails for someone on an antidepressant of the SSRI type. A check that fired on everyone would be switched off inside a week, so <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">scripts/test-safety-gates.ts</code> tests both directions: 23 cases, half of them proving the same sentence passes for a client the rule does not cover. It prints SAFETY GATES HOLD.</p>
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Referral list: stop the advice and refer</p>
          ...
          <Section id="platform-buildout" title="17e. The Build board, and the two boards it replaced" colour="teal">
            ...
            <p className="text-[#43474F] text-sm">Re-ordered 20 Sep 2026 to match the decision that the coach platform ships first. <strong>Strenn is a working name</strong>, chosen 14 Sep after Rey was checked and dropped, held until an attorney clearance comes back. Older documents still say Rey and mean the same product.</p>
            <ul className="space-y-1 list-disc list-inside text-[#43474F] text-sm">
          ...
          <Section id="training-program" title="20. Training Program - PTS (Performance Training System)" colour="teal">
            <p className="mt-2"><strong>Which week of the block it is (fixed 21 Sep 2026).</strong> Block weeks now run <strong>Monday to Sunday</strong>, anchored to the Monday of the week the block started, so they match the calendar week you and the client both mean. Before this they ran from whichever day the block was generated: two blocks made on a Tuesday meant Monday was the last day of the old week, so the log page showed a week that was already fully logged and today&apos;s session could not be recorded. Earlier versions of the same fault rolled the week at the activation <em>time</em> of day, and refused every log once a block passed its end date. <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">npm run test:block-week</code> covers all three.</p>
          ...
          <Section id="program-reading" title="20b. Program Read - Client Facing" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">How to publish a Program Read</p>
          ...
          <Section id="trajectory-reading" title="20c. Progress Read - Client Facing" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">How to publish a Progress Read</p>
            ...
            <ul className="space-y-1 list-disc list-inside text-[#43474F] text-sm">
              ...
              <li><strong>Publish &amp; notify</strong> surfaces the read at <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">/portal/[token]/program</code> and, the first time this block is published, emails the client (&ldquo;your Progress Read is ready&rdquo;). Republishing never re-emails.</li>
            ...
            <Note><strong>Notify Client (restored 2026-06-22).</strong> Publish to portal and notification email are now two separate clicks, mirroring the Program / Nutrition Notify Client pattern. <strong>Publish</strong> surfaces the read on the client portal; once published, a <strong>Notify Client</strong> button appears for the explicit send. Email stamps <code className="bg-[#EFF1F4] px-1 rounded text-[#1B6DFC] text-[12.5px]">programs.trajectory_reading_email_sent_at</code> and the button label flips to <strong>Notify Again</strong>. The earlier 2026-06-09 decision to drop the auto-email was kept in spirit (publish doesn&apos;t auto-fire), but block-end readings are their own reflection moment and need their own coach-gated notify path rather than waiting for the next program publish to be the client touchpoint.</Note>
          ...
          <Section id="nutrition-reading" title="22b. Nutrition Read - Client Facing" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">How to publish a Nutrition Read</p>
          ...
          <Section id="saas-launch" title="SaaS Launch Board - Is Anyone Actually Buying It" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The Strenn price test (added 14 Sep 2026)</p>
            <p>The top of the Launch board now shows the price test running at <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">bodyrecode.au/founding</code>. A woman answers two minutes of questions, sees her readiness and likely pattern, then sees the new app at $199 a year or $29 a month, and can join a founding list. No payment is taken. The page is hidden from search: send it to people who already know you, with <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">?source=</code> on the end (for example <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">?source=email_list</code>) so you can see where each woman came from.</p>
          ...
          <Section id="ch-landing" title="Landing Page" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Founding list confirmation (2026-09-14, the Strenn price test)</p>
            <p>Joining the founding list at <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">bodyrecode.au/founding</code> sends one branded confirmation from <strong>{coach().email}</strong>, BCC&apos;d to you. It confirms the founding price is kept for as long as she stays subscribed and that she will hear when the app opens. It does not name the app or give a date. Sent once; a retake or a second click does not resend. These women are stored separately from leads, so none of them receive the scorecard emails.</p>
            <p className="mt-2"><strong>Related file:</strong> <code className="bg-[#EFF1F4] px-1 rounded text-[#1056D6] text-[12.5px]">src/lib/rey-founding-email.ts</code>.</p>
