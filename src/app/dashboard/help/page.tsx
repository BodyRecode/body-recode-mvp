      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="client-portal" title="8. Client Portal" colour="teal">
            ...
            <p>Your side lives at <strong>/dashboard/messages</strong> (Clients → Messages). One card per client, newest activity first, with anyone waiting on you sorted to the top and flagged <strong>Awaiting reply</strong>. Type in the box at the bottom of their card and hit Send reply.</p>
            ...
            <Note>This is deliberately not a live chat. There is no typing indicator, no read receipt shown to the client, and no push notification. It is an async coaching thread - set the expectation with clients that you reply within your normal working rhythm, and keep WhatsApp as the urgent channel. The Ask-about-this rows are styled as quiet hairline links rather than buttons for the same reason: the artefact is the point, and the question is the escape hatch when a line of it does not land.</Note>
