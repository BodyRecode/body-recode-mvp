      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>What it does not cover, plainly.</strong> This is the data. The structure of the database lives in the migration files in version control, so the two together are a complete recovery story, but a true restore into an empty database has not been tested, because that needs a target database. And it does <em>not</em> cover uploaded files: progress photographs and blood panel documents are still single-copy. Those are the two gaps.</p>
