      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>Salt cravings changed meaning (17 September 2026).</strong> The intake question about salty or savoury cravings used to count as a strain signal, on nothing. No human study found stress raises salt intake, salt liking is mostly learned and falls within months of eating less salt, and adrenal fatigue is not a recognised condition, so that phrase is now blocked from anything a client reads. The question stays, because it matters in one specific way: a high answer <em>together with</em> unexplained weight loss, dizziness on standing, darkening skin or gums, ongoing nausea or marked persistent fatigue now raises a GP referral in the read. On its own it says nothing and the read stays quiet about it. If a doctor has told her to eat extra salt, every salt-reduction suggestion switches off. Evidence: research pass E1a, section A8.</p>
