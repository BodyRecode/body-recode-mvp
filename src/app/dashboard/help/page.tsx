      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p>Mirrors the CFFS / Foundational Reading / Program Reading / Nutrition Reading flow: click <strong>Generate response</strong> at the top of the card and Claude drafts all three fields from the check-in plus the CFFS, the four most recent prior check-ins, the active program block, and intake context (medications + dietary). The draft populates the textareas; nothing is saved or sent until you click <strong>Save and email client</strong>. You are the approval gate. The model returns <code>reframe: null</code> when no misread is detected (forced reframes are worse than no reframe). Em dashes are stripped from the draft before it lands in the form, in line with the brand voice rule.</p>
