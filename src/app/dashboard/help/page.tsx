      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="operator-flow" title="Operator Flow - Lead to Active Client" colour="violet">
            ...
            <div className="space-y-6 mt-2">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <ChecklistItem text="From the lead detail page, click Send to Client under Coaching Entry - this emails the $297 commencement fee link directly. It covers the initial read and the 12-week re-read, and it is the only way to charge the fee: the old static Stripe commencement links were switched off on 14 Sep 2026" />
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p>Her reading carries across too and stays published. A change to one food does not make the explanation wrong, and clearing it would pull it out of her portal until someone rebuilt it. If a revision is big enough to change the explanation, regenerate the reading yourself, which is a decision you make rather than something that happens quietly.</p>
