        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="coach-copilot" title="Coach Co-Pilot - Doctrine Tutor" colour="violet">
            ...
            <StatusList items={[
              ...
              { label: 'Refine a draft', desc: 'Tap "✎ Refine program" or "✎ Refine nutrition", then describe one change ("swap the barbell squat for a hip thrust", "drop the bench to 3 sets", "swap the oats for berries", "drop to 3 meals"). It shows you exactly what will change (for nutrition it re-sums the macros) before anything happens; you tap Apply. Only the named part changes, the rest of the draft is untouched, and it stays a draft until you publish. It won\'t make a change that breaks the phase, a gate, an injury, or the protein anchor.' },
            ]} />
