      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>Nothing was pulled from the library</strong>, except that red light is flagged for your decision because we were prescribing a dose that cannot be sourced. The protocols are fine. It was the claims that were wrong.</p>
