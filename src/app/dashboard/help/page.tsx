      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="weekly-checkins" title="11. Weekly Check-Ins and CFWS" colour="teal">
            ...
            <p><strong>The review queue.</strong> Every check-in that comes in lands at <strong>Check Ins</strong> in the sidebar (<code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">/dashboard/checkins</code>). It is the one place to work through them rather than opening clients one at a time.</p>
            <ul className="space-y-1 list-disc list-inside text-[#3A3A3A] text-sm">
