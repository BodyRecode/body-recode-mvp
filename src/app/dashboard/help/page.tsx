        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="trajectory-reading" title="20c. Progress Read - Client Facing" colour="teal">
            ...
            <ul className="space-y-1.5 list-disc list-inside text-[#43474F] text-sm mt-2">
              ...
              <li><strong>Generate.</strong> Click Generate on the read panel. It reads the block&apos;s weekly arc <em>and</em> the Progress Check answers, and produces the read plus a <strong>State Re-Score</strong> card (previous state → new state, direction, a plain-language rationale, and a pattern-held note). Review and edit as normal.</li>
