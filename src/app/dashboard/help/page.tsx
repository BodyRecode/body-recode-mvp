        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="zoom-1" title="2. Zoom - Call Companion" colour="teal">
            ...
            <ol className="space-y-1.5 list-decimal list-inside text-[#3A3A3A] text-sm mt-2">
              ...
              <li><strong>Tie the hot spot to how this works</strong> - all five cards in full: the intake and eight domains, where it shows up, the four profiles, execution, and the continuous loop. Each one carries your script underneath it.</li>
            ...
            <Note><strong>Your scripts live in one file.</strong> Every word of spoken copy is in <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">src/lib/companion-content.ts</code>, extracted verbatim from the previous companion. Edit that file, not the page. One deliberate change was made with your approval: the &quot;where it shows up&quot; card was a pure-location model, which Fat Map v2.0 retired, so it now reads as four location-plus-signal pairs in the same rhythm.</Note>
