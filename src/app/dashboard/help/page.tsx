      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="ch-overview" title="Challenge Overview" colour="teal">
            <p className="rounded-lg border border-[#E8EAEE] bg-[#F7F8FA] px-3 py-2 text-[12.5px] leading-relaxed"><strong>Body Decode paused, 17 September 2026.</strong> The five daily videos are being re-recorded, so nobody new can enrol. The signup form at /decode now takes her details for the waitlist instead, the scorecard emails, the bio link and the Performance scorecard all say reopening soon, and Decode stays her recommended next step. Names land in <strong>Business &rarr; Product Waitlist</strong> under Body Decode, and she gets a short waitlist email. The two people already part-way through keep their portals. Switching it back on is one setting, <code>NEXT_PUBLIC_DECODE_LIVE</code> set to true, no code change.</p>
