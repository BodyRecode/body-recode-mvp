      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            <Note><strong>Single source of truth:</strong> the full inventory of every email the platform sends — 120 distinct subject lines across 33+ client-facing paths plus coach notifications, drip workflows, and one-off extras — lives at <code>~/Dropbox/01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/03_EMAIL_SYSTEM/EMAIL_INVENTORY.md</code> (with a <code>.docx</code> mirror generated by pandoc). When you ship a new email, update that doc + the dashboard automation entry + this section in the same commit (see <code>feedback_email_inventory_update</code>). Section 15 below is the narrative summary; the inventory doc is the authoritative list.</Note>
          ...
          <Section id="ch-landing" title="Landing Page" colour="teal">
            ...
            <p className="mt-2"><strong>(1) Joiner welcome</strong> — branded email from <strong>{coach().email}</strong>, BCC&apos;d to <strong>{coach().email}</strong> so you see exactly what the joiner received. Product-aware copy: Challenge waitlisters get &quot;doors open Mon 13 July&quot; + a preview of the 14 days; Blueprint / Membership waitlisters get &quot;the Challenge comes first / start with the read&quot; funnelling them to the free Challenge as the read that comes before the paid product.</p>
