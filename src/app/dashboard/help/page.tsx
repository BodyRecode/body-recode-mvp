      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="saas-launch" title="SaaS Launch Board - Is Anyone Actually Buying It" colour="amber">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">The Rey price test (added 14 Sep 2026)</p>
          ...
          <Section id="ch-landing" title="Landing Page" colour="teal">
            ...
            <p className="text-[12.5px] font-medium text-[#666D7A] mt-4 mb-2">Founding list confirmation (2026-09-14, the Rey price test)</p>
