      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="ch-landing" title="Landing Page" colour="teal">
            ...
            <p className="mt-2">Default mode is <strong>PREVIEW</strong> (no <code>--live</code> flag): sends one [PREVIEW] copy of each product variant (challenge / blueprint / membership) to <strong>kade@bodyrecode.au</strong> so you see the exact look first. Add <code>--live</code> to broadcast.</p>
            ...
            <p className="mt-2"><strong>Coach BCC:</strong> every live send BCCs <strong>kade@bodyrecode.au</strong> for audit. Preview mode is the coach&apos;s copy already.</p>
