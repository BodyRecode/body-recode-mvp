      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="client-portal" title="8. Client Portal" colour="teal">
            ...
            <Note>This is deliberately not a live chat. There is no typing indicator and no push notification. You <em>do</em> get a read receipt on your own messages (see below), but the client never sees one on theirs. It is an async coaching thread - set the expectation with clients that you reply within your normal working rhythm. The Ask-about-this rows are styled as quiet hairline links rather than buttons for the same reason: the artefact is the point, and the question is the escape hatch when a line of it does not land.</Note>
