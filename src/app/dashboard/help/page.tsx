      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>Client profile sections are now collapsible.</strong> The six major blocks on <code>/dashboard/clients/[id]</code> (Foundational Synthesis, Baseline, Weekly Synthesis, Training Program, Nutrition Plan, Payments) collapse to single header rows on load. Sections with work for you to do open by default with an amber attention-pill in the header (e.g. <em>FR not published</em>, <em>Unanswered check-in</em>, <em>Draft awaiting review</em>); the rest stay closed. Right-side action buttons (Copy link, Macro Plan, Generate, Regenerate) stay in the header even when collapsed, so you can trigger them without first opening the section. Page-load state is not persisted — action-required sections will keep auto-opening until handled.</p>
