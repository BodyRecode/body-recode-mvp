      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>Still to do:</strong> this covers the nutrition engine. The same check belongs on the daily routine generator and the client-facing readings, and that is the next piece of the doctrine enforcement work.</p>
