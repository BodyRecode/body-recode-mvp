      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>Still to do:</strong> the gates are in front of the models but not yet enforced by a validator, and the referral list below is documentation rather than something the system fires on its own. Wiring the referral list to the intake answers is the next step, and the three questions added beside the salt craving question exist to feed it.</p>
