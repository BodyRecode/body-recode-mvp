      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="coaching-package" title="12. Coaching Package and Upgrades" colour="teal">
            ...
            <p>A third row holds <strong>Contra (trade)</strong> and <strong>No-charge / comp</strong>. Use these when the client is not on a paid subscription — e.g. a contra deal where they provide work in exchange for the coaching seat, or a founding-friend comp. Clients on a non-billing package are explicitly skipped by the Payments tracker: no commencement-fee flag, no Stripe-customer flag, no overdue indicator on the dashboard. The Send / Copy / Schedule controls don&apos;t appear because there is no Stripe link to send. Switch them back to a paid package if the arrangement changes.</p>
