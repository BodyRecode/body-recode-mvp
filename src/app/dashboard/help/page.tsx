      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="be-social-profiles" title="35. Social Profiles" colour="amber">
            ...
            <p className="text-xs font-bold text-[#6B6B6B] uppercase tracking-wider mt-4 mb-2">Personal Brand (@kade_dunstone_) in the Content Calendar</p>
            <p>The personal brand is <strong>not a separate calendar</strong> - it lives in the one Content Calendar on <strong>Business → Marketing Strategy → Content Calendar</strong>, filtered by <strong>brand = Personal Brand</strong> (violet) alongside Body Recode, AI Co-Founder and Studio of Ten. The 4-week launch run (16 posts, 4/week Mon/Wed/Fri/Sun across Body / Thinking / AI / Identity, drawn from the Personal Brand Script Library) is seeded via <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">sql/2026-06-04_seed_personal_brand_calendar_posts.sql</code>. The Personal Brand page itself holds the strategy reference (positioning, story, pillars, scripts, cadence, launch) - no calendar.</p>
            <p className="mt-2"><strong>Card design:</strong> personal-brand graphics use a dedicated <em>editorial</em> template - warm paper (#FAF8F4), a Signal Blue letterspaced eyebrow + short rule, a Source Serif 4 headline, and the <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">@kade_dunstone_</code> wordmark (no logo). Deliberately distinct from the Body Recode system cards (pure white, sans, logo) - the person reads differently from the system, tied to the ecosystem only by the Signal Blue thread. Square (1080x1080) and story (1080x1920) formats via the graphic endpoint <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">?style=personal</code>; each calendar row's <em>graphic</em> field holds that URL so it previews and downloads inline in the calendar.</p>
