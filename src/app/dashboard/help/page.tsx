      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <Note><strong>Coach BCC on manual sends (2026-05-14).</strong> Every coach-triggered manual email send (Send portal access, Send commencement fee, Send subscription link, Send intake, Send supplementary intake, Approve clearance, Inbox reply, the supplementary-intake script) BCCs <code>kade@bodyrecode.au</code> via <code>COACH_BCC</code> from <code>@/lib/email-shell</code> so you have a copy of every real send in your inbox for audit, quoting back, and confirming the send actually fired. NOT applied to cron, drip, OTP, or other automated sends - those would flood the inbox. Override per-send via the <code>COACH_BCC_EMAIL</code> env var (set to empty string to disable in dev).</Note>
