        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="platform-buildout" title="17e. Buildout boards (Body Recode + Performance Coaching)" colour="teal">
            ...
            <ul className="space-y-1 list-disc list-inside text-[#43474F] text-sm">
              ...
              <li><strong>Phase 3 · Better measurement inputs</strong> — accept measurements from any source, require none. Measurements become a list carrying <em>what, the number, and where it came from</em>, so adding a machine later is a label rather than a rebuild. The doctrine is a <strong>competence map, not a ranking</strong>: DEXA speaks to android/gynoid ratio and regional lean; InBody and Evolt to segmental muscle and fluid, never absolute fat percentage and never across machines; a 3D scan to shape only, since it cannot tell muscle from fat; a tape to circumference if plausible. ⚠ Every one of them says <em>where</em>, none says <em>why</em>. NOT blocked by the gate; it sits after door 2 because it must not be done instead of finding a coach.</li>
