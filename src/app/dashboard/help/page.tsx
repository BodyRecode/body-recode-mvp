      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="email-sequences" title="15. Email Sequences and Automation" colour="teal">
            ...
            <p><strong>What is still not covered, plainly.</strong> Neither backup has been restored end to end into an empty system. The database structure lives in the migration files in version control, so the pieces are all there, but putting them back has not been rehearsed, and that needs a target database. Until that is done this is a very good copy that nobody has proven can be put back.</p>
