      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="be-content-engine" title="32. Content Engine" colour="amber">
            ...
            <ul className="space-y-1 list-disc list-inside text-stone-300 text-sm mt-1">
              <li><strong>Graphic</strong> — 1080×1080 PNG (3 card styles). Download and post as a static Instagram or Facebook post.</li>
            ...
            <ul className="space-y-1 list-disc list-inside text-stone-300 text-sm mt-2">
              ...
              <li><strong>Create Graphic</strong> — choose Quote Card, Statement Card, or Question Card. Preview and download as 1080×1080 PNG.</li>
