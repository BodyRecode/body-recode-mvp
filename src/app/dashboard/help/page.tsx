      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <Section id="be-social-profiles" title="35. Social Profiles" colour="amber">
            ...
            <p className="text-xs font-bold text-[#6B6B6B] uppercase tracking-wider mt-4 mb-2">Personal Brand Content Calendar (@kade_dunstone_)</p>
            <p>Lives at <strong>Business → Personal Brand → Content Calendar</strong> (the default tab). A 4-week launch schedule, 4 posts/week (Mon/Wed/Fri/Sun) across the four pillars (Body / Thinking / AI / Identity), drawn from the Script Library on the same page. Week 1 runs the launch sequence; weeks 2-4 rotate the pillars.</p>
            <p className="mt-2">Each post has <strong>Preview graphic</strong> (inline render), <strong>Download</strong> (PNG), <strong>Copy copy</strong>, and a click-to-cycle status chip (planned → ready → posted). Status is a local planning aid, not yet persisted.</p>
            <p className="mt-2"><strong>Card design:</strong> personal-brand graphics use a dedicated <em>editorial</em> template - warm paper (#FAF8F4), a Signal Blue letterspaced eyebrow + short rule, a Source Serif 4 headline, and the <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">@kade_dunstone_</code> wordmark (no logo). Deliberately distinct from the Body Recode system cards (pure white, sans, logo) - the person reads differently from the system, tied to the ecosystem only by the Signal Blue thread. Square (1080x1080) and story (1080x1920) formats supported via the graphic endpoint <code className="bg-[#E5E5E5] px-1 rounded text-blue-700 text-xs">?style=personal</code>.</p>
