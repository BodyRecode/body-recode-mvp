    ...
    <>
      ...
      <section className="bg-black py-32 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-lg leading-relaxed mb-4">
            Body Recode™ strength coaching is conducted face-to-face at Anytime Fitness Newstead, Brisbane. All sessions are one-on-one. Availability is intentionally limited to maintain the quality and depth of coaching that the system requires.
          </p>
          <p className="text-white/60 text-lg leading-relaxed mb-12">
            The starting point is always the free Performance Check-In — a structured intake that tells you exactly where your body is right now and how the Body Recode™ system applies to you.
          </p>
          <Link href="/performance-coach-brisbane" className="text-[#10E1C2] text-sm font-semibold hover:underline mr-6">Performance coaching →</Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: 'How do sessions work?', a: 'All sessions are face-to-face at Anytime Fitness Newstead. Session structure depends on your body state and programming phase. Everything is guided — form, load, tempo, and rest are all coached.' },
