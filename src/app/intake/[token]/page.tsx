    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-[#666D7A] text-sm">This intake link is invalid or has expired. Please contact your coach.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-8">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-[#141821] mb-3 tracking-tight">Already submitted</h1>
