    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          <p className="text-xs font-bold tracking-widest text-[#1B6DFC] uppercase mb-6"><a href={brand().marketingDomain} className="text-xs font-bold tracking-widest text-[#1B6DFC] uppercase">{brand().name}™</a></p>
          <h1 className="text-xl font-semibold text-[#141821] mb-2">Link not found</h1>
          <p className="text-[#666D7A] text-sm">This check-in link is invalid. Please contact your coach.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-[#666D7A] text-sm mb-4">The check-in window opens <span className="text-[#141821]">Friday at 6:00pm</span> and closes Sunday at 6:00pm Brisbane time.</p>
          <p className="text-[#98A0AD] text-xs">Next window opens {opensAt} (Brisbane)</p>
        </div>
      </div>
    )
  }
  ...
  if (existing) {
    return (
      <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          <p className="text-xs font-bold tracking-widest text-[#1B6DFC] uppercase mb-6"><a href={brand().marketingDomain} className="text-xs font-bold tracking-widest text-[#1B6DFC] uppercase">{brand().name}™</a></p>
          <div className="w-14 h-14 bg-[#F4F6F9] border border-[#EFF1F4] rounded-full flex items-center justify-center mx-auto mb-5">
          ...
          <p className="text-[#666D7A] text-sm">Your check-in for this week has been received. Your coach will review it shortly.</p>
        </div>
      </div>
    )
  }
