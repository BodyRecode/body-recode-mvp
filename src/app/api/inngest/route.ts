...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [executeWorkflowFunction, challengeSequenceFunction, challengeCheckinPromptFunction, challengeIntakeReminderFunction, challengeFormsReminderFunction, challengeSmsFunction, decodeDailyArcFunction, blueprintWeekAdvanceFunction, blueprintEmailSequenceFunction, membershipWeekAdvanceFunction, extensionWeekAdvanceFunction, reengagementSequenceFunction, digitalAssetEngineFulfilmentFunction, weeklyCheckinAutoResponseFunction, weeklyPatternReportSequenceFunction, igPublisherCron, speedToLeadScorecardFunction, speedToLeadChallengeFunction, speedToLeadWaitlistFunction, speedToLeadPurchaseFunction, speedToLeadNoShowFunction, partnerActiveClientCounterCron, bookingAgentSequenceFunction, prepFormReminderFunction, dormantLeadReactivationFunction, reassessmentDigestCron],
