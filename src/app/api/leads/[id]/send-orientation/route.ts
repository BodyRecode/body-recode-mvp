...
<style>
  ...
  .wrapper { max-width: 640px; margin: 0 auto; padding: 48px 32px; }
  .logo { font-size: 11px; letter-spacing: 0.2em; color: #555; text-transform: uppercase; margin-bottom: 48px; }
  .title { font-size: 28px; color: #fff; font-weight: normal; margin-bottom: 8px; line-height: 1.3; }
  .subtitle { font-size: 14px; color: #888; margin-bottom: 48px; line-height: 1.6; }
  .divider { border: none; border-top: 1px solid #222; margin: 40px 0; }
  h2 { font-size: 16px; color: #fff; font-weight: normal; margin-bottom: 16px; margin-top: 0; letter-spacing: 0.05em; }
  p { font-size: 15px; color: #aaa; line-height: 1.8; margin: 0 0 20px; }
  .note { font-size: 13px; color: #555; line-height: 1.7; font-style: italic; margin-bottom: 32px; }
  .footer { margin-top: 56px; font-size: 12px; color: #444; letter-spacing: 0.05em; }
</style>
</head>
<body>
<div class="wrapper">
  ...
  <div class="title">Performance Coaching Orientation</div>
  <div class="subtitle">How this works. What to expect. How we begin.</div>

  <p class="note">This guide is designed to be read slowly. There is nothing here to complete, decide, or commit to. Orientation exists to create clarity. What happens next is always a choice.</p>

  <hr class="divider">

  <h2>A Note on How to Read This</h2>
  ...
  <h2>How Body Recode Performance Coaching Works</h2>
  ...
  <h2>The Coaching Relationship</h2>
  ...
  <h2>Expectations and Boundaries</h2>
  ...
  <h2>Pacing, Communication, and Rhythm</h2>
  ...
  <h2>Completing Orientation and Transitioning Forward</h2>
  ...
  <p style="color: #666; font-size: 14px; font-style: italic;">Body Recode doesn't ask for blind commitment. It asks for clarity. Take what resonates. Leave what doesn't. Move forward in a way that feels deliberate, grounded, and aligned with what your system can truly hold.</p>
