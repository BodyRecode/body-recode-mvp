...
export async function PATCH(
  ...
  const allowed = ['coaching_started_at', 'package', 'active', 'founding_client_status', 'phone', 'is_founding_client', 'founding_client_trigger_type', 'founding_client_start_date']
