...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:48px 32px;">
    ...
    <p style="font-size:15px;color:#aaa;line-height:1.9;margin:0 0 20px;">Your medical clearance has been reviewed and approved. Onboarding is now fully unlocked. The Foundational Intake and Baseline Documentation are open in your portal.</p>
    <p style="font-size:15px;color:#aaa;line-height:1.9;margin:0 0 20px;">Take your time with the intake. The more accurate it is, the better the read I get.</p>
