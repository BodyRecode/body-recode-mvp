        ...
        <main className="flex-1 max-w-2xl">
          ...
          <div className="space-y-14 text-stone-700 text-[15px] leading-relaxed">
            ...
            <OrientationSection id="what-this-is" title="What This Is (and What It Isn&apos;t)">
              <p>Body Recode Performance Coaching is built on the Body Recode framework. It is a considered system for understanding how the body responds to stress, load, recovery, and time.</p>
            ...
            <OrientationSection id="how-it-works" title="How Body Recode Performance Coaching Works">
              ...
              <p>Body Recode recognises that motivation is unreliable. Structure, however, holds when motivation does not. Coaching is built around clear phases, predictable rhythms, and defined decision points. This reduces emotional effort and removes the need to rely on willpower.</p>
              <p>Within the Body Recode framework, it is common to see that when load is applied appropriately, recovery is protected, and the body is no longer operating under constant stress, people achieve better results while doing less. The system is finally working with the body rather than against it.</p>
            </OrientationSection>

            <OrientationSection id="relationship" title="The Coaching Relationship">
              <p>This relationship is designed to feel steady, respectful, and well defined. Not intense, dependent, or constantly reactive. Its purpose is to support progress over time, not to create pressure or urgency.</p>
            ...
            <OrientationSection id="next" title="Before Our Next Conversation">
              ...
              <p>You don&apos;t need to have prepared anything. You don&apos;t need to have formed opinions or made decisions. What helps is arriving with a clearer sense of what this framework is. That&apos;s what this guide is for.</p>
