        ...
        <main className="flex-1 max-w-2xl">
          ...
          <div className="space-y-14 text-stone-700 text-[15px] leading-relaxed">
            ...
            <OrientationSection id="what-this-is" title="What This Is (and What It Isn&apos;t)">
              <p>{brand().name} Performance Coaching is built on the {brand().name} framework. It is a considered system for understanding how the body responds to stress, load, recovery, and time.</p>
            ...
            <OrientationSection id="how-it-works" title="How Body Recode Performance Coaching Works">
              ...
              <p>{brand().name} recognises that motivation is unreliable. Structure, however, holds when motivation does not. Coaching is built around clear phases, predictable rhythms, and defined decision points. This reduces emotional effort and removes the need to rely on willpower.</p>
              <p>Within the {brand().name} framework, it is common to see that when load is applied appropriately, recovery is protected, and the body is no longer operating under constant stress, people achieve better results while doing less. The system is finally working with the body rather than against it.</p>
            </OrientationSection>
