...
export async function sendPortalAccessEmail({
  ...
  try {
    ...
    html: darkEmailShell(`
      ...
      <p style="font-size:15px;color:#4A4A4A;line-height:1.9;margin:0 0 8px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;"><strong style="color:#1A1A1A;">3.</strong> Foundational Intake (221 questions across 8 areas. Take your time. The more accurate it is, the better your read.)</p>
