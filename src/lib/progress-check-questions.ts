 ...
 * body state. It is NOT the 221-point Foundational intake and it is NOT the weekly
 ...
 *    re-read (221 re-intake + fresh photos) can revise it. Fresh measurements and
