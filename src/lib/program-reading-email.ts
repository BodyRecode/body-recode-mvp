...
${emailLogo()}
${emailEyebrow('Program Read')}
${emailHeading(`Your new block is ready, ${escapeHtml(firstName)}.`)}
${emailBody(`${escapeHtml(blockName)} is live in your portal. Before the sessions, you will find your Program Read: the read of what this block is for, what it is asking of your body, and how we will know it is working.`)}
${emailBody(`The read sits at the top of your program page so the why frames every session you open.`)}
