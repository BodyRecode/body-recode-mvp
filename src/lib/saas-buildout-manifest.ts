  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Wire tplPurchaseReport + tplNoShowReminder templates into Stripe webhook + Zoom no-show cron. Foundation exists — just event emitters + Inngest functions.',
        status: 'planned',
        effort: 'S',
        blockedBy: 'speed-to-lead-sms',
      },
