  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: 'planned',
        effort: 'L',
        blockedBy: 'progress-check-any-answers',
        notes: 'The coaching front end for the comparison engine, per 02_FEATURE_SPECS/2026-09-13_Progress_Check_Spec.md. Replaces the 24-question form. Must store her answers and her disputes (a dispute never overwrites the old answer), show "we did not ask you this last time" for first answers, carry the two hormonal safety alerts, and ask the four energy/drive questions as "compared with your last read". Rey\'s short re-ask is a separate front end on the same engine.',
      },
      {
        id: 'reread-generator',
