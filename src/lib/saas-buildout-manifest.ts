  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        notes: 'First drafting target = training program. The ADVISORY half shipped 2026-07-15 (tutor recommends the generation setup; coach clicks Generate). This step is now specifically the DATA-MUTATING half: the co-pilot triggers the generate itself. Deferred until it can be click-tested alongside Kade (auth-gated; mutates live client drafts) — do not ship unattended.',
      },
      {
        id: 'copilot-refine',
