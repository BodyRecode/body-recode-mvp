...
export function buildWeeklyCheckinFeedbackEmail({
  ...
  const reframeBlock = reframe
    ? `
              <p style="font-size:11px;font-weight:700;letter-spacing:0.18em;color:#14b8a6;text-transform:uppercase;margin:28px 0 10px;">Reframe</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#111110" style="max-width:560px;background-color:#111110;border-radius:16px;border:1px solid #1c1917;overflow:hidden;">
          ...
          <tr>
            <td bgcolor="#111110" style="background-color:#111110;padding:36px 40px 40px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:15px;line-height:1.75;color:#a8a29e;">
              <p style="font-size:11px;font-weight:700;letter-spacing:0.18em;color:#14b8a6;text-transform:uppercase;margin:0 0 14px;">Week ${weekNumber} · Form ${formType} response</p>
              ...
              <p style="font-size:11px;font-weight:700;letter-spacing:0.18em;color:#14b8a6;text-transform:uppercase;margin:28px 0 10px;">Interpretation</p>
              <p style="margin:0;">${paragraphsToHtml(interpretation)}</p>
              ${reframeBlock}

              <p style="font-size:11px;font-weight:700;letter-spacing:0.18em;color:#14b8a6;text-transform:uppercase;margin:28px 0 10px;">This week, hold this</p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin:32px 0 8px;">
                <tr>
                  <td bgcolor="#14b8a6" style="background-color:#14b8a6;border-radius:10px;">
                    <a href="${checkinUrl}" style="display:inline-block;padding:14px 28px;color:#0c0c0a;font-size:14px;font-weight:700;text-decoration:none;letter-spacing:0.02em;">
                      View in your portal
                    </a>
                  </td>
                </tr>
              </table>
              <p style="font-size:13px;color:#a8a29e;margin-top:18px;">Your check-in and my response both live in your portal so you can return to them any time.</p>
