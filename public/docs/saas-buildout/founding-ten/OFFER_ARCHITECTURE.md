...
- **B (later):** their own unique method *replacing* BR's engine logic - method-injection baked into the interpretation. Comes only AFTER the first ten are live and stable.
...
- Funnels are their own beast (offer stack, email sequences, ad creative, landing pages, challenge mechanics). Bundling them balloons onboarding hours and slows the first ten.
