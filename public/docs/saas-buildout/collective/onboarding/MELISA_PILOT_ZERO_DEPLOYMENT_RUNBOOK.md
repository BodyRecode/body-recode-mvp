...
Pre-built starting point: **[../../../01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/sql/2026-07-05_melisa_seed.sql](../../../01_BODY_RECODE/06_SAAS_PLATFORM_BUILD/sql/2026-07-05_melisa_seed.sql)** ships with the Collective Launch tier defaults, Yoga modality, and doctrine parameters pre-tuned for a warm/grounded/breath-forward voice. Fill placeholders + run to provision.
...
- [ ] **Collective Partner Agreement + IP Licence Deed v1.0 signed** — drafts at `../legal/` (v0.1). Awaiting external lawyer review. Both must be signed together.
- [ ] **Setup fee cleared** — $2,500 Launch tier (the Collective locked rate) invoiced + paid via Kade's Stripe
